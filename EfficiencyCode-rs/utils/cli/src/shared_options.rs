//! Shared command-line flags used by both interactive and non-interactive EfficiencyCode entry points.

use crate::CliConfigOverrides;
use crate::SandboxModeCliArg;
use EfficiencyCode_protocol::config_types::ProfileV2Name;
use clap::Args;
