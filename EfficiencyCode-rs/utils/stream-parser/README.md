# EfficiencyCode-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and EfficiencyCode did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust EfficiencyCode on it. Feel free to update the documentation as you
modify the code
...
```rust
use EfficiencyCode_utils_stream_parser::CitationStreamParser;
use EfficiencyCode_utils_stream_parser::StreamTextParser;
...
```rust
use EfficiencyCode_utils_stream_parser::CitationStreamParser;
use EfficiencyCode_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), EfficiencyCode_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use EfficiencyCode_utils_stream_parser::InlineHiddenTagParser;
use EfficiencyCode_utils_stream_parser::InlineTagSpec;
use EfficiencyCode_utils_stream_parser::StreamTextParser;
