//! Helpers for truncating tool and exec output using [`TruncationPolicy`](EfficiencyCode_protocol::protocol::TruncationPolicy).

use EfficiencyCode_protocol::models::FunctionCallOutputContentItem;
pub use EfficiencyCode_utils_string::approx_bytes_for_tokens;
pub use EfficiencyCode_utils_string::approx_token_count;
pub use EfficiencyCode_utils_string::approx_tokens_from_byte_count;
use EfficiencyCode_utils_string::truncate_middle_chars;
use EfficiencyCode_utils_string::truncate_middle_with_token_budget;

pub use EfficiencyCode_protocol::protocol::TruncationPolicy;
