//! Path normalization, symlink resolution, and atomic writes shared across EfficiencyCode crates.
...
/// Compare paths after applying EfficiencyCode's filesystem normalization.
///
