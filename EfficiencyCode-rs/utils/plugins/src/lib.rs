//! Plugin path resolution, plaintext mention sigils, and MCP connector helpers shared across EfficiencyCode
//! crates.
...
pub use EfficiencyCode_exec_server_protocol::DISCOVERABLE_PLUGIN_MANIFEST_PATHS;
...
const PLUGIN_METADATA_DIR: &str = ".EfficiencyCode-plugin";
