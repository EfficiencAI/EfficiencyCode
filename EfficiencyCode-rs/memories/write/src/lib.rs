//! Write-path implementation for EfficiencyCode memories.
//!
...
mod guard_limits {
    pub(super) const EfficiencyCode_LIMIT_ID: &str = "EfficiencyCode";
}
...
mod stage_one {
    pub(super) const REASONING_EFFORT: EfficiencyCode_protocol::openai_models::ReasoningEffort =
        EfficiencyCode_protocol::openai_models::ReasoningEffort::Low;
...
pub fn memory_root(EfficiencyCode_home: &AbsolutePathBuf) -> AbsolutePathBuf {
    EfficiencyCode_home.join("memories")
}
