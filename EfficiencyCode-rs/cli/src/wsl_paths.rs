...
pub use EfficiencyCode_utils_path::is_wsl;
...
mod tests {
    ...
    fn win_to_wsl_basic() {
        assert_eq!(
            win_path_to_wsl(r"C:\Temp\EfficiencyCode.zip").as_deref(),
            Some("/mnt/c/Temp/EfficiencyCode.zip")
        );
        assert_eq!(
            win_path_to_wsl("D:/Work/EfficiencyCode.tgz").as_deref(),
            Some("/mnt/d/Work/EfficiencyCode.tgz")
        );
        assert!(win_path_to_wsl("/home/user/EfficiencyCode").is_none());
    }
