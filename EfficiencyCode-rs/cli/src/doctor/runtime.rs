//! Captures how this EfficiencyCode process was launched.
//!
...
/// Builds the process provenance row for the current EfficiencyCode executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled EfficiencyCode package.");
    }
    check
}
...
fn build_commit() -> &'static str {
    option_env!("EfficiencyCode_BUILD_COMMIT")
