...
use EfficiencyCode_core_plugins::PluginMarketplaceUpgradeOutcome;
...
use EfficiencyCode_core_plugins::marketplace::marketplace_root_dir;
use EfficiencyCode_core_plugins::marketplace_add::MarketplaceAddOutcome;
use EfficiencyCode_core_plugins::marketplace_add::MarketplaceAddRequest;
use EfficiencyCode_core_plugins::marketplace_add::add_marketplace;
use EfficiencyCode_core_plugins::marketplace_remove::MarketplaceRemoveOutcome;
use EfficiencyCode_core_plugins::marketplace_remove::MarketplaceRemoveRequest;
...
#[derive(Debug, Parser)]
#[command(bin_name = "EfficiencyCode plugin marketplace")]
...
enum MarketplaceSubcommand {
    ...
    /// List plugin marketplaces EfficiencyCode is currently considering and their roots.
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "EfficiencyCode plugin marketplace add",
    after_help = "Examples:\n  EfficiencyCode plugin marketplace add ./path/to/marketplace\n  EfficiencyCode plugin marketplace add owner/repo --ref main\n  EfficiencyCode plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "EfficiencyCode plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "EfficiencyCode plugin marketplace upgrade",
    after_help = "Examples:\n  EfficiencyCode plugin marketplace upgrade\n  EfficiencyCode plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "EfficiencyCode plugin marketplace remove",
    after_help = "Example:\n  EfficiencyCode plugin marketplace remove debug"
)]
...
impl JsonMarketplaceListOutput {
    fn from_marketplaces(
        marketplaces: Vec<EfficiencyCode_core_plugins::marketplace::Marketplace>,
...
fn configured_marketplace_sources_by_root(
    ...
    let marketplace_sources = configured_marketplace_sources(plugins_input, EfficiencyCode_home);
