...
const COMMIT_ATTRIBUTION: &str = "Co-authored-by: EfficiencyCode <noreply@openai.com>";
const PR_ATTRIBUTION: &str = "Generated with [EfficiencyCode](https://openai.com/EfficiencyCode/).";
                        ...
                        && text.contains("<git_attribution>")
                    {
                        *text = match legacy_attribution {
                            ...
                            LegacyAttribution::UnlinkedPullRequest => {
                                text.replace(PR_ATTRIBUTION, "Generated with EfficiencyCode.")
                            }
                        };
                        replaced = true;
                    }
