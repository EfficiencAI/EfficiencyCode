...
use EfficiencyCode_app_server_protocol::ServerDiagnosticsGauge;
use EfficiencyCode_app_server_protocol::ServerDiagnosticsParams;
use EfficiencyCode_app_server_protocol::ServerDiagnosticsResponse;
