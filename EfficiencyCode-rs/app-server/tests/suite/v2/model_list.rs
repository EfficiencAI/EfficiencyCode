...
use EfficiencyCode_app_server_protocol::Model;
use EfficiencyCode_app_server_protocol::ModelListParams;
use EfficiencyCode_app_server_protocol::ModelListResponse;
use EfficiencyCode_app_server_protocol::ModelServiceTier;
use EfficiencyCode_app_server_protocol::ModelUpgradeInfo;
use EfficiencyCode_app_server_protocol::ReasoningEffortOption;
...
fn expected_visible_models() -> Vec<Model> {
    ...
    let mut presets = ModelPreset::filter_by_auth(
        EfficiencyCode_core::test_support::all_model_presets().clone(),
        /*chatgpt_mode*/ false,
    );
