...
use EfficiencyCode_app_server_protocol::ApprovalsReviewer::AutoReview;
use EfficiencyCode_app_server_protocol::ApprovalsReviewer::User;
use EfficiencyCode_app_server_protocol::AskForApproval;
use EfficiencyCode_app_server_protocol::AskForApproval::Never;
use EfficiencyCode_app_server_protocol::AskForApproval::OnRequest;
...
use EfficiencyCode_app_server_protocol::ThreadForkParams as ForkParams;
use EfficiencyCode_app_server_protocol::ThreadForkResponse as ForkResponse;
use EfficiencyCode_app_server_protocol::ThreadResumeParams as ResumeParams;
use EfficiencyCode_app_server_protocol::ThreadResumeResponse as ResumeResponse;
use EfficiencyCode_app_server_protocol::ThreadSettingsUpdateParams as UpdateParams;
use EfficiencyCode_app_server_protocol::ThreadSettingsUpdateResponse as UpdateResponse;
use EfficiencyCode_app_server_protocol::ThreadSettingsUpdatedNotification as SettingsUpdated;
use EfficiencyCode_app_server_protocol::ThreadStartParams as StartParams;
use EfficiencyCode_app_server_protocol::TurnStartParams as TurnParams;
use EfficiencyCode_app_server_protocol::TurnStartResponse as TurnResponse;
...
async fn app_server(
    ...
    let server = TestAppServer::builder()
        .with_EfficiencyCode_home(home.path())
