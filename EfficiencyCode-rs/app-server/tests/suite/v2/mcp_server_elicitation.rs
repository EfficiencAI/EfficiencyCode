...
use EfficiencyCode_protocol::mcp_approval_meta as approval_meta;
use anyhow::Result;
...
const TOOL_NAMESPACE: &str = "mcp__EfficiencyCode_apps__calendar";
            ...
            ElicitationScenario::StandardForm | ElicitationScenario::Strict(_) => {
                if let ElicitationScenario::Strict(strict) = scenario {
                    ...
                    for index in 0..strict.review_outcomes().len().max(1) {
                        ...
                        let apps_meta = context.meta.0.0.get(MCP_TOOL_EfficiencyCode_APPS_META_KEY);
                        let mut meta = MetaObject(
                            json!({
                                ...
                                (MCP_TOOL_EfficiencyCode_APPS_META_KEY): apps_meta
