...
async fn request_permissions_round_trip() -> Result<()> {
    ...
    let EfficiencyCode_home = tempfile::TempDir::new()?;
    let responses = vec![
    ...
    assert_eq!(
        ...
        Some(vec![
            EfficiencyCode_app_server_protocol::FileSystemSandboxEntry {
                ...
                access: EfficiencyCode_app_server_protocol::FileSystemAccessMode::Write,
            },
            EfficiencyCode_app_server_protocol::FileSystemSandboxEntry {
                path: EfficiencyCode_app_server_protocol::FileSystemPath::Path {
    ...
    mcp.send_response(
        ...
        serde_json::to_value(PermissionsRequestApprovalResponse {
            permissions: EfficiencyCode_app_server_protocol::GrantedPermissionProfile {
                network: None,
                file_system: Some(
                    EfficiencyCode_app_server_protocol::AdditionalFileSystemPermissions {
                        read: None,
