...
async fn app_server_emits_structured_tool_call_timing_event() -> Result<()> {
    ...
    let mut app_server = TestAppServer::builder()
        ...
        .with_json_logging("warn,EfficiencyCode_core::tools::parallel=info")
        .build_initialized()
        .await?;
    ...
    let mut tool_call = app_server
        .wait_for_json_log_event("EfficiencyCode.tool_call")
        .await?;
    ...
    assert_eq!(
        ...
        json!({
            ...
            "target": "EfficiencyCode_core::tools::parallel",
        })
    );
