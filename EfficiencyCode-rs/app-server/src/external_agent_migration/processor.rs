...
use EfficiencyCode_analytics::ExternalAgentConfigImportCompletedInput;
use EfficiencyCode_analytics::ExternalAgentConfigImportFailureInput;
...
use EfficiencyCode_app_server_protocol::ExternalAgentConfigImportHistoryRecordParams;
use EfficiencyCode_app_server_protocol::ExternalAgentConfigImportHistoryRecordResponse;
use EfficiencyCode_app_server_protocol::ExternalAgentConfigImportItemTypeFailure as ProtocolImportFailure;
use EfficiencyCode_app_server_protocol::ExternalAgentConfigImportItemTypeSuccess as ProtocolImportSuccess;
...
use EfficiencyCode_app_server_protocol::ExternalAgentConfigImportTypeResult as ProtocolImportTypeResult;
...
use EfficiencyCode_external_agent_migration::DetectedConnectorCandidate;
use EfficiencyCode_external_agent_migration::ExternalAgentConfigDetectOptions;
use EfficiencyCode_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use EfficiencyCode_external_agent_migration::ExternalAgentConfigImportOutcome as CoreImportOutcome;
use EfficiencyCode_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use EfficiencyCode_external_agent_migration::ExternalAgentConfigService;
use EfficiencyCode_external_agent_migration::ExternalAgentSessionImportLimits;
use EfficiencyCode_external_agent_migration::PluginImportOutcome;
use EfficiencyCode_external_agent_migration::record_import_error;
use EfficiencyCode_external_agent_migration::sessions::ExternalAgentSessionMigration as CoreSessionMigration;
use EfficiencyCode_external_agent_migration::sessions::read_imported_connector_candidates;
use EfficiencyCode_external_agent_migration::sessions::record_detected_session_connectors;
use EfficiencyCode_features::Feature;
use EfficiencyCode_rollout::StateDbHandle;
use EfficiencyCode_state::ExternalAgentConfigImportFailureRecord;
use EfficiencyCode_state::ExternalAgentConfigImportSuccessRecord;
...
pub(crate) struct ExternalAgentConfigRequestProcessorArgs {
    ...
    pub(crate) EfficiencyCode_home: PathBuf,
}
...
impl ExternalAgentConfigRequestProcessor {
    ...
    pub(crate) async fn detect(
        ...
        record_detected_session_connectors(
            self.migration_service.EfficiencyCode_home(),
    ...
    pub(crate) async fn read_import_histories(
        ...
        let connectors =
            read_imported_connector_candidates(self.migration_service.EfficiencyCode_home())
                .map_err(|err| {
                    internal_error(format!(
