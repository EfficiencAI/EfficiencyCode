...
use EfficiencyCode_app_server_protocol::CommandMigration;
...
use EfficiencyCode_app_server_protocol::ExternalAgentConfigImportHistory;
...
use EfficiencyCode_app_server_protocol::ExternalAgentDetectedConnectorCandidate;
use EfficiencyCode_app_server_protocol::ExternalAgentDetectedConnectorSource;
use EfficiencyCode_app_server_protocol::HookMigration;
use EfficiencyCode_app_server_protocol::JSONRPCErrorError;
use EfficiencyCode_app_server_protocol::McpServerMigration;
use EfficiencyCode_app_server_protocol::MigrationDetails;
use EfficiencyCode_app_server_protocol::PluginsMigration;
use EfficiencyCode_app_server_protocol::SkillMigration;
use EfficiencyCode_app_server_protocol::SubagentMigration;
use EfficiencyCode_external_agent_migration::DetectedConnectorCandidate as CoreDetectedConnectorCandidate;
use EfficiencyCode_external_agent_migration::DetectedConnectorSource as CoreDetectedConnectorSource;
use EfficiencyCode_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use EfficiencyCode_external_agent_migration::ExternalAgentConfigImportRawError as CoreImportRawError;
use EfficiencyCode_external_agent_migration::ExternalAgentConfigImportSuccess;
use EfficiencyCode_external_agent_migration::ExternalAgentConfigMigrationItem as CoreMigrationItem;
use EfficiencyCode_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use EfficiencyCode_external_agent_migration::MigrationDetails as CoreMigrationDetails;
use EfficiencyCode_external_agent_migration::NamedMigration;
use EfficiencyCode_external_agent_migration::PluginsMigration as CorePluginsMigration;
use EfficiencyCode_external_agent_migration::sessions::ExternalAgentSessionMigration;
...
fn protocol_migration_details(details: CoreMigrationDetails) -> MigrationDetails {
    MigrationDetails {
        ...
        sessions: details
            ...
            .into_iter()
            .map(
                |session| EfficiencyCode_app_server_protocol::SessionMigration {
                    path: session.path,
                    cwd: session.cwd,
                    title: session.title,
                },
...
pub(super) fn protocol_import_history(
    record: EfficiencyCode_state::ExternalAgentConfigImportHistoryRecord,
