...
use EfficiencyCode_external_agent_migration::ExternalAgentConfigImportItemResult;
use EfficiencyCode_external_agent_migration::record_import_error;
use EfficiencyCode_external_agent_migration::sessions::CompletedExternalAgentSessionImport;
use EfficiencyCode_external_agent_migration::sessions::ExistingSessionAppend;
use EfficiencyCode_external_agent_migration::sessions::ExternalAgentSessionMigration;
use EfficiencyCode_external_agent_migration::sessions::ImportedExternalAgentSession;
use EfficiencyCode_external_agent_migration::sessions::ImportedSessionConnectorAttribution;
use EfficiencyCode_external_agent_migration::sessions::PendingSessionImport;
use EfficiencyCode_external_agent_migration::sessions::SessionImportTarget;
use EfficiencyCode_external_agent_migration::sessions::SessionMetadataMode;
use EfficiencyCode_external_agent_migration::sessions::append_existing_session;
use EfficiencyCode_external_agent_migration::sessions::append_imported_session_connector_names;
use EfficiencyCode_external_agent_migration::sessions::detect_imported_cla_session_connectors_by_source_path;
use EfficiencyCode_external_agent_migration::sessions::prepare_validated_session_import_with_metadata_mode;
use EfficiencyCode_external_agent_migration::sessions::record_completed_session_imports;
...
impl ExternalAgentSessionImporter {
    ...
    pub(super) async fn import_sessions(
        ...
        let completed_imports = completed_imports
            ...
            .collect();
        if let Err(err) =
            record_completed_session_imports(&self.EfficiencyCode_home, completed_imports)
        {
            record_import_error(
                &mut item_result,
                "session_ledger_update",
    ...
    async fn persist_session(
        ...
        let create_params = CreateThreadParams {
            ...
            source: source.clone(),
            thread_source: None,
            originator: EfficiencyCode_login::default_client::originator().value,
