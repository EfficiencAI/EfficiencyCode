...
use EfficiencyCode_app_server_protocol::AccountRateLimitsUpdatedNotification;
use EfficiencyCode_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use EfficiencyCode_app_server_protocol::CommandAction as V2ParsedCommand;
use EfficiencyCode_app_server_protocol::CommandExecutionApprovalDecision;
use EfficiencyCode_app_server_protocol::CommandExecutionPresentation;
...
use EfficiencyCode_app_server_protocol::DynamicToolCallParams;
use EfficiencyCode_app_server_protocol::EfficiencyCodeErrorInfo as V2EfficiencyCodeErrorInfo;
use EfficiencyCode_app_server_protocol::EnvironmentConnectionNotification;
use EfficiencyCode_app_server_protocol::ErrorNotification;
use EfficiencyCode_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use EfficiencyCode_app_server_protocol::FileChangeApprovalDecision;
use EfficiencyCode_app_server_protocol::FileChangeRequestApprovalParams;
use EfficiencyCode_app_server_protocol::FileChangeRequestApprovalResponse;
use EfficiencyCode_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use EfficiencyCode_app_server_protocol::GuardianWarningNotification;
use EfficiencyCode_app_server_protocol::HookCompletedNotification;
use EfficiencyCode_app_server_protocol::HookStartedNotification;
...
use EfficiencyCode_app_server_protocol::McpServerElicitationAction;
use EfficiencyCode_app_server_protocol::McpServerElicitationRequestParams;
use EfficiencyCode_app_server_protocol::McpServerElicitationRequestResponse;
use EfficiencyCode_app_server_protocol::McpServerStartupState;
use EfficiencyCode_app_server_protocol::McpServerStatusUpdatedNotification;
use EfficiencyCode_app_server_protocol::ModelReroutedNotification;
use EfficiencyCode_app_server_protocol::ModelSafetyBufferingUpdatedNotification;
use EfficiencyCode_app_server_protocol::ModelVerificationNotification;
use EfficiencyCode_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use EfficiencyCode_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use EfficiencyCode_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use EfficiencyCode_app_server_protocol::PermissionsRequestApprovalParams;
use EfficiencyCode_app_server_protocol::PermissionsRequestApprovalResponse;
use EfficiencyCode_app_server_protocol::RawResponseCompletedNotification;
use EfficiencyCode_app_server_protocol::RawResponseItemCompletedNotification;
...
use EfficiencyCode_app_server_protocol::ThreadRealtimeClosedNotification;
use EfficiencyCode_app_server_protocol::ThreadRealtimeErrorNotification;
use EfficiencyCode_app_server_protocol::ThreadRealtimeItemAddedNotification;
use EfficiencyCode_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use EfficiencyCode_app_server_protocol::ThreadRealtimeSdpNotification;
use EfficiencyCode_app_server_protocol::ThreadRealtimeStartedNotification;
use EfficiencyCode_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use EfficiencyCode_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use EfficiencyCode_app_server_protocol::ThreadRollbackResponse;
use EfficiencyCode_app_server_protocol::ThreadSettingsUpdatedNotification;
use EfficiencyCode_app_server_protocol::ThreadStatus;
use EfficiencyCode_app_server_protocol::ThreadTokenUsage;
use EfficiencyCode_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use EfficiencyCode_app_server_protocol::ToolRequestUserInputOption;
use EfficiencyCode_app_server_protocol::ToolRequestUserInputParams;
use EfficiencyCode_app_server_protocol::ToolRequestUserInputQuestion;
use EfficiencyCode_app_server_protocol::ToolRequestUserInputResponse;
...
use EfficiencyCode_app_server_protocol::TurnModerationMetadataNotification;
use EfficiencyCode_app_server_protocol::TurnPlanStep;
use EfficiencyCode_app_server_protocol::TurnPlanUpdatedNotification;
use EfficiencyCode_app_server_protocol::TurnStartedNotification;
use EfficiencyCode_app_server_protocol::TurnStatus;
use EfficiencyCode_app_server_protocol::WarningNotification;
use EfficiencyCode_app_server_protocol::build_item_from_guardian_event;
use EfficiencyCode_app_server_protocol::guardian_auto_approval_review_notification;
use EfficiencyCode_app_server_protocol::item_event_to_server_notification;
use EfficiencyCode_core::EfficiencyCodeThread;
use EfficiencyCode_core::ThreadManager;
use EfficiencyCode_protocol::ThreadId;
use EfficiencyCode_protocol::items::CollabAgentTool as CoreCollabAgentTool;
use EfficiencyCode_protocol::items::TurnItem as CoreTurnItem;
use EfficiencyCode_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use EfficiencyCode_protocol::plan_tool::UpdatePlanArgs;
use EfficiencyCode_protocol::protocol::EfficiencyCodeErrorInfo as CoreEfficiencyCodeErrorInfo;
use EfficiencyCode_protocol::protocol::Event;
use EfficiencyCode_protocol::protocol::EventMsg;
use EfficiencyCode_protocol::protocol::ExecApprovalRequestEvent;
use EfficiencyCode_protocol::protocol::Op;
use EfficiencyCode_protocol::protocol::RealtimeEvent;
use EfficiencyCode_protocol::protocol::ReviewDecision;
use EfficiencyCode_protocol::protocol::SubAgentActivityKind;
...
use EfficiencyCode_protocol::protocol::TurnDiffEvent;
...
use EfficiencyCode_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use EfficiencyCode_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use EfficiencyCode_sandboxing::policy_transforms::intersect_permission_profiles;
use EfficiencyCode_shell_command::parse_command::shlex_join;
...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    conversation: Arc<EfficiencyCodeThread>,
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error, failure_reason) = match update.status {
                EfficiencyCode_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None, None)
                }
                EfficiencyCode_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None, None)
                }
                EfficiencyCode_protocol::protocol::McpStartupStatus::Failed { error, reason } => (
                    McpServerStartupState::Failed,
                    Some(error),
                    reason.map(Into::into),
                ),
                EfficiencyCode_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status
                == EfficiencyCode_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            let completion_status = match assessment.status {
                EfficiencyCode_protocol::protocol::GuardianAssessmentStatus::Denied
                | EfficiencyCode_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                EfficiencyCode_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                EfficiencyCode_protocol::protocol::GuardianAssessmentStatus::InProgress
                | EfficiencyCode_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: EfficiencyCode_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            let EfficiencyCode_error_info = ev.EfficiencyCode_error_info.clone();
            ...
            if matches!(
                EfficiencyCode_error_info,
                Some(CoreEfficiencyCodeErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                EfficiencyCode_error_info: ev
                    .EfficiencyCode_error_info
                    .map(V2EfficiencyCodeErrorInfo::from),
...
async fn maybe_emit_raw_response_item_completed(
    conversation_id: ThreadId,
    turn_id: &str,
    item: EfficiencyCode_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: EfficiencyCode_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: EfficiencyCode_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<EfficiencyCodeThread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: EfficiencyCode_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            EfficiencyCode_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
async fn on_file_change_request_approval_response(
    ...
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    EfficiencyCode: Arc<EfficiencyCodeThread>,
    thread_state: Arc<Mutex<ThreadState>>,
    permission_guard: ThreadWatchActiveGuard,
) {
    let response = receiver.await;
...
mod tests {
    ...
    use EfficiencyCode_app_server_protocol::AutoReviewDecisionSource;
    ...
    use EfficiencyCode_app_server_protocol::TurnPlanStepStatus;
    use EfficiencyCode_login::EfficiencyCodeAuth;
    use EfficiencyCode_protocol::AgentPath;
    use EfficiencyCode_protocol::items::AgentMessageContent as CoreAgentMessageContent;
    use EfficiencyCode_protocol::items::AgentMessageItem as CoreAgentMessageItem;
    use EfficiencyCode_protocol::items::DynamicToolCallItem;
    use EfficiencyCode_protocol::items::DynamicToolCallStatus as CoreDynamicToolCallStatus;
    use EfficiencyCode_protocol::items::SubAgentActivityItem;
    use EfficiencyCode_protocol::items::TurnItem as CoreTurnItem;
    use EfficiencyCode_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    ...
    use EfficiencyCode_protocol::plan_tool::PlanItemArg;
    use EfficiencyCode_protocol::plan_tool::StepStatus;
    use EfficiencyCode_protocol::protocol::AgentMessageEvent;
    use EfficiencyCode_protocol::protocol::AskForApproval;
    use EfficiencyCode_protocol::protocol::CreditsSnapshot;
    use EfficiencyCode_protocol::protocol::EventMsg;
    use EfficiencyCode_protocol::protocol::GuardianAssessmentEvent;
    use EfficiencyCode_protocol::protocol::GuardianAssessmentStatus;
    use EfficiencyCode_protocol::protocol::ItemCompletedEvent;
    use EfficiencyCode_protocol::protocol::ItemStartedEvent;
    ...
    use EfficiencyCode_thread_store::StoredThreadHistory;
    use EfficiencyCode_utils_absolute_path::AbsolutePathBuf;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            started_at: None,
            reason: EfficiencyCode_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(EfficiencyCode_protocol::protocol::GuardianRiskLevel::Low),
                Some(EfficiencyCode_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(EfficiencyCode_protocol::protocol::GuardianRiskLevel::High),
                Some(EfficiencyCode_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(EfficiencyCode_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = EfficiencyCode_protocol::protocol::GuardianAssessmentAction::Command {
            source: EfficiencyCode_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: EfficiencyCode_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: EfficiencyCode_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(EfficiencyCode_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(
                    EfficiencyCode_protocol::protocol::GuardianUserAuthorization::Low,
                ),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    EfficiencyCode_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(EfficiencyCode_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(EfficiencyCode_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = EfficiencyCode_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: EfficiencyCode_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: EfficiencyCode_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn command_execution_started_helper_emits_once() -> Result<()> {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            EfficiencyCode_analytics::AnalyticsEventsClient::disabled(),
        ));
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&EfficiencyCode_home).await;
        let thread_manager = Arc::new(
            EfficiencyCode_core::test_support::thread_manager_with_models_provider_and_home(
                EfficiencyCodeAuth::create_dummy_chatgpt_auth_for_testing(),
                config.model_provider.clone(),
                config.EfficiencyCode_home.to_path_buf(),
                Arc::new(EfficiencyCode_exec_server::EnvironmentManager::default_for_tests()),
            ),
        );
        let EfficiencyCode_core::NewThread {
            thread_id: conversation_id,
            thread: conversation,
            ..
        } = thread_manager
            .start_thread(EfficiencyCode_core::StartThreadOptions::new(config.clone()))
            .await?;
        let thread_state = new_thread_state();
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                EfficiencyCode_error_info: Some(V2EfficiencyCodeErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(EfficiencyCode_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(EfficiencyCode_protocol::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(EfficiencyCode_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    trace_id: None,
                    started_at: Some(42),
                    model_context_window: None,
    ...
    async fn interrupted_subagent_activity_removes_missing_thread_watch() -> Result<()> {
        ...
        let EfficiencyCode_core::NewThread {
            ...
            .start_thread(EfficiencyCode_core::StartThreadOptions::new(config))
            .await?;
        ...
        assert_eq!(
            ...
            ItemCompletedNotification {
                item: ThreadItem::SubAgentActivity {
                    id: "activity-1".to_string(),
                    kind: EfficiencyCode_app_server_protocol::SubAgentActivityKind::Interrupted,
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                EfficiencyCode_error_info: Some(V2EfficiencyCodeErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                EfficiencyCode_error_info: Some(V2EfficiencyCodeErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
