...
use EfficiencyCode_app_server_protocol::Result;
...
use EfficiencyCode_otel::span_w3c_trace_context;
...
pub(crate) use EfficiencyCode_app_server_transport::ConnectionId;
pub(crate) use EfficiencyCode_app_server_transport::OutgoingError;
pub(crate) use EfficiencyCode_app_server_transport::OutgoingMessage;
pub(crate) use EfficiencyCode_app_server_transport::OutgoingResponse;
pub(crate) use EfficiencyCode_app_server_transport::QueuedOutgoingMessage;
...
mod tests {
    ...
    use EfficiencyCode_app_server_protocol::ApplyPatchApprovalParams;
    ...
    use EfficiencyCode_app_server_protocol::ModelRerouteReason;
    use EfficiencyCode_app_server_protocol::ModelReroutedNotification;
    use EfficiencyCode_app_server_protocol::ModelVerification;
    ...
    use EfficiencyCode_app_server_protocol::RateLimitWindow;
    use EfficiencyCode_app_server_protocol::ServerResponse;
    ...
    fn verify_model_rerouted_notification_serialization() {
        let notification = ServerNotification::ModelRerouted(ModelReroutedNotification {
            ...
            from_model: "gpt-5.3-EfficiencyCode".to_string(),
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    "threadId": "thread-1",
                    "turnId": "turn-1",
                    "fromModel": "gpt-5.3-EfficiencyCode",
                    "toModel": "gpt-5.2",
        ...
        outgoing
            .send_response(
                ...
                ClientResponsePayload::ThreadArchive(
                    EfficiencyCode_app_server_protocol::ThreadArchiveResponse {},
                ),
            )
            .await;
