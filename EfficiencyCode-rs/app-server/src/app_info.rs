use EfficiencyCode_app_server_protocol::AppBranding as ApiAppBranding;
use EfficiencyCode_app_server_protocol::AppInfo as ApiAppInfo;
use EfficiencyCode_app_server_protocol::AppMetadata as ApiAppMetadata;
use EfficiencyCode_app_server_protocol::AppReview as ApiAppReview;
use EfficiencyCode_app_server_protocol::AppScreenshot as ApiAppScreenshot;
use EfficiencyCode_app_server_protocol::AppToolSummary as ApiAppToolSummary;
use EfficiencyCode_app_server_protocol::ConnectorMetadata as ApiConnectorMetadata;
use EfficiencyCode_connectors::AppBranding;
use EfficiencyCode_connectors::AppInfo;
use EfficiencyCode_connectors::AppMetadata;
use EfficiencyCode_connectors::AppReview;
use EfficiencyCode_connectors::AppScreenshot;
...
/// Converts connector-domain app metadata owned by `EfficiencyCode-connectors` into the app-server wire
/// type owned by `EfficiencyCode-app-server-protocol`.
///
