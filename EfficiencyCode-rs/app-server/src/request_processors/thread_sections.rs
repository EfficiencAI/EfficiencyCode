...
use EfficiencyCode_app_server_protocol::ThreadSectionCreateResponse;
use EfficiencyCode_app_server_protocol::ThreadSectionDeleteParams;
use EfficiencyCode_app_server_protocol::ThreadSectionDeleteResponse;
...
use EfficiencyCode_app_server_protocol::ThreadSectionUpdateResponse;
use EfficiencyCode_state::PINNED_THREAD_SECTION_ID;
use EfficiencyCode_thread_store::CreateThreadSectionParams as StoreCreateThreadSectionParams;
use EfficiencyCode_thread_store::DeleteThreadSectionParams as StoreDeleteThreadSectionParams;
use EfficiencyCode_thread_store::ListThreadSectionsParams as StoreListThreadSectionsParams;
use EfficiencyCode_thread_store::RenameThreadSectionParams as StoreRenameThreadSectionParams;
use EfficiencyCode_thread_store::StoredThreadSection;
...
fn state_thread_section_appearance(
    appearance: ThreadSectionAppearance,
) -> EfficiencyCode_state::ThreadSectionAppearance {
    EfficiencyCode_state::ThreadSectionAppearance {
        icon: appearance.icon,
        color: appearance.color,
    }
