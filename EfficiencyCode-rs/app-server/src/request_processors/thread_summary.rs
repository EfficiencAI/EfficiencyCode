...
fn extract_conversation_summary(
    ...
    let preview = head
        ...
        .find_map(|item| match EfficiencyCode_core::parse_turn_item(&item) {
...
pub(super) fn with_thread_spawn_agent_metadata(
    source: EfficiencyCode_protocol::protocol::SessionSource,
    agent_nickname: Option<String>,
    agent_role: Option<String>,
) -> EfficiencyCode_protocol::protocol::SessionSource {
...
) -> Option<EfficiencyCode_app_server_protocol::ActivePermissionProfile> {
...
pub(crate) fn thread_settings_from_core_snapshot(
    snapshot: EfficiencyCode_protocol::protocol::ThreadSettingsSnapshot,
) -> ThreadSettings {
    let EfficiencyCode_protocol::protocol::ThreadSettingsSnapshot {
        model,
        model_provider_id,
        service_tier,
        approval_policy,
