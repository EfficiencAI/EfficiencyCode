...
use EfficiencyCode_app_server_protocol::PluginSearchResult;
use EfficiencyCode_app_server_protocol::PluginSearchScope;
use EfficiencyCode_core_plugins::OPENAI_BUNDLED_MARKETPLACE_NAME;
use EfficiencyCode_core_plugins::remote::RemotePluginSearchRequest;
use EfficiencyCode_core_plugins::remote::search_remote_plugins;
...
impl PluginRequestProcessor {
    ...
    async fn plugin_search_response(
        ...
        if auth_mode.is_some_and(DomainAuthMode::uses_EfficiencyCode_backend)
