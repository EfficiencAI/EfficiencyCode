...
use EfficiencyCode_analytics::PluginInstallSource;
use EfficiencyCode_app_server_protocol::PluginAvailability;
use EfficiencyCode_app_server_protocol::PluginInstallPolicy;
use EfficiencyCode_app_server_protocol::PluginSharePrincipalRole;
use EfficiencyCode_app_server_protocol::PluginShareTargetRole;
use EfficiencyCode_config::types::McpServerConfig;
use EfficiencyCode_core_plugins::OPENAI_CURATED_MARKETPLACE_NAME;
use EfficiencyCode_core_plugins::PluginListBackgroundTaskOptions;
use EfficiencyCode_core_plugins::is_openai_curated_marketplace_name;
use EfficiencyCode_core_plugins::loader::load_configured_plugin_mcp_servers;
use EfficiencyCode_core_plugins::manifest::is_agent_plugin_manifest;
use EfficiencyCode_core_plugins::remote::REMOTE_CREATED_BY_ME_MARKETPLACE_NAME;
use EfficiencyCode_core_plugins::remote::REMOTE_GLOBAL_MARKETPLACE_NAME;
use EfficiencyCode_core_plugins::remote::REMOTE_WORKSPACE_MARKETPLACE_NAME;
use EfficiencyCode_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_MARKETPLACE_NAME;
use EfficiencyCode_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_PRIVATE_MARKETPLACE_NAME;
use EfficiencyCode_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_UNLISTED_MARKETPLACE_NAME;
use EfficiencyCode_core_plugins::remote::RemoteAppTemplateUnavailableReason;
use EfficiencyCode_core_plugins::remote::RemotePluginCatalogCacheMode;
use EfficiencyCode_core_plugins::remote::RemotePluginScope;
use EfficiencyCode_core_plugins::remote::is_valid_remote_plugin_id;
use EfficiencyCode_core_plugins::remote::validate_remote_plugin_id;
use EfficiencyCode_core_plugins::remote_bundle::RemotePluginBundleInstallError;
use EfficiencyCode_mcp::McpOAuthLoginSupport;
use EfficiencyCode_mcp::McpRuntimeContext;
use EfficiencyCode_mcp::oauth_login_support;
use EfficiencyCode_mcp::should_retry_without_scopes;
use EfficiencyCode_plugin::PluginId;
use EfficiencyCode_plugin::PluginTelemetryMetadata;
use EfficiencyCode_protocol::auth::AuthMode as DomainAuthMode;
use EfficiencyCode_rmcp_client::McpOAuthClientRegistration;
use EfficiencyCode_rmcp_client::OAuthDiscoveryTimeout;
use EfficiencyCode_rmcp_client::StreamableHttpRedirectMode;
use EfficiencyCode_rmcp_client::perform_oauth_login_silent;
...
pub(crate) struct PluginRequestProcessor {
    ...
    on_effective_plugins_changed:
        Arc<dyn Fn(EfficiencyCode_core_plugins::EffectivePluginsChange) + Send + Sync>,
}

fn plugin_skills_to_info(
    skills: &[EfficiencyCode_skills::SkillMetadata],
    ...
    skills
        ...
        .map(|skill| SkillSummary {
            ...
            interface: skill.interface.clone().map(|interface| {
                EfficiencyCode_app_server_protocol::SkillInterface {
...
fn load_shared_plugin_ids_by_local_path(
    ...
    EfficiencyCode_core_plugins::remote::load_plugin_share_remote_ids_by_local_path(
...
fn convert_configured_marketplace_plugin_to_plugin_summary(
    plugin: EfficiencyCode_core_plugins::ConfiguredMarketplacePlugin,
    shared_plugin_ids_by_local_path: &std::collections::BTreeMap<AbsolutePathBuf, String>,
) -> PluginSummary {
...
) -> EfficiencyCode_core_plugins::remote::RemotePluginShareDiscoverability {
    match discoverability {
        PluginShareDiscoverability::Listed => {
            EfficiencyCode_core_plugins::remote::RemotePluginShareDiscoverability::Listed
        }
        PluginShareDiscoverability::Unlisted => {
            EfficiencyCode_core_plugins::remote::RemotePluginShareDiscoverability::Unlisted
        }
        PluginShareDiscoverability::Private => {
            EfficiencyCode_core_plugins::remote::RemotePluginShareDiscoverability::Private
        }
    }
}
...
) -> EfficiencyCode_core_plugins::remote::RemotePluginShareUpdateDiscoverability {
    match discoverability {
        PluginShareUpdateDiscoverability::Listed => {
            EfficiencyCode_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Listed
        }
        PluginShareUpdateDiscoverability::Unlisted => {
            EfficiencyCode_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Unlisted
        }
        PluginShareUpdateDiscoverability::Private => {
            EfficiencyCode_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Private
        }
    }
}
...
) -> EfficiencyCode_core_plugins::remote::RemotePluginShareTargetRole {
    match role {
        PluginShareTargetRole::Reader => {
            EfficiencyCode_core_plugins::remote::RemotePluginShareTargetRole::Reader
        }
        PluginShareTargetRole::Editor => {
            EfficiencyCode_core_plugins::remote::RemotePluginShareTargetRole::Editor
        }
    }
}

fn plugin_share_principal_role_from_remote(
    role: EfficiencyCode_core_plugins::remote::RemotePluginSharePrincipalRole,
) -> PluginSharePrincipalRole {
    match role {
        EfficiencyCode_core_plugins::remote::RemotePluginSharePrincipalRole::Reader => {
            PluginSharePrincipalRole::Reader
        }
        EfficiencyCode_core_plugins::remote::RemotePluginSharePrincipalRole::Editor => {
            PluginSharePrincipalRole::Editor
        }
        EfficiencyCode_core_plugins::remote::RemotePluginSharePrincipalRole::Owner => {
...
) -> Vec<EfficiencyCode_core_plugins::remote::RemotePluginShareTarget> {
    targets
        .into_iter()
        .map(
            |target| EfficiencyCode_core_plugins::remote::RemotePluginShareTarget {
                principal_type: match target.principal_type {
                    PluginSharePrincipalType::User => {
                        EfficiencyCode_core_plugins::remote::RemotePluginSharePrincipalType::User
                    }
                    PluginSharePrincipalType::Group => {
                        EfficiencyCode_core_plugins::remote::RemotePluginSharePrincipalType::Group
                    }
                    PluginSharePrincipalType::Workspace => {
                        EfficiencyCode_core_plugins::remote::RemotePluginSharePrincipalType::Workspace
                    }
                },
...
fn plugin_share_principal_from_remote(
    principal: EfficiencyCode_core_plugins::remote::RemotePluginSharePrincipal,
...
impl PluginRequestProcessor {
    pub(crate) fn new(
        ...
        on_effective_plugins_changed: Arc<
            dyn Fn(EfficiencyCode_core_plugins::EffectivePluginsChange) + Send + Sync,
        >,
    ) -> Self {
        Self {
            auth_manager,
    ...
    async fn workspace_EfficiencyCode_plugins_enabled(
        &self,
        config: &Config,
        auth: Option<&EfficiencyCodeAuth>,
    ) -> bool {
        match workspace_settings::EfficiencyCode_plugins_enabled_for_workspace(
            config,
            auth,
        ...
        .await
        {
            ...
            Err(err) => {
                warn!(
                    "failed to fetch workspace EfficiencyCode plugins setting; allowing EfficiencyCode plugins: {err:#}"
                );
                true
            }
        }
    ...
    async fn plugin_list_response(
        ...
        if !self
            .workspace_EfficiencyCode_plugins_enabled(&config, auth.as_ref())
            .await
        {
            return Ok(empty_response());
        }
        let auth_mode = auth.as_ref().map(EfficiencyCodeAuth::api_auth_mode);
        ...
        let use_remote_global_catalog = include_global_remote
            && auth_mode.is_some_and(DomainAuthMode::uses_EfficiencyCode_backend);
            ...
            match tokio::task::spawn_blocking(move || {
                ...
                Ok::<
                    (
                        ...
                        Vec<EfficiencyCode_app_server_protocol::MarketplaceLoadErrorInfo>,
                    ),
                    MarketplaceError,
                >((
                    outcome
                    ...
                    outcome
                        ...
                        .into_iter()
                        .map(
                            |err| EfficiencyCode_app_server_protocol::MarketplaceLoadErrorInfo {
        ...
        if include_vertical && !config.features.enabled(Feature::RemotePlugin) {
            match EfficiencyCode_core_plugins::remote::fetch_openai_curated_remote_collection_marketplace(
        ...
        if !remote_sources.is_empty() {
            match EfficiencyCode_core_plugins::remote::fetch_remote_marketplaces(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_sources,
                /*catalog_cache_root*/ Some(config.EfficiencyCode_home.as_path()),
    ...
    async fn load_local_installed_and_suggested_plugins(
        &self,
        plugins_manager: Arc<EfficiencyCode_core_plugins::PluginsManager>,
        config: &Config,
        plugins_input: &EfficiencyCode_core_plugins::PluginsConfigInput,
    ...
    async fn plugin_read_response(
        ...
        let plugins_input = config.plugins_config_input();
        let auth = self.auth_manager.auth().await;
        plugins_manager.set_auth_mode(auth.as_ref().map(EfficiencyCodeAuth::api_auth_mode));
        ...
        let plugin = match read_source {
            Ok(marketplace_path) => {
                ...
                let share_context = match share_context {
                    Some(context) => {
                        let remote_plugin_service_config = remote_plugin_service_config(&config);
                        match EfficiencyCode_core_plugins::remote::fetch_remote_plugin_share_context(
                            &remote_plugin_service_config,
                            auth.as_ref(),
                ...
                PluginDetail {
                    ...
                    hooks: outcome
                        ...
                        .into_iter()
                        .map(
                            |hook| EfficiencyCode_app_server_protocol::PluginHookSummary {
                                key: hook.key,
            ...
            Err(remote_marketplace_name) => {
                ...
                let remote_detail =
                    EfficiencyCode_core_plugins::remote::fetch_remote_plugin_detail(
                        &remote_plugin_service_config,
                        auth.as_ref(),
                        &remote_marketplace_name,
                        &plugin_name,
                ...
                let plugin_apps = remote_detail
                    ...
                    .iter()
                    .cloned()
                    .map(EfficiencyCode_plugin::AppConnectorId)
                    .collect::<Vec<_>>();
    ...
    async fn plugin_skill_read_response(
        ...
        let remote_skill_detail =
            EfficiencyCode_core_plugins::remote::fetch_remote_plugin_skill_detail(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_marketplace_name,
                &remote_plugin_id,
    ...
    async fn plugin_share_save_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let access_policy = EfficiencyCode_core_plugins::remote::RemotePluginShareAccessPolicy {
        ...
        let result = EfficiencyCode_core_plugins::remote::save_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.EfficiencyCode_home.as_path(),
            &plugin_path,
        ...
        EfficiencyCode_core_plugins::remote::invalidate_cached_remote_plugin_catalog_scopes(
            config.EfficiencyCode_home.as_path(),
            &remote_plugin_service_config,
            auth.as_ref(),
    ...
    async fn plugin_share_update_targets_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let result = EfficiencyCode_core_plugins::remote::update_remote_plugin_share_targets(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_plugin_id,
    ...
    async fn plugin_share_list_response(
        ...
        let (config, auth) = self.load_plugin_share_config_and_auth().await?;
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let data = EfficiencyCode_core_plugins::remote::list_remote_plugin_shares(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.EfficiencyCode_home.as_path(),
        )
    ...
    async fn plugin_share_checkout_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let result = EfficiencyCode_core_plugins::remote::checkout_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.EfficiencyCode_home.as_path(),
            &remote_plugin_id,
    ...
    async fn plugin_share_delete_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        EfficiencyCode_core_plugins::remote::delete_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.EfficiencyCode_home.as_path(),
            &remote_plugin_id,
    ...
    async fn load_plugin_share_config_and_auth(
        &self,
    ) -> Result<(Config, Option<EfficiencyCodeAuth>), JSONRPCErrorError> {
        let config = self.load_latest_config(/*fallback_cwd*/ None).await?;
        if !config.features.enabled(Feature::Plugins) {
    ...
    async fn plugin_install_response(
        ...
        {
            return Err(invalid_request(
                "EfficiencyCode plugins are disabled for this workspace",
            ));
        }
        ...
        let plugin_mcp_servers = load_configured_plugin_mcp_servers(
            ...
            auth.as_ref().map(EfficiencyCodeAuth::auth_mode),
            &result.plugin_id,
    ...
    async fn remote_plugin_install_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let remote_detail =
            EfficiencyCode_core_plugins::remote::fetch_remote_plugin_detail_with_download_urls(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_marketplace_name,
                &remote_plugin_id,
        ...
        let _remote_plugin_cache_mutation =
            EfficiencyCode_core_plugins::remote::mark_remote_plugin_cache_mutation_in_flight(
                config.EfficiencyCode_home.as_path(),
                &actual_remote_marketplace_name,
                &remote_plugin_name,
            );
        let validated_bundle =
            EfficiencyCode_core_plugins::remote_bundle::validate_remote_plugin_bundle(
                &remote_plugin_id,
                &actual_remote_marketplace_name,
                &remote_plugin_name,
        ...
        let result =
            EfficiencyCode_core_plugins::remote_bundle::download_and_install_remote_plugin_bundle(
                &remote_plugin_service_config,
        ...
        let install_result = if let Some(install_attempt_id) = install_attempt_id.as_deref() {
            EfficiencyCode_core_plugins::remote::install_remote_plugin_with_install_attempt_id(
                &remote_plugin_service_config,
                auth.as_ref(),
                &actual_remote_marketplace_name,
                &remote_plugin_id,
            ...
            EfficiencyCode_core_plugins::remote::install_remote_plugin(
                &remote_plugin_service_config,
                auth.as_ref(),
                &actual_remote_marketplace_name,
                &remote_plugin_id,
        ...
        let is_chatgpt_auth = auth
            .as_ref()
            .is_some_and(EfficiencyCodeAuth::is_chatgpt_auth);
    ...
    async fn plugin_apps_needing_auth_for_install(
        ...
        auth: Option<&EfficiencyCodeAuth>,
        plugin_id: &str,
        plugin_app_declarations: &[EfficiencyCode_plugin::AppDeclaration],
    ) -> Vec<AppSummary> {
        if plugin_app_declarations.is_empty()
            || !config
                .features
                .apps_enabled_for_auth(auth.is_some_and(EfficiencyCodeAuth::is_chatgpt_auth))
        {
            return Vec::new();
        }

        let plugin_apps =
            EfficiencyCode_plugin::app_connector_ids_from_declarations(plugin_app_declarations);
        ...
        let (accessible_connectors, EfficiencyCode_apps_ready) = match accessible_connectors_result
        {
            Ok(status) => (status.connectors, status.EfficiencyCode_apps_ready),
            Err(err) => {
                warn!(
                    plugin = plugin_id,
        ...
        if !EfficiencyCode_apps_ready {
            warn!(
                plugin = plugin_id,
                "EfficiencyCode_apps MCP not ready after plugin install; skipping appsNeedingAuth check"
            );
            return Vec::new();
        }
    ...
    async fn plugin_uninstall_response(
        ...
        if EfficiencyCode_plugin::PluginId::parse(&plugin_id).is_err()
    ...
    async fn remote_plugin_uninstall_response(
        ...
        let uninstall_target =
            EfficiencyCode_core_plugins::remote::resolve_remote_plugin_uninstall_target(
                &remote_plugin_service_config,
                auth.as_ref(),
                &plugin_id,
            )
        ...
        let uninstall_result = EfficiencyCode_core_plugins::remote::uninstall_remote_plugin(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.EfficiencyCode_home.to_path_buf(),
            uninstall_target,
...
async fn load_plugin_app_summaries(
    config: &Config,
    auth: Option<&EfficiencyCodeAuth>,
    plugin_apps: &[EfficiencyCode_plugin::AppConnectorId],
    ...
    if let Some(auth) = auth.filter(|auth| {
        config
            .features
            .apps_enabled_for_auth(auth.uses_EfficiencyCode_backend())
    }) {
        metadata_by_id.extend(
            EfficiencyCode_connectors::ConnectorMetadataStore::new(
                config.chatgpt_base_url.clone(),
                auth.get_account_id(),
    ...
    app_ids
        ...
        .map(|app_id| {
            ...
            AppSummary {
                install_url: Some(EfficiencyCode_connectors::metadata::connector_install_url(
                    &name, &app_id,
                )),
                id: app_id,
                name,
...
fn remote_plugin_share_discoverability_to_info(
    discoverability: EfficiencyCode_core_plugins::remote::RemotePluginShareDiscoverability,
...
fn remote_plugin_bundle_install_error_to_jsonrpc(
    err: EfficiencyCode_core_plugins::remote_bundle::RemotePluginBundleInstallError,
) -> JSONRPCErrorError {
