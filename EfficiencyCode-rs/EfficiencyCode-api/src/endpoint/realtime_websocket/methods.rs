...
use EfficiencyCode_client::backoff;
use EfficiencyCode_http_client::maybe_build_rustls_client_config_with_custom_ca;
use EfficiencyCode_protocol::protocol::ConversationTextParams;
use EfficiencyCode_protocol::protocol::ConversationTextRole;
use EfficiencyCode_protocol::protocol::RealtimeTranscriptDelta;
...
const REALTIME_WIRE_LOG_TARGET: &str = "EfficiencyCode_api::realtime_websocket::wire";
...
impl RealtimeWebsocketClient {
    ...
    async fn connect_realtime_websocket_url(
        ...
        // Realtime websocket TLS should honor the same custom-CA env vars as the rest of EfficiencyCode's
...
mod tests {
    ...
    use EfficiencyCode_protocol::protocol::RealtimeInputAudioSpeechStarted;
    use EfficiencyCode_protocol::protocol::RealtimeNoopRequested;
    use EfficiencyCode_protocol::protocol::RealtimeResponseCancelled;
    use EfficiencyCode_protocol::protocol::RealtimeResponseCreated;
    use EfficiencyCode_protocol::protocol::RealtimeResponseDone;
    use EfficiencyCode_protocol::protocol::RealtimeTranscriptDelta;
    use EfficiencyCode_protocol::protocol::RealtimeTranscriptDone;
    ...
    fn webrtc_frameless_sideband_ignores_provider_base_url() {
        let client = RealtimeWebsocketClient::new(Provider {
            ...
            base_url: "https://chatgpt.com/backend-api/EfficiencyCode".to_string(),
            query_params: None,
