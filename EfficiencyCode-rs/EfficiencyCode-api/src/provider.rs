...
use EfficiencyCode_client::RequestCompression;
use EfficiencyCode_client::RetryOn;
...
///
/// This is converted into a `RetryPolicy` used by `EfficiencyCode-client` to drive
