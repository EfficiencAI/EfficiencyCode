...
pub(crate) fn subagent_header(source: &Option<SessionSource>) -> Option<String> {
    ...
    match sub {
        EfficiencyCode_protocol::protocol::SubAgentSource::Review => Some("review".to_string()),
        EfficiencyCode_protocol::protocol::SubAgentSource::Compact => Some("compact".to_string()),
        EfficiencyCode_protocol::protocol::SubAgentSource::MemoryConsolidation => {
        ...
        EfficiencyCode_protocol::protocol::SubAgentSource::Other(label) => Some(label.clone()),
    }
}
