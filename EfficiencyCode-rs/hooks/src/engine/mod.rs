...
pub(crate) struct ConfiguredHandler {
    pub event_name: EfficiencyCode_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            EfficiencyCode_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            EfficiencyCode_protocol::protocol::HookEventName::PermissionRequest => {
                "permission-request"
            }
            EfficiencyCode_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            EfficiencyCode_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            EfficiencyCode_protocol::protocol::HookEventName::PostCompact => "post-compact",
            EfficiencyCode_protocol::protocol::HookEventName::SessionStart => "session-start",
            EfficiencyCode_protocol::protocol::HookEventName::SessionEnd => "session-end",
            EfficiencyCode_protocol::protocol::HookEventName::UserPromptSubmit => {
                "user-prompt-submit"
            }
            EfficiencyCode_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            EfficiencyCode_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            EfficiencyCode_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
...
pub struct HookListEntry {
    ...
    pub execution_mode: EfficiencyCode_protocol::protocol::HookExecutionMode,
}
