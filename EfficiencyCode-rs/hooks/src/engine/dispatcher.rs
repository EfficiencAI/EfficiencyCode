...
pub(crate) fn completed_summary(
    ...
    entries: Vec<EfficiencyCode_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    HookRunSummary {
        id: handler.run_id(),
        event_name: handler.event_name,
...
pub(crate) fn hook_source_label(
    source: EfficiencyCode_protocol::protocol::HookSource,
) -> &'static str {
    match source {
        EfficiencyCode_protocol::protocol::HookSource::System => "system",
        EfficiencyCode_protocol::protocol::HookSource::User => "user",
        EfficiencyCode_protocol::protocol::HookSource::Project => "project",
        EfficiencyCode_protocol::protocol::HookSource::Mdm => "mdm",
        EfficiencyCode_protocol::protocol::HookSource::SessionFlags => "session_flags",
        EfficiencyCode_protocol::protocol::HookSource::Plugin => "plugin",
        EfficiencyCode_protocol::protocol::HookSource::CloudRequirements => "cloud_requirements",
        EfficiencyCode_protocol::protocol::HookSource::CloudManagedConfig => "cloud_managed_config",
        EfficiencyCode_protocol::protocol::HookSource::LegacyManagedConfigFile => {
            "legacy_managed_config_file"
        }
        EfficiencyCode_protocol::protocol::HookSource::LegacyManagedConfigMdm => {
            "legacy_managed_config_mdm"
        }
        EfficiencyCode_protocol::protocol::HookSource::Unknown => "unknown",
    }
}
