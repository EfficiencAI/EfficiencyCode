...
impl Hooks {
    ...
    pub fn new(
        ...
        Self,
        Receiver<EfficiencyCode_protocol::protocol::HookCompletedEvent>,
    ) {
    ...
    ) -> Vec<EfficiencyCode_protocol::protocol::HookRunSummary> {
    ...
    pub fn preview_session_end(&self) -> Vec<EfficiencyCode_protocol::protocol::HookRunSummary> {
