...
use EfficiencyCode_protocol::config_types::WebSearchFilters as ConfigWebSearchFilters;
use EfficiencyCode_protocol::config_types::WebSearchUserLocation as ConfigWebSearchUserLocation;
