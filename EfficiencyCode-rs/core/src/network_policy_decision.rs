use EfficiencyCode_execpolicy::Decision as ExecPolicyDecision;
use EfficiencyCode_execpolicy::NetworkRuleProtocol as ExecPolicyNetworkRuleProtocol;
use EfficiencyCode_network_proxy::BlockedRequest;
use EfficiencyCode_network_proxy::NetworkPolicyDecision;
...
use EfficiencyCode_protocol::network_policy::NetworkPolicyDecisionPayload;
