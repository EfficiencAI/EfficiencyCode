...
use EfficiencyCode_git_utils::get_git_remote_urls_assume_git_repo;
use EfficiencyCode_git_utils::get_git_repo_root;
use EfficiencyCode_git_utils::get_has_changes_in_repo;
use EfficiencyCode_git_utils::get_head_commit_hash;
...
pub async fn detached_memory_responses_metadata(
    ...
    EfficiencyCodeResponsesMetadata {
        request_kind: Some(EfficiencyCodeResponsesRequestKind::Memory),
        ...
        ..EfficiencyCodeResponsesMetadata::new(installation_id, session_id, thread_id, window_id)
    }
}
...
impl TurnMetadataState {
    ...
    fn responses_metadata_template(&self) -> EfficiencyCodeResponsesMetadata {
    ...
    fn mcp_metadata_template(&self) -> EfficiencyCodeResponsesMetadata {
        let mut extra = self
            .responsesapi_client_metadata
            .read()
            .unwrap_or_else(std::sync::PoisonError::into_inner)
