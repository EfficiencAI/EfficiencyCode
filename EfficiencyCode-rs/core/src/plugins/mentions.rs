...
use EfficiencyCode_connectors::metadata::connector_mention_slug;
...
use EfficiencyCode_skills::extract_tool_mentions_with_sigil;
use EfficiencyCode_skills::plugin_config_name_from_path;
