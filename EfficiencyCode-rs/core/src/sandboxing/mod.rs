...
command transformation live in the EfficiencyCode-sandboxing crate; this module keeps
...
pub use EfficiencyCode_protocol::models::SandboxPermissions;
...
pub(crate) struct ExecServerEnvConfig {
    pub(crate) policy: EfficiencyCode_exec_server::ExecEnvPolicy,
...
impl ExecRequest {
    ...
    pub(crate) fn from_sandbox_exec_request(
        ...
        if !network_sandbox_policy.is_enabled() {
            env.insert(CODEX_SANDBOX_ENV_VAR.to_string(), "1".to_string());
        }
        #[cfg(target_os = "macos")]
...
) -> EfficiencyCode_protocol::error::Result<ExecToolCallOutput> {
