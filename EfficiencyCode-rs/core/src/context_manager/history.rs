...
use EfficiencyCode_utils_audio::estimate_audio_token_count;
use EfficiencyCode_utils_cache::BlockingLruCache;
use EfficiencyCode_utils_cache::sha1_digest;
...
use EfficiencyCode_utils_output_truncation::approx_tokens_from_byte_count_i64;
use EfficiencyCode_utils_output_truncation::truncate_function_output_items_with_policy;
...
impl ContextManager {
    ...
    where
        I: IntoIterator<Item = (T, Option<&'a EfficiencyCodeHarnessMetadata>)>,
