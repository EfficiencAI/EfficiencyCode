...
pub(crate) struct GuardianAssessment {
    pub(crate) risk_level: EfficiencyCode_protocol::protocol::GuardianRiskLevel,
    pub(crate) user_authorization: EfficiencyCode_protocol::protocol::GuardianUserAuthorization,
