...
use EfficiencyCode_network_proxy::NetworkPolicyDecider;
...
use EfficiencyCode_protocol::protocol::TerminalInteractionEvent;
...
const NETWORK_ACCESS_DENIED_MESSAGE: &str =
    "Network access was denied by the EfficiencyCode sandbox network proxy.";
...
fn exec_env_policy_from_shell_policy(
...
) -> EfficiencyCode_exec_server::ExecEnvPolicy {
    ...
    exclude.extend([
        ...
        EfficiencyCode_apply_patch::EfficiencyCode_APPLY_PATCH_PRESERVE_LINE_ENDINGS_ENV_VAR
            .to_string(),
    ]);
...
fn exec_server_env_for_request(
    ...
    Option<EfficiencyCode_exec_server::ExecEnvPolicy>,
    HashMap<String, String>,
) {
...
fn exec_server_params_for_request(
    ...
    tty: bool,
) -> EfficiencyCode_exec_server::ExecParams {
...
fn network_approval_error_message(err: ToolError) -> String {
    match err {
        ...
        ToolError::EfficiencyCode(err) => err.to_string(),
    }
}
...
impl UnifiedExecProcessManager {
    ...
    pub(crate) async fn open_session_with_exec_env(
        ...
        network_proxy_launch: Option<EfficiencyCode_network_proxy::RemoteNetworkProxyLaunchConfig>,
        ...
        .map_err(|err| match err {
            UnifiedExecError::SandboxDenied { output, .. } => {
                ToolError::EfficiencyCode(EfficiencyCodeErr::Sandbox(SandboxErr::Denied {
    ...
    pub(crate) async fn open_session_with_prepared_exec_env(
        ...
        let network_proxy_restricting_sid = {
            ...
            {
                if request.sandbox == EfficiencyCode_sandboxing::SandboxType::WindowsRestrictedToken
                {
                    request
                        .network
                        .as_ref()
        ...
        let windows_sandbox =
            if request.sandbox == EfficiencyCode_sandboxing::SandboxType::WindowsRestrictedToken {
                Some(EfficiencyCode_sandboxing::WindowsSandboxSpawnRequest {
        ...
        let spawn_result =
            EfficiencyCode_sandboxing::spawn_process(EfficiencyCode_sandboxing::SpawnRequest {
    ...
    pub(super) async fn open_session_with_sandbox(
        ...
        env.insert(
            EfficiencyCode_THREAD_ID_ENV_VAR.to_string(),
        ...
        orchestrator
            ...
            .map_err(|err| match err {
                ToolError::EfficiencyCode(err) => match err.details() {
