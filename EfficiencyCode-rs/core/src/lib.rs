//! Root of the `EfficiencyCode-core` library.
...
pub use EfficiencyCode_thread::BackgroundTerminalInfo;
pub use EfficiencyCode_thread::EfficiencyCodeThread;
pub use EfficiencyCode_thread::EfficiencyCodeThreadSettingsOverrides;
pub use EfficiencyCode_thread::ThreadConfigSnapshot;
pub use EfficiencyCode_thread::TryStartTurnIfIdleError;
pub use EfficiencyCode_thread::TryStartTurnIfIdleRejectionReason;
...
pub use EfficiencyCode_mcp::EfficiencyCodeAppsToolsCache;
pub use EfficiencyCode_mcp::SandboxState;
mod mcp_openai_file;
mod mcp_tool_call;
...
pub use EfficiencyCode_protocol::config_types::ModelProviderAuthInfo;
pub use client::X_RESPONSESAPI_INCLUDE_TIMING_METRICS_HEADER;
mod event_mapping;
pub use EfficiencyCode_prompts as review_prompts;
mod thread_manager;
...
#[deprecated(note = "use EfficiencyCodeThread")]
pub type EfficiencyCodeConversation = EfficiencyCodeThread;
...
pub use EfficiencyCode_prompts::REVIEW_PROMPT;
...
pub use client::X_EfficiencyCode_INSTALLATION_ID_HEADER;
pub use client::X_EfficiencyCode_ROUTING_HINT_HEADER;
pub use client::X_EfficiencyCode_TURN_METADATA_HEADER;
