...
/// `EfficiencyCode_feedback::EfficiencyCodeFeedback::metadata_layer()` is installed, these fields are captured and
...
///
/// EfficiencyCode_core::feedback_tags!(model = "gpt-5", cached = true);
/// EfficiencyCode_core::feedback_tags!(provider = provider_id, request_id = request_id);
/// ```
#[macro_export]
