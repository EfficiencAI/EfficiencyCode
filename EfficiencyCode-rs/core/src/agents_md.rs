...
use EfficiencyCode_config::default_project_root_markers;
use EfficiencyCode_config::merge_toml_values;
use EfficiencyCode_config::project_root_markers_from_config;
...
impl LoadedAgentsMd {
    ...
    /// compile `EfficiencyCode-core` as a normal dependency without that configuration.
