...
use EfficiencyCode_analytics::ImageDetailSetting;
...
use EfficiencyCode_utils_image::PromptImageResizeLimits;
use EfficiencyCode_utils_image::load_data_url_for_prompt;
use tracing::warn;
