...
//!
//! `EfficiencyCode-rollout-trace` owns the event schema and writer behavior. This module
...
use EfficiencyCode_rollout_trace::ToolDispatchInvocation;
use EfficiencyCode_rollout_trace::ToolDispatchPayload;
use EfficiencyCode_rollout_trace::ToolDispatchRequester;
use EfficiencyCode_rollout_trace::ToolDispatchResult;
use EfficiencyCode_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        EfficiencyCode_turn_id: invocation.turn.sub_id.clone(),
