...
impl CodeModeExecuteHandler {
    ...
    async fn execute(
        ...
        let args = EfficiencyCode_code_mode::parse_exec_source(&code)
        ...
        for (spec, cached_runtime) in &self.nested_tool_specs {
            ...
            let definitions = EfficiencyCode_tools::collect_code_mode_tool_definitions(
        ...
        let started_cell = exec
            ...
            .services
            .code_mode_service
            .execute(EfficiencyCode_code_mode::ExecuteRequest {
        ...
        exec.session
            ...
            .track_code_mode_tool_call(
                EfficiencyCode_analytics::CodeModeToolCallFact::CellStarted {
