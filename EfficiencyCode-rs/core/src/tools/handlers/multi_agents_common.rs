...
pub(crate) fn collab_spawn_error(err: EfficiencyCodeErr) -> FunctionCallError {
    match err.details() {
...
pub(crate) fn collab_agent_error(agent_id: ThreadId, err: EfficiencyCodeErr) -> FunctionCallError {
    match err.details() {
