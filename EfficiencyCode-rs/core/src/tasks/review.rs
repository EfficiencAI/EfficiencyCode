...
use EfficiencyCode_prompts::render_review_exit_interrupted;
use EfficiencyCode_prompts::render_review_exit_success;
...
use EfficiencyCode_protocol::review_format::format_review_findings_block;
use EfficiencyCode_protocol::review_format::render_review_output_text;
use tokio_util::sync::CancellationToken;

use crate::EfficiencyCode_delegate::run_EfficiencyCode_thread_one_shot;
...
impl SessionTask for ReviewTask {
    ...
    async fn run(
        ...
        // Start sub-EfficiencyCode conversation and get the receiver for events.
...
async fn start_review_conversation(
    ...
    (run_EfficiencyCode_thread_one_shot(
        sub_agent_config,
