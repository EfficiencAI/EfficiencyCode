...
use EfficiencyCode_core_plugins::startup_sync::curated_plugins_repo_path;
...
use EfficiencyCode_protocol::approvals::ElicitationAction;
...
const CALENDAR_NAMESPACE: &str = "mcp__EfficiencyCode_apps__calendar";
            ...
            .find_map(|request| {
                ...
                payload["events"].as_array().and_then(|events| {
                    events
                        .iter()
                        .find(|event| {
                            event["event_type"] == "EfficiencyCode_plugin_install_requested"
                        })
                        .cloned()
                })
            })
    ...
    assert_eq!(
        ...
        json!({
            ...
            "event_params": {
                ...
                "turn_id": turn_id,
                "model_slug": "gpt-5.4",
                "product_client_id": EfficiencyCode_login::default_client::originator().value,
            }
        })
    );
