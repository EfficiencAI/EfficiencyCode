...
async fn ultra_reasoning_uses_max_and_proactive_mode() -> Result<()> {
    ...
    submit_turn(&test.EfficiencyCode, "hello", /*effort*/ None).await?;
...
async fn empty_configured_mode_hint_emits_no_mode_message() -> Result<()> {
    ...
    submit_turn(&test.EfficiencyCode, "hello", Some(ReasoningEffort::High)).await?;
...
async fn live_mode_change_appends_mode_without_reappending_usage_hint() -> Result<()> {
    ...
    submit_turn(&test.EfficiencyCode, "proactive", /*effort*/ None).await?;
    submit_turn(
        &test.EfficiencyCode,
        "explicit",
        Some(ReasoningEffort::High),
