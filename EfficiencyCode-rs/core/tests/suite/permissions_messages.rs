...
use EfficiencyCode_core::context::ApprovalPromptContext;
use EfficiencyCode_core::context::ContextualUserFragment;
use EfficiencyCode_core::context::PermissionsInstructions;
use EfficiencyCode_core::load_exec_policy;
use EfficiencyCode_models_manager::model_info::model_info_from_slug;
use EfficiencyCode_protocol::models::PermissionProfile;
use EfficiencyCode_protocol::openai_models::ApprovalMessages;
use EfficiencyCode_protocol::openai_models::ModelMessages;
use EfficiencyCode_protocol::openai_models::ModelsResponse;
use EfficiencyCode_protocol::openai_models::PermissionMessages;
...
) -> EfficiencyCode_protocol::openai_models::ModelInfo {
