...
use EfficiencyCode_protocol::openai_models::CollaborationModeMessages;
use EfficiencyCode_protocol::openai_models::ModelMessages;
use EfficiencyCode_protocol::openai_models::ModelsResponse;
use EfficiencyCode_protocol::protocol::COLLABORATION_MODE_CLOSE_TAG;
            ...
            thread_settings: EfficiencyCode_protocol::protocol::ThreadSettingsOverrides {
                ...
                summary: Some(
                    test.config
                        ...
                        .unwrap_or(EfficiencyCode_protocol::config_types::ReasoningSummary::Auto),
                ),
                collaboration_mode: Some(collaboration_mode),
                ..Default::default()
            },
