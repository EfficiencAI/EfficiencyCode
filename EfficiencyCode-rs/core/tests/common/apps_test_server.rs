use crate::test_EfficiencyCode::TestEfficiencyCodeBuilder;
use crate::test_EfficiencyCode::test_EfficiencyCode;
...
const EfficiencyCode_APPS_META_KEY: &str = "_EfficiencyCode_apps";
const EfficiencyCode_APPS_MCP_PATH_REGEX: &str = "^/api/EfficiencyCode/ps/mcp/?$";
const HOSTED_PLUGIN_RUNTIME_MCP_PATH_REGEX: &str = "^/api/EfficiencyCode/ps/mcp/?$";
const PROTOCOL_VERSION: &str = "2025-11-25";
const SERVER_NAME: &str = "EfficiencyCode-apps-test";
...
pub const DIRECT_CALENDAR_CREATE_EVENT_TOOL: &str =
    "mcp__EfficiencyCode_apps__calendar__create_event";
pub const DIRECT_CALENDAR_APP_ONLY_TOOL: &str =
    "mcp__EfficiencyCode_apps__calendar__app_only_action";
pub const DIRECT_CALENDAR_LIST_EVENTS_TOOL: &str =
    "mcp__EfficiencyCode_apps__calendar__list_events";
pub const DIRECT_CALENDAR_EXTRACT_TEXT_TOOL: &str =
    "mcp__EfficiencyCode_apps__calendar__extract_text";
pub const SEARCH_CALENDAR_NAMESPACE: &str = "mcp__EfficiencyCode_apps__calendar";
...
impl AppsTestServer {
    ...
    pub async fn mount_with_startup_control(
        ...
        mount_streamable_http_json_rpc_with_startup_control(
            server,
            EfficiencyCode_APPS_MCP_PATH_REGEX,
            CONNECTOR_NAME.to_string(),
            CONNECTOR_DESCRIPTION.to_string(),
            /*searchable*/ true,
            /*include_app_only_tool*/ false,
...
pub fn apps_enabled_builder(apps_base_url: impl Into<String>) -> TestEfficiencyCodeBuilder {
...
pub fn search_capable_apps_builder(apps_base_url: impl Into<String>) -> TestEfficiencyCodeBuilder {
    let apps_base_url = apps_base_url.into();
    test_EfficiencyCode()
        .with_auth(EfficiencyCodeAuth::create_dummy_chatgpt_auth_for_testing())
...
fn apps_tool_call_id(body: &Value) -> Option<&str> {
    body.get("params")?
        .get("_meta")?
        .get(EfficiencyCode_APPS_META_KEY)?
        .get("call_id")?
        .as_str()
}
...
pub async fn recorded_apps_tool_calls(server: &MockServer) -> Vec<Value> {
    server
        ...
        .filter_map(|request| {
            ...
            (request.url.path() == "/api/EfficiencyCode/ps/mcp"
...
async fn mount_streamable_http_json_rpc_with_startup_control(
    ...
    Mock::given(method("POST"))
        ...
        .respond_with(EfficiencyCodeAppsJsonRpcResponder {
            connector_name,
            connector_description,
            searchable,
            include_app_only_tool,
...
struct EfficiencyCodeAppsJsonRpcResponder {
    connector_name: String,
    connector_description: String,
    searchable: bool,
    include_app_only_tool: bool,
...
impl Respond for EfficiencyCodeAppsJsonRpcResponder {
        ...
        match method {
            ...
            "tools/call" => {
                ...
                let file_id = body
                    ...
                    .and_then(Value::as_str)
                    .unwrap_or_default();
                let EfficiencyCode_apps_meta =
                    body.pointer("/params/_meta/_EfficiencyCode_apps").cloned();
                ...
                ResponseTemplate::new(200).set_body_json(json!({
                    ...
                    "result": {
                        ...
                        "structuredContent": {
                            "_EfficiencyCode_apps": EfficiencyCode_apps_meta,
                        },
                        "isError": false
                    }
                }))
