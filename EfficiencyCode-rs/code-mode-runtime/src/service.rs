...
use EfficiencyCode_code_mode_protocol::CodeModeSession;
...
use EfficiencyCode_code_mode_protocol::CodeModeSessionResultFuture;
use EfficiencyCode_code_mode_protocol::CodeModeToolKind;
use EfficiencyCode_code_mode_protocol::DEFAULT_EXEC_YIELD_TIME_MS;
use EfficiencyCode_code_mode_protocol::ExecuteRequest;
use EfficiencyCode_code_mode_protocol::ExecuteToPendingOutcome;
use EfficiencyCode_code_mode_protocol::FunctionCallOutputContentItem;
use EfficiencyCode_code_mode_protocol::ImageDetail;
use EfficiencyCode_code_mode_protocol::NoopCodeModeSessionDelegate;
...
use EfficiencyCode_code_mode_protocol::WaitToPendingOutcome;
use EfficiencyCode_code_mode_protocol::WaitToPendingRequest;
        ...
        self.delegate
            .invoke_tool(
                CodeModeNestedToolCall {
                    ...
                    tool_name: EfficiencyCode_protocol::ToolName {
