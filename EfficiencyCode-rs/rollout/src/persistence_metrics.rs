...
const ITEM_BYTES_METRIC: &str = "EfficiencyCode.rollout.persistence.item_bytes";
const APPEND_METRIC: &str = "EfficiencyCode.rollout.persistence.append";
const TURN_BYTES_METRIC: &str = "EfficiencyCode.rollout.persistence.turn_bytes";
const MEASUREMENT_ERROR_METRIC: &str = "EfficiencyCode.rollout.persistence.measurement_error";
...
impl RolloutPersistenceTelemetry {
    pub fn new(thread_id: ThreadId) -> Self {
        let metrics = EfficiencyCode_otel::global();
