...
use EfficiencyCode_uds::UnixStream;
...
pub struct RemoteAppServerClient {
    ...
    EfficiencyCode_home: Option<String>,
...
impl RemoteAppServerClient {
    ...
    pub fn EfficiencyCode_home(&self) -> Option<&str> {
        self.EfficiencyCode_home.as_deref()
    }
        ...
        S: AsyncRead + AsyncWrite + Unpin + Send + 'static,
    {
        ...
        let (pending_events, server_version, EfficiencyCode_home) = initialize_remote_connection(
            &mut stream,
            &endpoint,
            initialize_params,
            INITIALIZE_TIMEOUT,
    ...
    pub async fn shutdown(self) -> IoResult<()> {
        let Self {
            ...
            EfficiencyCode_home: _EfficiencyCode_home,
            worker_handle,
        } = self;
    ...
    S: AsyncRead + AsyncWrite + Unpin,
{
    ...
    let mut EfficiencyCode_home = None;
                ...
                Some(Ok(Message::Text(text))) => {
                    ...
                    match message {
                        JSONRPCMessage::Response(response) if response.id == initialize_request_id => {
                            ...
                            EfficiencyCode_home = response
                                .result
                                .get("EfficiencyCodeHome")
                                .and_then(serde_json::Value::as_str)
                                .filter(|EfficiencyCode_home| !EfficiencyCode_home.is_empty())
                                .map(str::to_string);
                            break Ok(());
                        }
    ...
    Ok((pending_events, server_version, EfficiencyCode_home))
}
