...
use EfficiencyCode_protocol::models::SandboxPermissions;
use EfficiencyCode_protocol::protocol::GuardianAssessmentOutcome;
use EfficiencyCode_protocol::protocol::GuardianCommandSource;
use EfficiencyCode_protocol::protocol::GuardianRiskLevel;
use EfficiencyCode_protocol::protocol::GuardianUserAuthorization;
...
pub(crate) enum TrackEventRequest {
    ...
    AppMentioned(EfficiencyCodeAppMentionedEventRequest),
    AppUsed(EfficiencyCodeAppUsedEventRequest),
    HookRun(EfficiencyCodeHookRunEventRequest),
    Compaction(Box<EfficiencyCodeCompactionEventRequest>),
    Goal(Box<EfficiencyCodeGoalEventRequest>),
    TurnEvent(Box<EfficiencyCodeTurnEventRequest>),
    TurnSteer(EfficiencyCodeTurnSteerEventRequest),
    ArtifactOperation(EfficiencyCodeArtifactOperationEventRequest),
    CommandExecution(EfficiencyCodeCommandExecutionEventRequest),
    FileChange(EfficiencyCodeFileChangeEventRequest),
    McpToolCall(EfficiencyCodeMcpToolCallEventRequest),
    DynamicToolCall(EfficiencyCodeDynamicToolCallEventRequest),
    CollabAgentToolCall(EfficiencyCodeCollabAgentToolCallEventRequest),
    WebSearch(EfficiencyCodeWebSearchEventRequest),
    ImageGeneration(EfficiencyCodeImageGenerationEventRequest),
    AcceptedLineFingerprints(Box<EfficiencyCodeAcceptedLineFingerprintsEventRequest>),
    #[allow(dead_code)]
    ReviewEvent(EfficiencyCodeReviewEventRequest),
    PluginUsed(EfficiencyCodePluginUsedEventRequest),
    PluginInstallRequested(EfficiencyCodePluginInstallRequestedEventRequest),
    PluginInstalled(EfficiencyCodePluginEventRequest),
    PluginUninstalled(EfficiencyCodePluginEventRequest),
    PluginEnabled(EfficiencyCodePluginEventRequest),
    PluginDisabled(EfficiencyCodePluginEventRequest),
    PluginInstallFailed(EfficiencyCodePluginInstallFailedEventRequest),
    ExternalAgentConfigImportCompleted(
        EfficiencyCodeOnboardingExternalAgentImportCompleteEventRequest,
    ),
    ExternalAgentConfigImportFailure(
        EfficiencyCodeOnboardingExternalAgentImportFailureEventRequest,
    ),
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodeArtifactOperationEventParams {
    ...
    pub(crate) runtime: EfficiencyCodeRuntimeMetadata,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeArtifactOperationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeArtifactOperationEventParams,
}

pub(crate) fn EfficiencyCode_artifact_operation_event_request(
    tracking: TrackEventsContext,
    operation: ArtifactOperation,
) -> EfficiencyCodeArtifactOperationEventRequest {
    EfficiencyCodeArtifactOperationEventRequest {
        event_type: "EfficiencyCode_artifact_operation",
        event_params: EfficiencyCodeArtifactOperationEventParams {
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeAcceptedLineFingerprintsEventParams {
    pub(crate) event_type: &'static str,
    pub(crate) turn_id: String,
    pub(crate) thread_id: String,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeAcceptedLineFingerprintsEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeAcceptedLineFingerprintsEventParams,
}
...
pub(crate) struct EfficiencyCodeAppServerClientMetadata {
    pub(crate) product_client_id: String,
...
#[derive(Clone, Serialize)]
pub(crate) struct EfficiencyCodeRuntimeMetadata {
    pub(crate) EfficiencyCode_rs_version: String,
...
pub(crate) struct ThreadInitializedEventParams {
    ...
    pub(crate) app_server_client: EfficiencyCodeAppServerClientMetadata,
    pub(crate) runtime: EfficiencyCodeRuntimeMetadata,
...
pub enum GuardianApprovalRequestSource {
    /// Approval requested directly by the main EfficiencyCode turn.
    MainTurn,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeToolItemEventBase {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeReviewEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeReviewEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeReviewEventParams,
}
#[allow(dead_code)]
#[derive(Clone, Copy, Debug, Serialize)]
#[serde(rename_all = "snake_case")]
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeCommandExecutionEventParams {
    #[serde(flatten)]
    pub(crate) base: EfficiencyCodeToolItemEventBase,
    pub(crate) plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeCommandExecutionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeCommandExecutionEventParams,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodeFileChangeEventParams {
    #[serde(flatten)]
    pub(crate) base: EfficiencyCodeToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeFileChangeEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeFileChangeEventParams,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodeMcpToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: EfficiencyCodeToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeMcpToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeMcpToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodeDynamicToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: EfficiencyCodeToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeDynamicToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeDynamicToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodeCollabAgentToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: EfficiencyCodeToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeCollabAgentToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeCollabAgentToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodeWebSearchEventParams {
    #[serde(flatten)]
    pub(crate) base: EfficiencyCodeToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeWebSearchEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeWebSearchEventParams,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodeImageGenerationEventParams {
    #[serde(flatten)]
    pub(crate) base: EfficiencyCodeToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeImageGenerationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeImageGenerationEventParams,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodeAppMetadata {
    pub(crate) connector_id: Option<String>,
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeAppMentionedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodeAppUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodeHookRunMetadata {
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) product_client_id: Option<String>,
    pub(crate) model_slug: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeHookRunEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeHookRunMetadata,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodeCompactionEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
    pub(crate) app_server_client: EfficiencyCodeAppServerClientMetadata,
    ...
    pub(crate) EfficiencyCode_error_kind: Option<EfficiencyCodeErrKind>,
    pub(crate) EfficiencyCode_error_http_status_code: Option<u16>,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeCompactionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeCompactionEventParams,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodeGoalEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: Option<String>,
    pub(crate) app_server_client: EfficiencyCodeAppServerClientMetadata,
    ...
    pub(crate) goal_status: EfficiencyCode_state::ThreadGoalStatus,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeGoalEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeGoalEventParams,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodeTurnEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
    ...
    pub(crate) turn_error: Option<EfficiencyCodeErrorInfo>,
    pub(crate) EfficiencyCode_error_kind: Option<EfficiencyCodeErrKind>,
    pub(crate) EfficiencyCode_error_http_status_code: Option<u16>,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeTurnEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeTurnEventParams,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodeTurnSteerEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeTurnSteerEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeTurnSteerEventParams,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodePluginMetadata {
    pub(crate) plugin_id: Option<String>,
    pub(crate) remote_plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodePluginUsedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: EfficiencyCodePluginMetadata,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodePluginInstallRequestedPluginMetadata {
    pub(crate) plugin_id: String,
    pub(crate) remote_plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodePluginInstallRequestedMetadata {
    pub(crate) suggestion_id: String,
    pub(crate) plugins: Vec<EfficiencyCodePluginInstallRequestedPluginMetadata>,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodePluginInstallRequestedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodePluginInstallRequestedMetadata,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodePluginEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodePluginMetadata,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodePluginInstallFailedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: EfficiencyCodePluginMetadata,
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodePluginInstallFailedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodePluginInstallFailedMetadata,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodeOnboardingExternalAgentImportCompleteMetadata {
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeOnboardingExternalAgentImportCompleteEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeOnboardingExternalAgentImportCompleteMetadata,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodeOnboardingExternalAgentImportFailureMetadata {
    pub(crate) import_id: String,
    pub(crate) source: String,
    pub(crate) provider_id: String,
    #[serde(rename = "type")]
...
#[derive(Serialize)]
pub(crate) struct EfficiencyCodeOnboardingExternalAgentImportFailureEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodeOnboardingExternalAgentImportFailureMetadata,
}

#[derive(Serialize)]
pub(crate) struct EfficiencyCodePluginUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: EfficiencyCodePluginUsedMetadata,
}

pub(crate) fn plugin_state_event_type(state: PluginState) -> &'static str {
    match state {
        PluginState::Installed => "EfficiencyCode_plugin_installed",
        PluginState::Uninstalled => "EfficiencyCode_plugin_uninstalled",
        PluginState::Enabled => "EfficiencyCode_plugin_enabled",
        PluginState::Disabled => "EfficiencyCode_plugin_disabled",
    }
}

pub(crate) fn EfficiencyCode_app_metadata(
    tracking: &TrackEventsContext,
    app: AppInvocation,
) -> EfficiencyCodeAppMetadata {
    EfficiencyCodeAppMetadata {
...
pub(crate) fn EfficiencyCode_plugin_metadata(
    plugin: PluginTelemetryMetadata,
) -> EfficiencyCodePluginMetadata {
    EfficiencyCode_plugin_metadata_with_product_client_id(plugin, originator().value)
}

fn EfficiencyCode_plugin_metadata_with_product_client_id(
    plugin: PluginTelemetryMetadata,
...
pub(crate) fn EfficiencyCode_plugin_install_requested_metadata(
    tracking: &TrackEventsContext,
    request: PluginInstallRequested,
) -> EfficiencyCodePluginInstallRequestedMetadata {
    EfficiencyCodePluginInstallRequestedMetadata {
        ...
        plugins: request
            ...
            .into_iter()
            .map(
                |plugin| EfficiencyCodePluginInstallRequestedPluginMetadata {
...
pub(crate) fn EfficiencyCode_compaction_event_params(
...
) -> EfficiencyCodeCompactionEventParams {
    EfficiencyCodeCompactionEventParams {
        ...
        status: input.status,
        EfficiencyCode_error_kind: input.EfficiencyCode_error_kind,
        EfficiencyCode_error_http_status_code: input.EfficiencyCode_error_http_status_code,
...
pub(crate) fn EfficiencyCode_goal_event_params(
    input: EfficiencyCodeGoalEvent,
    session_id: String,
    app_server_client: EfficiencyCodeAppServerClientMetadata,
    runtime: EfficiencyCodeRuntimeMetadata,
    thread_source: Option<ThreadSource>,
...
pub(crate) fn EfficiencyCode_plugin_used_metadata(
    tracking: &TrackEventsContext,
    plugin: PluginTelemetryMetadata,
) -> EfficiencyCodePluginUsedMetadata {
    let mcp_server_names = plugin
        .capability_summary
        .as_ref()
        .map(|summary| summary.mcp_server_names.clone());
    EfficiencyCodePluginUsedMetadata {
        plugin: EfficiencyCode_plugin_metadata_with_product_client_id(
            plugin,
...
pub(crate) fn EfficiencyCode_hook_run_metadata(
    tracking: &TrackEventsContext,
    hook: HookRunFact,
) -> EfficiencyCodeHookRunMetadata {
    EfficiencyCodeHookRunMetadata {
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        product_client_id: Some(tracking.product_client_id.clone()),
...
pub(crate) fn current_runtime_metadata() -> EfficiencyCodeRuntimeMetadata {
    let os_info = os_info::get();
    EfficiencyCodeRuntimeMetadata {
        EfficiencyCode_rs_version: env!("CARGO_PKG_VERSION").to_string(),
