...
use crate::events::EfficiencyCode_app_metadata;
use crate::events::EfficiencyCode_hook_run_metadata;
use crate::events::EfficiencyCode_plugin_metadata;
use crate::events::EfficiencyCode_plugin_used_metadata;
use crate::events::EfficiencyCodeAcceptedLineFingerprintsEventParams;
use crate::events::EfficiencyCodeAcceptedLineFingerprintsEventRequest;
use crate::events::EfficiencyCodeAppMentionedEventRequest;
use crate::events::EfficiencyCodeAppServerClientMetadata;
use crate::events::EfficiencyCodeAppUsedEventRequest;
use crate::events::EfficiencyCodeCommandExecutionEventParams;
use crate::events::EfficiencyCodeCommandExecutionEventRequest;
use crate::events::EfficiencyCodeCompactionEventRequest;
use crate::events::EfficiencyCodeHookRunEventRequest;
use crate::events::EfficiencyCodeOnboardingExternalAgentImportFailureEventRequest;
use crate::events::EfficiencyCodeOnboardingExternalAgentImportFailureMetadata;
use crate::events::EfficiencyCodePluginEventRequest;
use crate::events::EfficiencyCodePluginInstallFailedEventRequest;
use crate::events::EfficiencyCodePluginInstallFailedMetadata;
use crate::events::EfficiencyCodePluginUsedEventRequest;
use crate::events::EfficiencyCodeReviewEventParams;
use crate::events::EfficiencyCodeReviewEventRequest;
use crate::events::EfficiencyCodeRuntimeMetadata;
use crate::events::EfficiencyCodeToolItemEventBase;
use crate::events::EfficiencyCodeTurnEventRequest;
...
use crate::facts::EfficiencyCodeCompactionEvent;
use crate::facts::EfficiencyCodeErrKind;
...
use crate::facts::TurnEfficiencyCodeErrorFact;
...
use EfficiencyCode_app_server_protocol::ApprovalsReviewer as AppServerApprovalsReviewer;
use EfficiencyCode_app_server_protocol::AskForApproval as AppServerAskForApproval;
...
use EfficiencyCode_app_server_protocol::CollabAgentTool;
use EfficiencyCode_app_server_protocol::CollabAgentToolCallStatus;
use EfficiencyCode_app_server_protocol::CommandAction;
use EfficiencyCode_app_server_protocol::CommandExecutionApprovalDecision;
use EfficiencyCode_app_server_protocol::CommandExecutionRequestApprovalParams;
use EfficiencyCode_app_server_protocol::CommandExecutionRequestApprovalResponse;
use EfficiencyCode_app_server_protocol::CommandExecutionSource;
use EfficiencyCode_app_server_protocol::CommandExecutionStatus;
use EfficiencyCode_app_server_protocol::DynamicToolCallStatus;
use EfficiencyCode_app_server_protocol::EfficiencyCodeErrorInfo;
use EfficiencyCode_app_server_protocol::GuardianApprovalReview;
use EfficiencyCode_app_server_protocol::GuardianApprovalReviewAction;
use EfficiencyCode_app_server_protocol::GuardianApprovalReviewStatus;
use EfficiencyCode_app_server_protocol::GuardianCommandSource as AppServerGuardianCommandSource;
use EfficiencyCode_app_server_protocol::ImageGenerationItem;
use EfficiencyCode_app_server_protocol::InitializeCapabilities;
use EfficiencyCode_app_server_protocol::InitializeParams;
use EfficiencyCode_app_server_protocol::ItemCompletedNotification;
use EfficiencyCode_app_server_protocol::ItemGuardianApprovalReviewCompletedNotification;
use EfficiencyCode_app_server_protocol::ItemStartedNotification;
use EfficiencyCode_app_server_protocol::JSONRPCErrorError;
use EfficiencyCode_app_server_protocol::McpToolCallAppContext;
use EfficiencyCode_app_server_protocol::McpToolCallStatus;
use EfficiencyCode_app_server_protocol::NonSteerableTurnKind;
use EfficiencyCode_app_server_protocol::PatchApplyStatus;
use EfficiencyCode_app_server_protocol::PermissionsRequestApprovalParams;
use EfficiencyCode_app_server_protocol::RequestId;
use EfficiencyCode_app_server_protocol::RequestPermissionProfile;
use EfficiencyCode_app_server_protocol::SandboxPolicy as AppServerSandboxPolicy;
use EfficiencyCode_app_server_protocol::ServerNotification;
use EfficiencyCode_app_server_protocol::ServerRequest;
use EfficiencyCode_app_server_protocol::ServerResponse;
use EfficiencyCode_app_server_protocol::SessionSource as AppServerSessionSource;
use EfficiencyCode_app_server_protocol::SubAgentActivityKind;
...
use EfficiencyCode_app_server_protocol::ThreadSource as AppServerThreadSource;
use EfficiencyCode_app_server_protocol::ThreadStartResponse;
use EfficiencyCode_app_server_protocol::ThreadStatus as AppServerThreadStatus;
use EfficiencyCode_app_server_protocol::Turn;
use EfficiencyCode_app_server_protocol::TurnCompletedNotification;
use EfficiencyCode_app_server_protocol::TurnDiffUpdatedNotification;
use EfficiencyCode_app_server_protocol::TurnError as AppServerTurnError;
use EfficiencyCode_app_server_protocol::TurnInterruptResponse;
use EfficiencyCode_app_server_protocol::TurnStartParams;
use EfficiencyCode_app_server_protocol::TurnStartedNotification;
use EfficiencyCode_app_server_protocol::TurnStatus as AppServerTurnStatus;
use EfficiencyCode_app_server_protocol::TurnSteerParams;
use EfficiencyCode_app_server_protocol::TurnSteerResponse;
use EfficiencyCode_app_server_protocol::UserInput;
use EfficiencyCode_app_server_protocol::WebSearchItem;
use EfficiencyCode_login::default_client::DEFAULT_ORIGINATOR;
use EfficiencyCode_login::default_client::originator;
use EfficiencyCode_plugin::AppConnectorId;
use EfficiencyCode_plugin::PluginCapabilitySummary;
use EfficiencyCode_plugin::PluginId;
use EfficiencyCode_plugin::PluginTelemetryMetadata;
use EfficiencyCode_protocol::approvals::NetworkApprovalProtocol;
use EfficiencyCode_protocol::config_types::ApprovalsReviewer;
use EfficiencyCode_protocol::config_types::ModeKind;
use EfficiencyCode_protocol::error::EfficiencyCodeErr;
use EfficiencyCode_protocol::models::NetworkPermissions as CoreNetworkPermissions;
use EfficiencyCode_protocol::models::PermissionProfile as CorePermissionProfile;
use EfficiencyCode_protocol::protocol::AskForApproval;
use EfficiencyCode_protocol::protocol::HookEventName;
use EfficiencyCode_protocol::protocol::HookRunStatus;
use EfficiencyCode_protocol::protocol::HookSource;
use EfficiencyCode_protocol::protocol::SessionSource;
use EfficiencyCode_protocol::protocol::SubAgentSource;
use EfficiencyCode_protocol::protocol::ThreadSource;
use EfficiencyCode_protocol::protocol::TokenUsage;
use EfficiencyCode_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use EfficiencyCode_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use EfficiencyCode_protocol::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
use EfficiencyCode_utils_absolute_path::test_support::PathBufExt;
use EfficiencyCode_utils_absolute_path::test_support::test_path_buf;
...
const TEST_PRODUCT_CLIENT_ID: &str = "EfficiencyCode_work_desktop";
...
fn sample_app_server_client_metadata() -> EfficiencyCodeAppServerClientMetadata {
    EfficiencyCodeAppServerClientMetadata {
...
fn sample_runtime_metadata() -> EfficiencyCodeRuntimeMetadata {
    EfficiencyCodeRuntimeMetadata {
        EfficiencyCode_rs_version: "0.1.0".to_string(),
...
fn sample_turn_start_response(turn_id: &str) -> ClientResponsePayload {
    ClientResponsePayload::TurnStart(EfficiencyCode_app_server_protocol::TurnStartResponse {
        turn: Turn {
            id: turn_id.to_string(),
            items_view: EfficiencyCode_app_server_protocol::TurnItemsView::Full,
            items: vec![],
...
fn sample_turn_completed_notification(
    ...
    EfficiencyCode_error_info: Option<EfficiencyCode_app_server_protocol::EfficiencyCodeErrorInfo>,
) -> ServerNotification {
    ServerNotification::TurnCompleted(TurnCompletedNotification {
        ...
        turn: Turn {
            ...
            items: vec![],
            status,
            error: EfficiencyCode_error_info.map(|EfficiencyCode_error_info| AppServerTurnError {
                message: "turn failed".to_string(),
                EfficiencyCode_error_info: Some(EfficiencyCode_error_info),
    ...
    JSONRPCErrorError {
        ...
        data: Some(
            serde_json::to_value(AppServerTurnError {
                message: "cannot steer a review turn".to_string(),
                EfficiencyCode_error_info: Some(EfficiencyCodeErrorInfo::ActiveTurnNotSteerable {
            ...
            AnalyticsFact::Initialize {
                ...
                params: InitializeParams {
                    client_info: ClientInfo {
                        name: "EfficiencyCode-web".to_string(),
                        title: None,
                        version: "1.0.0".to_string(),
                    },
                    capabilities: None,
                },
                product_client_id: "EfficiencyCode-web".to_string(),
    ...
    reducer
        .ingest(
            AnalyticsFact::Initialize {
                ...
                params: InitializeParams {
                    client_info: ClientInfo {
                        name: "EfficiencyCode-tui".to_string(),
                        title: None,
                        version: "1.0.0".to_string(),
                    },
                    capabilities: None,
                },
                product_client_id: "EfficiencyCode-tui".to_string(),
                runtime: sample_runtime_metadata(),
                rpc_transport: AppServerRpcTransport::Stdio,
            },
            out,
...
fn sample_initialize_fact(connection_id: u64) -> AnalyticsFact {
    AnalyticsFact::Initialize {
        ...
        product_client_id: DEFAULT_ORIGINATOR.to_string(),
        runtime: EfficiencyCodeRuntimeMetadata {
            EfficiencyCode_rs_version: "0.99.0".to_string(),
...
async fn ingest_complete_child_turn(
    ...
    for fact in [
        ...
        AnalyticsFact::Notification(Box::new(sample_turn_completed_notification(
            ...
            /*EfficiencyCode_error_info*/ None,
        ))),
    ] {
    ...
    ServerRequest::PermissionsRequestApproval {
        ...
        params: PermissionsRequestApprovalParams {
            ...
            permissions: RequestPermissionProfile {
                network: Some(
                    EfficiencyCode_app_server_protocol::AdditionalNetworkPermissions {
                        enabled: Some(true),
                    },
                ),
                file_system: None,
...
fn sample_guardian_review_completed(
    ...
    ServerNotification::ItemGuardianApprovalReviewCompleted(
        ItemGuardianApprovalReviewCompletedNotification {
            ...
            decision_source: EfficiencyCode_app_server_protocol::AutoReviewDecisionSource::Agent,
...
fn normalize_path_for_skill_id_repo_scoped_uses_relative_path() {
    ...
    let skill_path = PathBuf::from("/repo/root/.EfficiencyCode/skills/doc/SKILL.md");
    ...
    assert_eq!(path, ".EfficiencyCode/skills/doc/SKILL.md");
}

#[test]
fn normalize_path_for_skill_id_user_scoped_uses_absolute_path() {
    let skill_path = PathBuf::from("/Users/abc/.EfficiencyCode/skills/doc/SKILL.md");
...
fn normalize_path_for_skill_id_admin_scoped_uses_absolute_path() {
    let skill_path = PathBuf::from("/etc/EfficiencyCode/skills/doc/SKILL.md");
...
fn normalize_path_for_skill_id_repo_root_not_in_skill_path_uses_absolute_path() {
    let repo_root = PathBuf::from("/repo/root");
    let skill_path = PathBuf::from("/other/path/.EfficiencyCode/skills/doc/SKILL.md");
...
fn app_mentioned_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::AppMentioned(EfficiencyCodeAppMentionedEventRequest {
        event_type: "EfficiencyCode_app_mentioned",
        event_params: EfficiencyCode_app_metadata(
            &tracking,
            AppInvocation {
...
fn app_used_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::AppUsed(EfficiencyCodeAppUsedEventRequest {
        event_type: "EfficiencyCode_app_used",
        event_params: EfficiencyCode_app_metadata(
            &tracking,
            AppInvocation {
...
fn accepted_line_fingerprints_event_serializes_expected_shape() {
    let event = TrackEventRequest::AcceptedLineFingerprints(Box::new(
        EfficiencyCodeAcceptedLineFingerprintsEventRequest {
            event_type: "EfficiencyCode_accepted_line_fingerprints",
            event_params: EfficiencyCodeAcceptedLineFingerprintsEventParams {
                event_type: "EfficiencyCode.accepted_line_fingerprints",
                turn_id: "turn-1".to_string(),
                thread_id: "thread-1".to_string(),
                product_surface: Some("EfficiencyCode".to_string()),
                model_slug: Some("gpt-5.1-EfficiencyCode".to_string()),
    ...
    assert_eq!(
        ...
        json!({
            ...
            "event_params": {
                ...
                "turn_id": "turn-1",
                "thread_id": "thread-1",
                "product_surface": "EfficiencyCode",
                "model_slug": "gpt-5.1-EfficiencyCode",
                "completed_at": 1710000000,
...
async fn analytics_flush_delivers_completed_turn_with_file_diff() {
    ...
    let capture_path = std::env::temp_dir().join(format!(
        "EfficiencyCode-analytics-turn-flush-{}-{nonce}.jsonl",
        std::process::id()
    ));
    let auth_manager = EfficiencyCode_login::AuthManager::from_auth_for_testing(
        EfficiencyCode_login::EfficiencyCodeAuth::create_dummy_chatgpt_auth_for_testing(),
    );
...
"
    ...
    assert!(
        event_types
            .iter()
            .any(|event| event == "EfficiencyCode_turn_event")
    );
    assert!(
        event_types
            .iter()
            .any(|event| event == "EfficiencyCode_accepted_line_fingerprints")
    );
...
fn compaction_event_serializes_expected_shape() {
    let event = TrackEventRequest::Compaction(Box::new(EfficiencyCodeCompactionEventRequest {
        event_type: "EfficiencyCode_compaction_event",
        event_params: crate::events::EfficiencyCode_compaction_event_params(
            EfficiencyCodeCompactionEvent {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
                ...
                EfficiencyCode_error_kind: None,
                EfficiencyCode_error_http_status_code: None,
        ...
        json!({
            ...
            "event_params": {
                ...
                "app_server_client": {
                    ...
                    "client_name": "EfficiencyCode-tui",
                    "client_version": "1.0.0",
                    "rpc_transport": "stdio",
                    "experimental_api_enabled": true
                },
                "runtime": {
                    "EfficiencyCode_rs_version": "0.1.0",
                    "runtime_os": "macos",
                ...
                "strategy": "memento",
                "status": "completed",
                "EfficiencyCode_error_kind": null,
                "EfficiencyCode_error_http_status_code": null,
...
fn thread_initialized_event_serializes_expected_shape() {
    let event = TrackEventRequest::ThreadInitialized(ThreadInitializedEvent {
        event_type: "EfficiencyCode_thread_initialized",
        event_params: ThreadInitializedEventParams {
            thread_id: "thread-0".to_string(),
            session_id: "session-thread-0".to_string(),
            app_server_client: EfficiencyCodeAppServerClientMetadata {
                product_client_id: DEFAULT_ORIGINATOR.to_string(),
                client_name: Some("EfficiencyCode-tui".to_string()),
                client_version: Some("1.0.0".to_string()),
                rpc_transport: AppServerRpcTransport::Stdio,
...
fn command_execution_event_serializes_expected_shape() {
    let event = TrackEventRequest::CommandExecution(EfficiencyCodeCommandExecutionEventRequest {
        event_type: "EfficiencyCode_command_execution_event",
        event_params: EfficiencyCodeCommandExecutionEventParams {
            base: EfficiencyCodeToolItemEventBase {
                thread_id: "thread-1".to_string(),
                ...
                app_server_client: EfficiencyCodeAppServerClientMetadata {
                    product_client_id: "EfficiencyCode_tui".to_string(),
                    client_name: Some("EfficiencyCode-tui".to_string()),
    ...
    assert_eq!(
        ...
        json!({
            ...
            "event_params": {
                ...
                "app_server_client": {
                    "product_client_id": "EfficiencyCode_tui",
                    "client_name": "EfficiencyCode-tui",
                ...
                "runtime": {
                    "EfficiencyCode_rs_version": "0.99.0",
                    "runtime_os": "macos",
                    "runtime_os_version": "15.3.1",
                    "runtime_arch": "aarch64"
                },
...
fn review_event_serializes_expected_shape() {
    let event = TrackEventRequest::ReviewEvent(EfficiencyCodeReviewEventRequest {
        event_type: "EfficiencyCode_review_event",
        event_params: EfficiencyCodeReviewEventParams {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            item_id: None,
...
async fn initialize_caches_client_and_thread_lifecycle_publishes_once_initialized() {
    ...
    assert_eq!(
        ...
        "EfficiencyCode_thread_initialized"
    );
    ...
    assert_eq!(
        payload[0]["event_params"]["runtime"]["EfficiencyCode_rs_version"],
        "0.99.0"
    );
...
async fn thread_originator_overrides_shared_connection_across_thread_events() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            json!({
                "event_type": "EfficiencyCode_turn_event",
                "product_client_id": TEST_PRODUCT_CLIENT_ID,
            }),
            json!({
                "event_type": "EfficiencyCode_compaction_event",
...
async fn compaction_event_ingests_custom_fact() {
    ...
    let parent_thread_id =
        EfficiencyCode_protocol::ThreadId::from_string("22222222-2222-2222-2222-222222222222")
        ...
        .ingest(
            AnalyticsFact::Custom(CustomAnalyticsFact::Compaction(Box::new(
                EfficiencyCodeCompactionEvent {
                    ...
                    EfficiencyCode_error_kind: Some(EfficiencyCodeErrKind::ContextWindowExceeded),
                    EfficiencyCode_error_http_status_code: None,
                    active_context_tokens_before: 131_000,
    ...
    let payload = serde_json::to_value(&events).expect("serialize events");
    assert_eq!(payload.as_array().expect("events array").len(), 1);
    assert_eq!(payload[0]["event_type"], "EfficiencyCode_compaction_event");
    assert_eq!(payload[0]["event_params"]["session_id"], "session-thread-1");
    assert_eq!(payload[0]["event_params"]["thread_id"], "thread-1");
    assert_eq!(payload[0]["event_params"]["turn_id"], "turn-compact");
    assert_eq!(
        payload[0]["event_params"]["EfficiencyCode_error_kind"],
        json!("context_window_exceeded")
    );
    assert_eq!(
        payload[0]["event_params"]["EfficiencyCode_error_http_status_code"],
        json!(null)
    );
    assert_eq!(
        payload[0]["event_params"]["app_server_client"]["product_client_id"],
...
async fn guardian_review_event_ingests_custom_fact_with_optional_target_item() {
        ...
        .ingest(
            AnalyticsFact::Custom(CustomAnalyticsFact::GuardianReview(Box::new(
                GuardianReviewEventParams {
                    ...
                    guardian_default_review_model_id: Some(
                        "EfficiencyCode-auto-review".to_string(),
                    ),
    ...
    let payload = serde_json::to_value(&events).expect("serialize events");
    assert_eq!(payload.as_array().expect("events array").len(), 1);
    assert_eq!(payload[0]["event_type"], "EfficiencyCode_guardian_review");
    assert_eq!(
...
async fn item_lifecycle_notifications_publish_command_execution_event() {
    ...
    assert_eq!(
        payload[0]["event_type"],
        "EfficiencyCode_command_execution_event"
    );
    assert_eq!(payload[0]["event_params"]["thread_id"], "thread-1");
    assert_eq!(payload[0]["event_params"]["session_id"], "session-thread-1");
...
async fn command_execution_approval_response_publishes_user_review_event() {
    ...
    let payload = serde_json::to_value(&events).expect("serialize events");
    assert_eq!(payload.as_array().expect("events array").len(), 1);
    assert_eq!(payload[0]["event_type"], "EfficiencyCode_review_event");
    assert_eq!(payload[0]["event_params"]["thread_id"], "thread-1");
    assert_eq!(payload[0]["event_params"]["turn_id"], "turn-1");
    assert_eq!(payload[0]["event_params"]["item_id"], "item-1");
...
async fn guardian_completed_notification_publishes_review_event_with_thread_metadata() {
    ...
    assert_eq!(payload["event_type"], "EfficiencyCode_review_event");
...
fn subagent_thread_started_review_serializes_expected_shape() {
    let event = TrackEventRequest::ThreadInitialized(subagent_thread_started_event_request(
        SubAgentThreadStartedInput {
            ...
            forked_from_thread_id: None,
            product_client_id: "EfficiencyCode-tui".to_string(),
            client_name: "EfficiencyCode-tui".to_string(),
...
fn subagent_thread_started_thread_spawn_serializes_thread_lineage() {
    let parent_thread_id =
        EfficiencyCode_protocol::ThreadId::from_string("11111111-1111-1111-1111-111111111111")
            .expect("valid thread id");
    let forked_from_thread_id =
        EfficiencyCode_protocol::ThreadId::from_string("22222222-2222-4222-8222-222222222222")
            .expect("valid thread id");
    let event = TrackEventRequest::ThreadInitialized(subagent_thread_started_event_request(
        SubAgentThreadStartedInput {
            session_id: "session-root".to_string(),
...
fn subagent_thread_started_other_serializes_explicit_parent_thread_id() {
    let parent_thread_id =
        EfficiencyCode_protocol::ThreadId::from_string("33333333-3333-4333-8333-333333333333")
            .expect("valid thread id");
    let event = TrackEventRequest::ThreadInitialized(subagent_thread_started_event_request(
        SubAgentThreadStartedInput {
            session_id: "session-root".to_string(),
...
async fn subagent_events_keep_thread_originator_with_explicit_turn_connection() {
    ...
    let mut events = Vec::new();
    let parent_thread_id =
        EfficiencyCode_protocol::ThreadId::from_string("44444444-4444-4444-4444-444444444444")
            .expect("valid parent thread id");
    ...
    assert_eq!(params.runtime.EfficiencyCode_rs_version, "0.1.0");
...
fn plugin_used_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::PluginUsed(EfficiencyCodePluginUsedEventRequest {
        event_type: "EfficiencyCode_plugin_used",
        event_params: EfficiencyCode_plugin_used_metadata(&tracking, sample_plugin_metadata()),
    });
...
fn plugin_management_event_serializes_expected_shape() {
    let event = TrackEventRequest::PluginInstalled(EfficiencyCodePluginEventRequest {
        event_type: "EfficiencyCode_plugin_installed",
        event_params: EfficiencyCode_plugin_metadata(sample_plugin_metadata()),
    });
...
fn plugin_install_failed_event_serializes_expected_shape() {
    let event =
        TrackEventRequest::PluginInstallFailed(EfficiencyCodePluginInstallFailedEventRequest {
            event_type: "EfficiencyCode_plugin_install_failed",
            event_params: EfficiencyCodePluginInstallFailedMetadata {
                plugin: EfficiencyCode_plugin_metadata(sample_plugin_metadata()),
...
fn plugin_management_event_keeps_plugin_id_local_when_remote_id_exists() {
    ...
    let event = TrackEventRequest::PluginInstalled(EfficiencyCodePluginEventRequest {
        event_type: "EfficiencyCode_plugin_installed",
        event_params: EfficiencyCode_plugin_metadata(plugin),
    });
...
fn hook_run_event_serializes_expected_shape() {
    let tracking = test_tracking_context("thread-3", "turn-3");
    let event = TrackEventRequest::HookRun(EfficiencyCodeHookRunEventRequest {
        event_type: "EfficiencyCode_hook_run",
        event_params: EfficiencyCode_hook_run_metadata(
            &tracking,
            HookRunFact {
...
fn hook_run_metadata_maps_sources_and_statuses() {
    ...
    let system = serde_json::to_value(EfficiencyCode_hook_run_metadata(
        &tracking,
        HookRunFact {
    ...
    let project = serde_json::to_value(EfficiencyCode_hook_run_metadata(
        &tracking,
        HookRunFact {
    ...
    let cloud_requirements = serde_json::to_value(EfficiencyCode_hook_run_metadata(
        &tracking,
        HookRunFact {
            event_name: HookEventName::Stop,
    ...
    let unknown = serde_json::to_value(EfficiencyCode_hook_run_metadata(
        &tracking,
        HookRunFact {
...
fn hook_run_metadata_maps_stopped_status() {
    ...
    let stopped = serde_json::to_value(EfficiencyCode_hook_run_metadata(
        &tracking,
        HookRunFact {
            event_name: HookEventName::Stop,
            hook_source: HookSource::User,
...
async fn reducer_ingests_artifact_operation_fact() {
    ...
    assert_eq!(
        ...
        json!([{
            "event_type": "EfficiencyCode_artifact_operation",
            "event_params": {
                "thread_id": "thread-1",
                "turn_id": "turn-1",
                "item_id": "call-1",
            ...
            AnalyticsFact::Custom(CustomAnalyticsFact::SkillInvoked(SkillInvokedInput {
                ...
                invocations: vec![SkillInvocation {
                    ...
                    location: SkillInvocationLocation::Host {
                        path: skill_path,
                        scope: EfficiencyCode_protocol::protocol::SkillScope::User,
                    },
                    plugin_id: None,
...
async fn reducer_includes_plugin_ids_for_plugin_skill_invocations() {
    ...
    let tracking = test_tracking_context("thread-1", "turn-1");
    let skill_path =
        PathBuf::from("/Users/abc/.EfficiencyCode/plugins/cache/test/sample/skills/doc/SKILL.md");
...
async fn reducer_ingests_hook_run_fact() {
    ...
    let payload = serde_json::to_value(&events).expect("serialize events");
    assert_eq!(payload.as_array().expect("events array").len(), 1);
    assert_eq!(payload[0]["event_type"], "EfficiencyCode_hook_run");
...
async fn reducer_ingests_app_and_plugin_facts() {
    ...
    assert_eq!(payload[0]["event_type"], "EfficiencyCode_app_mentioned");
    assert_eq!(payload[1]["event_type"], "EfficiencyCode_app_used");
    assert_eq!(payload[2]["event_type"], "EfficiencyCode_plugin_used");
    assert_eq!(
...
async fn reducer_ingests_plugin_state_changed_fact() {
    ...
    assert_eq!(
        payload,
        json!([{
            "event_type": "EfficiencyCode_plugin_disabled",
            "event_params": {
                "plugin_id": "sample@test",
                "remote_plugin_id": null,
                "plugin_name": "sample",
...
async fn reducer_ingests_plugin_install_requested_fact() {
    ...
    assert_eq!(
        serde_json::to_value(&events).expect("serialize events"),
        json!([{
            "event_type": "EfficiencyCode_plugin_install_requested",
            "event_params": {
...
async fn reducer_ingests_external_agent_config_import_completed_fact() {
    ...
    assert_eq!(
        payload,
        json!([{
            "event_type": "EfficiencyCode_onboarding_external_agent_import_complete",
            "event_params": {
                "import_id": "import-1",
                "source": "app_server",
...
fn external_agent_config_import_failure_event_serializes_expected_shape() {
    let event = TrackEventRequest::ExternalAgentConfigImportFailure(
        EfficiencyCodeOnboardingExternalAgentImportFailureEventRequest {
            event_type: "EfficiencyCode_onboarding_external_agent_import_failure",
            event_params: EfficiencyCodeOnboardingExternalAgentImportFailureMetadata {
                import_id: "import-1".to_string(),
                source: "app_server".to_string(),
                provider_id: "test-provider-42".to_string(),
                item_type: "PLUGINS".to_string(),
...
fn turn_event_serializes_expected_shape() {
    let event = TrackEventRequest::TurnEvent(Box::new(EfficiencyCodeTurnEventRequest {
        event_type: "EfficiencyCode_turn_event",
        event_params: crate::events::EfficiencyCodeTurnEventParams {
            thread_id: "thread-2".to_string(),
    ...
    let expected = serde_json::from_str::<serde_json::Value>(
        r#"{
            ...
            "event_params": {
                ...
                "app_server_client": {
                    "product_client_id": "EfficiencyCode_cli_rs",
                    "client_name": "EfficiencyCode-tui",
                    "client_version": "1.0.0",
                    "rpc_transport": "stdio",
                    "experimental_api_enabled": true
...
async fn accepted_turn_steer_emits_expected_event() {
    ...
    assert_eq!(
        payload["event_type"],
        json!("EfficiencyCode_turn_steer_event")
    );
    ...
    assert_eq!(
        payload["event_params"]["app_server_client"]["product_client_id"],
        json!("EfficiencyCode-tui")
    );
    assert_eq!(
        payload["event_params"]["runtime"]["EfficiencyCode_rs_version"],
        json!("0.1.0")
    );
...
async fn turn_lifecycle_emits_turn_event() {
    ...
    assert_eq!(payload["event_type"], json!("EfficiencyCode_turn_event"));
    assert_eq!(payload["event_params"]["thread_id"], json!("thread-2"));
    assert_eq!(
        payload["event_params"]["session_id"],
        json!("session-thread-2")
    ...
    assert_eq!(
        ...
        json!({
            "product_client_id": "EfficiencyCode-tui",
            "client_name": "EfficiencyCode-tui",
            "client_version": "1.0.0",
            "rpc_transport": "stdio",
...
async fn turn_event_counts_completed_tool_items() {
    ...
    let completed_tool_items = vec![
        ...
        ThreadItem::WebSearch(WebSearchItem {
            id: "web-1".to_string(),
            query: "EfficiencyCode".to_string(),
            action: None,
            results: None,
        }),
    ...
    assert_eq!(
        emitted_tool_events,
        vec![
            ("EfficiencyCode_command_execution_event", "session-thread-2"),
            ("EfficiencyCode_file_change_event", "session-thread-2"),
            ("EfficiencyCode_mcp_tool_call_event", "session-thread-2"),
            ("EfficiencyCode_dynamic_tool_call_event", "session-thread-2"),
            (
                "EfficiencyCode_collab_agent_tool_call_event",
                "session-thread-2"
            ),
            ("EfficiencyCode_web_search_event", "session-thread-2"),
            ("EfficiencyCode_image_generation_event", "session-thread-2"),
        ]
    );
...
async fn turn_lifecycle_emits_failed_turn_event() {
    ...
    reducer
        .ingest(
            AnalyticsFact::Custom(CustomAnalyticsFact::TurnEfficiencyCodeError(Box::new(
                TurnEfficiencyCodeErrorFact::from_EfficiencyCode_err(
                    "thread-2".to_string(),
                    "turn-2".to_string(),
                    &EfficiencyCodeErr::InvalidRequest(
    ...
    reducer
        .ingest(
            AnalyticsFact::Notification(Box::new(sample_turn_completed_notification(
                ...
                Some(EfficiencyCode_app_server_protocol::EfficiencyCodeErrorInfo::BadRequest),
            ))),
            &mut out,
        )
        .await;
    ...
    assert_eq!(
        payload["event_params"]["EfficiencyCode_error_kind"],
        json!("invalid_request")
    );
    assert_eq!(
        payload["event_params"]["EfficiencyCode_error_http_status_code"],
        json!(null)
    );
}
