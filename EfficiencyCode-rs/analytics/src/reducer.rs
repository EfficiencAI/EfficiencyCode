...
use crate::events::EfficiencyCode_artifact_operation_event_request;
use crate::events::EfficiencyCode_compaction_event_params;
use crate::events::EfficiencyCode_goal_event_params;
use crate::events::EfficiencyCode_hook_run_metadata;
use crate::events::EfficiencyCode_plugin_install_requested_metadata;
...
use crate::events::EfficiencyCodeCollabAgentToolCallEventParams;
use crate::events::EfficiencyCodeCollabAgentToolCallEventRequest;
...
use crate::events::EfficiencyCodeDynamicToolCallEventParams;
use crate::events::EfficiencyCodeDynamicToolCallEventRequest;
use crate::events::EfficiencyCodeFileChangeEventParams;
use crate::events::EfficiencyCodeFileChangeEventRequest;
use crate::events::EfficiencyCodeGoalEventRequest;
use crate::events::EfficiencyCodeHookRunEventRequest;
use crate::events::EfficiencyCodeImageGenerationEventParams;
use crate::events::EfficiencyCodeImageGenerationEventRequest;
use crate::events::EfficiencyCodeMcpToolCallEventParams;
use crate::events::EfficiencyCodeMcpToolCallEventRequest;
use crate::events::EfficiencyCodeOnboardingExternalAgentImportCompleteEventRequest;
use crate::events::EfficiencyCodeOnboardingExternalAgentImportCompleteMetadata;
...
use crate::events::EfficiencyCodePluginInstallRequestedEventRequest;
...
use crate::events::EfficiencyCodeTurnEventParams;
use crate::events::EfficiencyCodeTurnEventRequest;
use crate::events::EfficiencyCodeTurnSteerEventParams;
use crate::events::EfficiencyCodeTurnSteerEventRequest;
use crate::events::EfficiencyCodeWebSearchEventParams;
use crate::events::EfficiencyCodeWebSearchEventRequest;
...
use crate::facts::EfficiencyCodeGoalEvent;
...
use crate::facts::TurnEfficiencyCodeError;
...
use EfficiencyCode_app_server_protocol::ClientResponse;
use EfficiencyCode_app_server_protocol::CollabAgentStatus;
...
use EfficiencyCode_app_server_protocol::DynamicToolCallOutputContentItem;
...
use EfficiencyCode_app_server_protocol::NetworkPolicyRuleAction;
use EfficiencyCode_app_server_protocol::PatchApplyStatus;
use EfficiencyCode_app_server_protocol::PatchChangeKind;
...
use EfficiencyCode_app_server_protocol::WebSearchAction;
use EfficiencyCode_git_utils::collect_git_info;
...
use EfficiencyCode_protocol::items::is_safe_plugin_relative_path;
use EfficiencyCode_protocol::models::PermissionProfile;
use EfficiencyCode_protocol::protocol::SessionSource;
use EfficiencyCode_protocol::protocol::SkillScope;
...
impl<'a> AnalyticsDropSite<'a> {
    ...
    fn compaction(input: &'a EfficiencyCodeCompactionEvent) -> Self {
        Self {
    ...
    fn goal(input: &'a EfficiencyCodeGoalEvent) -> Self {
        Self {
            event_name: "goal",
            thread_id: &input.thread_id,
    ...
    fn tool_item(
        notification: &'a EfficiencyCode_app_server_protocol::ItemCompletedNotification,
        item_id: &'a str,
    ) -> Self {
        Self {
...
struct CompletedTurnState {
    ...
    turn_error: Option<EfficiencyCodeErrorInfo>,
    completed_at: u64,
...
struct TurnState {
    ...
    EfficiencyCode_error: Option<TurnEfficiencyCodeError>,
...
impl AnalyticsReducer {
    pub(crate) async fn ingest(&mut self, input: AnalyticsFact, out: &mut Vec<TrackEventRequest>) {
        match input {
            ...
            AnalyticsFact::Custom(input) => match input {
                ...
                CustomAnalyticsFact::TurnEfficiencyCodeError(input) => {
                    self.ingest_turn_EfficiencyCode_error(*input);
                }
    ...
    fn ingest_artifact_operation(
        ...
        out.push(TrackEventRequest::ArtifactOperation(
            EfficiencyCode_artifact_operation_event_request(input.tracking, input.operation),
        ));
    }
    ...
    fn ingest_code_mode_tool_call(
        ...
        match input {
            ...
            CodeModeToolCallFact::Completed {
                ...
                let event =
                    TrackEventRequest::DynamicToolCall(EfficiencyCodeDynamicToolCallEventRequest {
                        event_type: "EfficiencyCode_dynamic_tool_call_event",
                        event_params: EfficiencyCodeDynamicToolCallEventParams {
                            base,
    ...
    fn ingest_guardian_review(
        ...
        out.push(TrackEventRequest::GuardianReview(Box::new(
            GuardianReviewEventRequest {
                event_type: "EfficiencyCode_guardian_review",
    ...
    fn ingest_turn_EfficiencyCode_error(&mut self, input: TurnEfficiencyCodeErrorFact) {
        let TurnEfficiencyCodeErrorFact {
            turn_id,
            thread_id,
            error,
        } = input;
        ...
        turn_state.EfficiencyCode_error = Some(error);
    }
    ...
    fn ingest_app_mentioned(&mut self, input: AppMentionedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.extend(mentions.into_iter().map(|mention| {
            let event_params = EfficiencyCode_app_metadata(&tracking, mention);
            TrackEventRequest::AppMentioned(EfficiencyCodeAppMentionedEventRequest {
    ...
    fn ingest_app_used(&mut self, input: AppUsedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        let event_params = EfficiencyCode_app_metadata(&tracking, app);
        out.push(TrackEventRequest::AppUsed(
            EfficiencyCodeAppUsedEventRequest {
    ...
    fn ingest_hook_run(&mut self, input: HookRunInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.push(TrackEventRequest::HookRun(
            EfficiencyCodeHookRunEventRequest {
                event_type: "EfficiencyCode_hook_run",
                event_params: EfficiencyCode_hook_run_metadata(&tracking, hook),
            },
        ));
    }
    ...
    fn ingest_plugin_used(&mut self, input: PluginUsedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.push(TrackEventRequest::PluginUsed(
            EfficiencyCodePluginUsedEventRequest {
                event_type: "EfficiencyCode_plugin_used",
                event_params: EfficiencyCode_plugin_used_metadata(&tracking, plugin),
            },
        ));
    }
    ...
    fn ingest_plugin_install_requested(
        ...
        out.push(TrackEventRequest::PluginInstallRequested(
            EfficiencyCodePluginInstallRequestedEventRequest {
                event_type: "EfficiencyCode_plugin_install_requested",
                event_params: EfficiencyCode_plugin_install_requested_metadata(&tracking, request),
            },
        ));
    }
    ...
    fn ingest_plugin_state_changed(
        ...
        let event = EfficiencyCodePluginEventRequest {
    ...
    fn ingest_external_agent_config_import_completed(
        ...
        out.push(TrackEventRequest::ExternalAgentConfigImportCompleted(
            EfficiencyCodeOnboardingExternalAgentImportCompleteEventRequest {
                event_type: "EfficiencyCode_onboarding_external_agent_import_complete",
                event_params: EfficiencyCodeOnboardingExternalAgentImportCompleteMetadata {
        ...
        match notification {
            ServerNotification::ThreadArchived(notification) => {
                out.push(TrackEventRequest::ThreadArchive(ThreadArchiveEvent {
                    event_type: "EfficiencyCode_thread_archive_event",
            ...
            ServerNotification::TurnCompleted(notification) => {
                ...
                turn_state.completed = Some(CompletedTurnState {
                    ...
                    turn_error: notification
                        .turn
                        .error
                        .and_then(|error| error.EfficiencyCode_error_info),
    ...
    fn emit_thread_initialized(
        &mut self,
        connection_id: u64,
        thread: EfficiencyCode_app_server_protocol::Thread,
        model: String,
        initialization_mode: ThreadInitializationMode,
        thread_originator: Option<String>,
        out: &mut Vec<TrackEventRequest>,
    ...
    fn ingest_compaction(
        &mut self,
        input: EfficiencyCodeCompactionEvent,
        out: &mut Vec<TrackEventRequest>,
    ) {
        let Some((connection_state, thread_state, thread_metadata)) =
        ...
        out.push(TrackEventRequest::Compaction(Box::new(
            EfficiencyCodeCompactionEventRequest {
                event_type: "EfficiencyCode_compaction_event",
                event_params: EfficiencyCode_compaction_event_params(
                    input,
    ...
    fn ingest_goal(&mut self, input: EfficiencyCodeGoalEvent, out: &mut Vec<TrackEventRequest>) {
        let Some((connection_state, thread_state, thread_metadata)) =
        ...
        out.push(TrackEventRequest::Goal(Box::new(
            EfficiencyCodeGoalEventRequest {
                event_type: "EfficiencyCode_goal_event",
                event_params: EfficiencyCode_goal_event_params(
                    input,
                    thread_metadata.session_id.clone(),
                    thread_state.app_server_client(connection_state),
                    connection_state.runtime.clone(),
    ...
    fn ingest_guardian_review_completed(
        &mut self,
        notification: EfficiencyCode_app_server_protocol::ItemGuardianApprovalReviewCompletedNotification,
        out: &mut Vec<TrackEventRequest>,
    ) {
    ...
    fn emit_turn_steer_event(
        ...
        out.push(TrackEventRequest::TurnSteer(
            EfficiencyCodeTurnSteerEventRequest {
                event_type: "EfficiencyCode_turn_steer_event",
                event_params: EfficiencyCodeTurnSteerEventParams {
    ...
    fn emit_review_event(
        ...
        out.push(TrackEventRequest::ReviewEvent(
            EfficiencyCodeReviewEventRequest {
    ...
    async fn maybe_emit_turn_event(&mut self, turn_id: &str, out: &mut Vec<TrackEventRequest>) {
        ...
        let turn_event = TrackEventRequest::TurnEvent(Box::new(EfficiencyCodeTurnEventRequest {
            event_type: "EfficiencyCode_turn_event",
            event_params: EfficiencyCode_turn_event_params(
                thread_state.app_server_client(connection_state),
                connection_state.runtime.clone(),
                turn_id.to_string(),
                turn_state,
...
fn tool_event_base_mut(
    event: &mut TrackEventRequest,
) -> Option<&mut EfficiencyCodeToolItemEventBase> {
    match event {
    ...
    match item {
        ThreadItem::CommandExecution {
            ...
            Some(TrackEventRequest::CommandExecution(
                EfficiencyCodeCommandExecutionEventRequest {
        ...
        ThreadItem::FileChange {
            ...
            Some(TrackEventRequest::FileChange(
                EfficiencyCodeFileChangeEventRequest {
                    event_type: "EfficiencyCode_file_change_event",
                    event_params: EfficiencyCodeFileChangeEventParams {
                        base,
        ...
        ThreadItem::McpToolCall {
            ...
            Some(TrackEventRequest::McpToolCall(
                EfficiencyCodeMcpToolCallEventRequest {
                    event_type: "EfficiencyCode_mcp_tool_call_event",
                    event_params: EfficiencyCodeMcpToolCallEventParams {
                        base,
        ...
        ThreadItem::DynamicToolCall {
            ...
            Some(TrackEventRequest::DynamicToolCall(
                EfficiencyCodeDynamicToolCallEventRequest {
                    event_type: "EfficiencyCode_dynamic_tool_call_event",
                    event_params: EfficiencyCodeDynamicToolCallEventParams {
                        base,
        ...
        ThreadItem::CollabAgentToolCall {
            ...
            Some(TrackEventRequest::CollabAgentToolCall(
                EfficiencyCodeCollabAgentToolCallEventRequest {
                    event_type: "EfficiencyCode_collab_agent_tool_call_event",
                    event_params: EfficiencyCodeCollabAgentToolCallEventParams {
                        base,
        ...
        ThreadItem::WebSearch(item) => {
            ...
            Some(TrackEventRequest::WebSearch(
                EfficiencyCodeWebSearchEventRequest {
                    event_type: "EfficiencyCode_web_search_event",
                    event_params: EfficiencyCodeWebSearchEventParams {
                        base,
        ...
        ThreadItem::ImageGeneration(item) => {
            ...
            Some(TrackEventRequest::ImageGeneration(
                EfficiencyCodeImageGenerationEventRequest {
                    event_type: "EfficiencyCode_image_generation_event",
                    event_params: EfficiencyCodeImageGenerationEventParams {
                        base,
...
) -> EfficiencyCodeToolItemEventBase {
...
fn file_change_counts(
    changes: &[EfficiencyCode_app_server_protocol::FileUpdateChange],
) -> FileChangeCounts {
...
fn EfficiencyCode_turn_event_params(
    app_server_client: EfficiencyCodeAppServerClientMetadata,
    runtime: EfficiencyCodeRuntimeMetadata,
    turn_id: String,
    turn_state: &TurnState,
    thread_metadata: &ThreadMetadataState,
) -> EfficiencyCodeTurnEventParams {
    let (
        Some(thread_id),
    ...
    let EfficiencyCode_error = turn_state.EfficiencyCode_error.as_ref();
    EfficiencyCodeTurnEventParams {
        thread_id,
        session_id: thread_metadata.session_id.clone(),
        turn_id,
        ...
        EfficiencyCode_error_kind: EfficiencyCode_error.map(|error| error.kind),
        EfficiencyCode_error_http_status_code: EfficiencyCode_error
...
fn analytics_turn_status(
    status: EfficiencyCode_app_server_protocol::TurnStatus,
) -> Option<TurnStatus> {
    match status {
        EfficiencyCode_app_server_protocol::TurnStatus::Completed => Some(TurnStatus::Completed),
        EfficiencyCode_app_server_protocol::TurnStatus::Failed => Some(TurnStatus::Failed),
        EfficiencyCode_app_server_protocol::TurnStatus::Interrupted => {
            Some(TurnStatus::Interrupted)
        }
        EfficiencyCode_app_server_protocol::TurnStatus::InProgress => None,
    }
}
    ...
    fn command_execution_script_paths_reject_unsafe_values() {
        assert_eq!(
            safe_plugin_relative_script_path(
                ...
                Some(
                    "/home/user/.EfficiencyCode/plugins/cache/openai-curated/sample/scripts/run.py"
                ),
            ),
            None
        );
