...
pub use EfficiencyCode_protocol::error::EfficiencyCodeErrKind;
...
/// Measurements for one successfully decoded image at the point where EfficiencyCode prepares it for
...
#[derive(Clone)]
pub struct TurnEfficiencyCodeErrorFact {
    pub(crate) turn_id: String,
    pub(crate) thread_id: String,
    pub(crate) error: TurnEfficiencyCodeError,
}

impl TurnEfficiencyCodeErrorFact {
    pub fn from_EfficiencyCode_err(
        thread_id: String,
        turn_id: String,
        ...
        Self {
            turn_id,
            thread_id,
            error: TurnEfficiencyCodeError::from_EfficiencyCode_err(error),
        }
    }
}

#[derive(Clone)]
pub(crate) struct TurnEfficiencyCodeError {
    pub(crate) kind: EfficiencyCodeErrKind,
    pub(crate) http_status_code: Option<u16>,
}

impl TurnEfficiencyCodeError {
    fn from_EfficiencyCode_err(error: &EfficiencyCodeErr) -> Self {
        Self {
            kind: error.into(),
...
#[derive(Clone)]
pub struct EfficiencyCodeTurnSteerEvent {
...
#[derive(Clone)]
pub struct EfficiencyCodeCompactionEvent {
    pub thread_id: String,
    pub turn_id: String,
    ...
    pub EfficiencyCode_error_kind: Option<EfficiencyCodeErrKind>,
    pub EfficiencyCode_error_http_status_code: Option<u16>,
...
#[derive(Clone)]
pub struct EfficiencyCodeGoalEvent {
    pub thread_id: String,
    pub turn_id: Option<String>,
    pub goal_id: String,
    pub event_kind: GoalEventKind,
    pub goal_status: EfficiencyCode_state::ThreadGoalStatus,
...
pub(crate) enum CustomAnalyticsFact {
    ...
    Compaction(Box<EfficiencyCodeCompactionEvent>),
    Goal(Box<EfficiencyCodeGoalEvent>),
    GuardianReview(Box<GuardianReviewEventParams>),
    TurnResolvedConfig(Box<TurnResolvedConfigFact>),
    TurnTokenUsage(Box<TurnTokenUsageFact>),
    TurnProfile(Box<TurnProfileFact>),
    TurnEfficiencyCodeError(Box<TurnEfficiencyCodeErrorFact>),
