...
pub const EfficiencyCode_OPEN_APP_URL: &str = "https://chatgpt.com/EfficiencyCode/open-app";
...
pub(crate) fn compose_success_url(
    ...
    if EfficiencyCode_streamlined_login {
        params.push(("EfficiencyCode_streamlined_login", "true".to_string()));
    }
    let query = params
        .into_iter()
