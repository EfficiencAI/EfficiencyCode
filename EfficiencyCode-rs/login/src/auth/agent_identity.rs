...
use EfficiencyCode_agent_identity::agent_identity_jwks_url;
use EfficiencyCode_agent_identity::agent_registration_url;
use EfficiencyCode_agent_identity::agent_task_registration_url;
use EfficiencyCode_agent_identity::build_abom;
use EfficiencyCode_agent_identity::decode_agent_identity_jwt;
use EfficiencyCode_agent_identity::fetch_agent_identity_jwks;
use EfficiencyCode_agent_identity::generate_agent_key_material;
use EfficiencyCode_agent_identity::is_retryable_registration_error;
use EfficiencyCode_agent_identity::public_key_ssh_from_private_key_pkcs8_base64;
use EfficiencyCode_agent_identity::register_agent_identity;
use EfficiencyCode_agent_identity::register_agent_task;
...
const EfficiencyCode_AGENT_IDENTITY_AUTHAPI_BASE_URL_ENV_VAR: &str =
    "EfficiencyCode_AGENT_IDENTITY_AUTHAPI_BASE_URL";
const EfficiencyCode_AGENT_IDENTITY_JWKS_BASE_URL_ENV_VAR: &str =
...
pub(super) fn agent_identity_authapi_base_url(
    ...
    let authapi_base_url =
        agent_identity_endpoint_override(EfficiencyCode_AGENT_IDENTITY_AUTHAPI_BASE_URL_ENV_VAR);
    let jwks_base_url =
        agent_identity_endpoint_override(EfficiencyCode_AGENT_IDENTITY_JWKS_BASE_URL_ENV_VAR);
...
pub(super) async fn verified_record_from_jwt(
    ...
    let jwks_base_url =
        match agent_identity_endpoint_override(EfficiencyCode_AGENT_IDENTITY_JWKS_BASE_URL_ENV_VAR)
        {
            Some(base_url) => {
