...
use EfficiencyCode_app_server_protocol::RemoteControlDisableParams;
use EfficiencyCode_app_server_protocol::RemoteControlDisableResponse;
use EfficiencyCode_app_server_protocol::RemoteControlEnableParams;
...
async fn connect_with_retry(
    ...
    connect_timeout: Duration,
    connect_retry_delay: Duration,
) -> Result<WebSocketStream<EfficiencyCode_uds::UnixStream>> {
...
mod tests {
    ...
    const TEST_EfficiencyCode_HOME: &str = "/tmp/EfficiencyCode-home";
        ...
        client::send_message(
            ...
            &JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "EfficiencyCode_app_server/1.2.3",
                    "EfficiencyCodeHome": TEST_EfficiencyCode_HOME,
                    "platformFamily": "unix",
                    "platformOs": "macos",
                }),
            }),
