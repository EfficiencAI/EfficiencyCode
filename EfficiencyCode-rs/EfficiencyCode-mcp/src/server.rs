...
use EfficiencyCode_rmcp_client::StoredOAuthCredentialSnapshot;
...
pub(crate) struct McpServerConnectionIdentity {
    ...
    runtime_auth: Option<EfficiencyCodeAuth>,
    runtime_auth_token: Option<String>,
    EfficiencyCode_apps_cache_identity: Option<(PathBuf, ConnectorRuntimeContextKey)>,
...
impl McpServerConnectionIdentity {
    ...
    pub(crate) fn new(
        ...
        Self {
            ...
            runtime_auth,
            runtime_auth_token,
            EfficiencyCode_apps_cache_identity,
    ...
    pub(crate) fn has_same_connection_config(&self, other: &Self) -> bool {
        let same_runtime_auth = match (&self.runtime_auth, &other.runtime_auth) {
            (
                Some(EfficiencyCodeAuth::AgentIdentity(left)),
                Some(EfficiencyCodeAuth::AgentIdentity(right)),
        ...
        self.transport == other.transport
            ...
            && self.EfficiencyCode_apps_cache_identity == other.EfficiencyCode_apps_cache_identity
