pub use EfficiencyCode_rmcp_client::McpProtocolMode;
...
/// Backward-compatible name for the shared EfficiencyCode Apps tools runtime.
pub type EfficiencyCodeAppsToolsCache =
    EfficiencyCode_connectors::ConnectorRuntimeManager<ToolInfo>;
/// Backward-compatible name for the EfficiencyCode Apps runtime context key.
pub type EfficiencyCodeAppsToolsCacheKey = EfficiencyCode_connectors::ConnectorRuntimeContextKey;
...
pub use mcp::EfficiencyCode_APPS_MCP_SERVER_NAME;
pub use mcp::McpConfig;
pub use mcp::ToolPluginProvenance;
pub use server::EffectiveMcpServer;

/// Backward-compatible name for the EfficiencyCode Apps runtime context key builder.
pub use EfficiencyCode_connectors::connector_runtime_context_key as EfficiencyCode_apps_tools_cache_key;
pub use auth_elicitation::EfficiencyCodeAppsAuthElicitation;
pub use auth_elicitation::EfficiencyCodeAppsAuthElicitationPlan;
pub use auth_elicitation::EfficiencyCodeAppsConnectorAuthFailure;
pub use auth_elicitation::MCP_TOOL_EfficiencyCode_APPS_META_KEY;
...
pub use mcp::EfficiencyCode_apps_mcp_server_config;
pub use mcp::configured_mcp_servers;
pub use mcp::effective_mcp_servers;
pub use mcp::effective_mcp_servers_from_configured;
pub use mcp::host_owned_EfficiencyCode_apps_enabled;
...
pub use EfficiencyCode_apps::declared_openai_file_input_param_names;
pub use mcp::McpPermissionPromptAutoApproveContext;
pub use mcp::mcp_permission_prompt_is_auto_approved;
pub use mcp::qualified_mcp_tool_name_prefix;

pub(crate) mod EfficiencyCode_apps;
