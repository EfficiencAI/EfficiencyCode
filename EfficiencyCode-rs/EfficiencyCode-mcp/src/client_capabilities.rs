...
/// Selects the MCP extensions EfficiencyCode supports from those declared by the app-server host.
///
/// App-server clients may declare unrelated extensions. EfficiencyCode retains only the
