//! EfficiencyCode Apps support for the host-owned apps MCP server.
//!
...
use EfficiencyCode_utils_plugins::mcp_connector::sanitize_name;
...
pub(crate) fn normalize_EfficiencyCode_apps_tool_title(
...
pub(crate) fn normalize_EfficiencyCode_apps_callable_name(
    tool_name: &str,
...
pub(crate) fn normalize_EfficiencyCode_apps_callable_namespace(
    server_name: &str,
    connector_name: Option<&str>,
) -> String {
    if let Some(connector_name) = connector_name {
