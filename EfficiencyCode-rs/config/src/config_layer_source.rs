...
/// Provenance for one layer in the effective EfficiencyCode configuration.
...
pub enum ConfigLayerSource {
    ...
    /// Configuration loaded from a project's `.EfficiencyCode` directory.
    Project {
    ...
    match source {
        ...
        ConfigLayerSource::Project {
            ...
            format!(
                ...
                dot_EfficiencyCode_folder.as_path().display()
            )
        }
