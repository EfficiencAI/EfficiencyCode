...
pub type LoadedPlugin = EfficiencyCode_plugin::LoadedPlugin<EfficiencyCode_config::McpServerConfig>;
pub type PluginLoadOutcome =
    EfficiencyCode_plugin::PluginLoadOutcome<EfficiencyCode_config::McpServerConfig>;
