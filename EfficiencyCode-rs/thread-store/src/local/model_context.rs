...
use EfficiencyCode_rollout::ModelContextScan;
use EfficiencyCode_rollout::ModelContextScanProgress;
use EfficiencyCode_rollout::ReverseJsonlScanner;
use EfficiencyCode_rollout::RolloutItem;
use EfficiencyCode_rollout::RolloutLine;
use EfficiencyCode_rollout::ScanOutcome;
...
pub(super) async fn load_for_fork(
    ...
    let session_meta = EfficiencyCode_rollout::read_session_meta_line(source_path)
        .await
        .map_err(|err| ThreadStoreError::Internal {
            message: format!(
