...
//!
//! Application code should treat [`EfficiencyCode_protocol::ThreadId`] as the only durable thread handle.
...
pub use EfficiencyCode_state::MAX_QUEUE_ITEMS;
pub use EfficiencyCode_state::QueuedUserSubmissionRecord;
