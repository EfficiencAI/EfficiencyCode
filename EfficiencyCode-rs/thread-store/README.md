...
`EfficiencyCode-thread-store` is the storage boundary for EfficiencyCode threads. It defines the
...
- `LocalThreadStore` persists history through `EfficiencyCode-rollout` JSONL files and
