//! Resolve the release identity of the current EfficiencyCode runtime.
...
impl BuildInfo {
    /// Return build information for the current EfficiencyCode runtime.
    pub fn get() -> Self {
        BUILD_INFO
    ...
    /// Format the version for a user-facing EfficiencyCode header.
