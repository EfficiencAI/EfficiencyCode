...
const CONNECTOR_DIRECTORY_DISK_CACHE_DIR: &str = "cache/EfficiencyCode_app_directory";
...
impl ConnectorDirectoryCacheContext {
    pub fn new(EfficiencyCode_home: PathBuf, cache_key: ConnectorDirectoryCacheKey) -> Self {
        Self {
            EfficiencyCode_home,
            cache_key,
        }
