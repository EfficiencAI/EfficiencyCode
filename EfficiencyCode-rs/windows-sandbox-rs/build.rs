...
const SETUP_BIN: &str = "EfficiencyCode-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "EfficiencyCode-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so EfficiencyCode binaries that link the
