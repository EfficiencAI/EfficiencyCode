...
pub use EfficiencyCode_protocol::config_types::WindowsSandboxProxySettingsMode;
...
#[cfg(target_os = "windows")]
pub use logging::current_log_file_path_for_EfficiencyCode_home;
#[cfg(target_os = "windows")]
...
#[cfg(target_os = "windows")]
pub use wrapper::EfficiencyCode_WINDOWS_SANDBOX_ARG1;
#[cfg(target_os = "windows")]
...
mod windows_impl {
    ...
    use super::sandbox_utils::ensure_EfficiencyCode_home_exists;
