...
const SESSION_NAME: &str = "EfficiencyCode Windows Sandbox WFP";
const PROVIDER_NAME: &str = "EfficiencyCode Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str =
    "Persistent WFP provider for EfficiencyCode Windows sandbox filters";
const SUBLAYER_NAME: &str = "EfficiencyCode Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str =
    "Persistent WFP sublayer for EfficiencyCode Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are EfficiencyCode-owned identities; do not regenerate them unless we
...
/// Installs the persistent EfficiencyCode WFP filters for `account`.
///
...
/// Ensures the persistent EfficiencyCode WFP provider exists.
...
/// Ensures the persistent EfficiencyCode sublayer exists under the EfficiencyCode provider.
