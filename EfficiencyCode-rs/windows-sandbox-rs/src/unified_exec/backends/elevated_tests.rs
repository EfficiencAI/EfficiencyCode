...
fn retry_uses_original_unified_exec_request_and_stops_after_second_failure() {
    ...
    let request = RunnerTransportRequest {
        ...
        EfficiencyCode_home: PathBuf::from(r"C:\Users\EfficiencyCode"),
        cwd: PathBuf::from(r"C:\workspace"),
        env_map: env_map.clone(),
        logs_base_dir: Some(PathBuf::from(r"C:\Users\EfficiencyCode\.sandbox")),
        spawn_request: SpawnRequest {
            ...
            EfficiencyCode_home: PathBuf::from(r"C:\Users\EfficiencyCode\.sandbox"),
            real_EfficiencyCode_home: PathBuf::from(r"C:\Users\EfficiencyCode"),
        ...
        deny_write_paths_override: vec![PathBuf::from(r"C:\workspace\.EfficiencyCode")],
        proxy_enforced: true,
    ...
    let expected_refresh = RefreshObservation {
        ...
        env_map,
        EfficiencyCode_home: request.EfficiencyCode_home.clone(),
    ...
    let result = spawn_runner_transport_with_retry(
        ...
        &request,
        |EfficiencyCode_home, cwd, sandbox_creds, logs_base_dir, spawn_request| {
