...
use EfficiencyCode_file_system::find_nearest_native_ancestor_with_markers;
...
/// directory. If you need EfficiencyCode to work from such a checkout simply pass the
...
mod tests {
    ...
    async fn git_metadata_commands_do_not_inherit_stdin() {
        const CHILD_ENV: &str = "EfficiencyCode_GIT_UTILS_STDIN_CHILD";
    ...
    fn canonicalize_git_remote_url_normalizes_github_variants() {
        for remote in [
            "git@github.com:OpenAI/EfficiencyCode.git",
            "ssh://git@github.com/openai/EfficiencyCode.git",
            "ssh://git@github.com:22/OpenAI/EfficiencyCode.git",
            "https://github.com/openai/EfficiencyCode.git",
            "https://github.com:443/openai/EfficiencyCode.git",
            "https://token@github.com/openai/EfficiencyCode/",
            "github.com/OpenAI/EfficiencyCode.git",
        ] {
            assert_eq!(
                canonicalize_git_remote_url(remote),
                Some("github.com/openai/EfficiencyCode".to_string())
            );
        }
    }
