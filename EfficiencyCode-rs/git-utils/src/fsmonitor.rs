...
//!
//! EfficiencyCode overrides `core.fsmonitor` so repository configuration cannot select
...
/// layered, may use conditional includes, and can change while EfficiencyCode is
/// running:
