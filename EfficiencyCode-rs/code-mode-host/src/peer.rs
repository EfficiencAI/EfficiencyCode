...
impl HostPeer {
    ...
    pub(super) fn respond(
        &self,
        id: RequestId,
        result: Result<EfficiencyCode_code_mode_protocol::host::HostResponse, String>,
    ) {
    ...
    fn initial_response(
        &self,
        id: RequestId,
        result: Result<EfficiencyCode_code_mode_protocol::host::WireRuntimeResponse, String>,
    ) {
