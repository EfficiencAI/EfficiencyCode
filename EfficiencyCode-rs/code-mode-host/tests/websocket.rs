...
use EfficiencyCode_code_mode::CellId;
use EfficiencyCode_code_mode::CodeModeSessionCellExecutionLimits;
use EfficiencyCode_code_mode::CodeModeSessionProvider;
use EfficiencyCode_code_mode::CodeModeToolKind;
use EfficiencyCode_code_mode::ExecuteRequest;
use EfficiencyCode_code_mode::FunctionCallOutputContentItem;
use EfficiencyCode_code_mode::NoopCodeModeSessionDelegate;
use EfficiencyCode_code_mode::RuntimeResponse;
use EfficiencyCode_code_mode::ToolDefinition;
use EfficiencyCode_code_mode::WebSocketCodeModeSessionProvider;
use EfficiencyCode_code_mode_protocol::host::Capability;
use EfficiencyCode_code_mode_protocol::host::CapabilitySet;
use EfficiencyCode_code_mode_protocol::host::ClientHello;
use EfficiencyCode_code_mode_protocol::host::ClientToHost;
use EfficiencyCode_code_mode_protocol::host::DUAL_WEBSOCKET_CAPABILITY;
use EfficiencyCode_code_mode_protocol::host::DelegateRequest;
use EfficiencyCode_code_mode_protocol::host::DelegateResponse;
use EfficiencyCode_code_mode_protocol::host::EncodedFrame;
use EfficiencyCode_code_mode_protocol::host::HostHello;
use EfficiencyCode_code_mode_protocol::host::HostRequest;
use EfficiencyCode_code_mode_protocol::host::HostResponse;
use EfficiencyCode_code_mode_protocol::host::HostToClient;
use EfficiencyCode_code_mode_protocol::host::MAX_FRAME_BYTES;
use EfficiencyCode_code_mode_protocol::host::ProtocolVersion;
use EfficiencyCode_code_mode_protocol::host::RequestId;
use EfficiencyCode_code_mode_protocol::host::SESSION_RESOURCE_LIMITS_CAPABILITY;
use EfficiencyCode_code_mode_protocol::host::SessionId;
use EfficiencyCode_code_mode_protocol::host::SupportedProtocolVersions;
use EfficiencyCode_code_mode_protocol::host::WireContentItem;
use EfficiencyCode_code_mode_protocol::host::WireExecuteRequest;
use EfficiencyCode_code_mode_protocol::host::WireResult;
use EfficiencyCode_code_mode_protocol::host::WireRuntimeResponse;
use EfficiencyCode_code_mode_protocol::host::WireToolDefinition;
use EfficiencyCode_code_mode_protocol::host::WireToolKind;
use EfficiencyCode_code_mode_protocol::host::WireToolName;
use EfficiencyCode_code_mode_protocol::host::WireWaitRequest;
...
async fn websocket_control_operations_bypass_an_incomplete_bulk_frame() -> Result<()> {
    ...
    let bulk_message = ClientToHost::DelegateResponse {
        id: EfficiencyCode_code_mode_protocol::host::DelegateRequestId::new(/*value*/ 999),
        result: WireResult::Ok {
            value: DelegateResponse::ToolResult {
        ...
        .send(&ClientToHost::Request {
            ...
            request: HostRequest::Wait {
                ...
                request: WireWaitRequest {
                    cell_id: EfficiencyCode_code_mode_protocol::host::WireCellId::new(
                        "missing-cell",
                    ),
                    yield_time_ms: 10,
                },
...
async fn websocket_bulk_lane_rejects_control_messages() -> Result<()> {
    ...
    bulk.send(&ClientToHost::Request {
        ...
        request: HostRequest::Wait {
            session_id,
            request: WireWaitRequest {
                cell_id: EfficiencyCode_code_mode_protocol::host::WireCellId::new("missing-cell"),
                yield_time_ms: 10,
            },
        },
    })
