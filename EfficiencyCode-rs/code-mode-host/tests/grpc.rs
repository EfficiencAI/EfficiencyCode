...
use EfficiencyCode_code_mode::GrpcCodeModeSessionProvider;
...
use EfficiencyCode_code_mode_protocol::grpc;
use EfficiencyCode_code_mode_protocol::grpc::code_mode_host_client::CodeModeHostClient;
