...
use EfficiencyCode_code_mode_protocol::CellId;
use EfficiencyCode_code_mode_protocol::CodeModeNestedToolCall;
use EfficiencyCode_code_mode_protocol::CodeModeSessionCellExecutionLimits;
use EfficiencyCode_code_mode_protocol::CodeModeSessionDelegate;
use EfficiencyCode_code_mode_protocol::ExecuteRequest;
use EfficiencyCode_code_mode_protocol::NotificationFuture;
use EfficiencyCode_code_mode_protocol::ToolInvocationFuture;
use EfficiencyCode_code_mode_protocol::WaitRequest;
...
use EfficiencyCode_code_mode_protocol::host::DelegateRequestId;
...
use EfficiencyCode_code_mode_protocol::host::MAX_PENDING_DELEGATE_CALLS;
use EfficiencyCode_code_mode_protocol::host::RequestId;
use EfficiencyCode_code_mode_protocol::host::SessionId;
use EfficiencyCode_code_mode_protocol::host::WireNestedToolCall;
use EfficiencyCode_code_mode_protocol::host::WireResult;
use EfficiencyCode_code_mode_protocol::host::WireRuntimeResponse;
use EfficiencyCode_code_mode_protocol::host::WireSessionCellExecutionLimits;
use EfficiencyCode_code_mode_protocol::host::WireWaitOutcome;
...
struct DriverHarness {
    ...
    outgoing_rx: mpsc::Receiver<EfficiencyCode_code_mode_protocol::host::EncodedFrame>,
...
impl DriverHarness {
    ...
    async fn start_cell(
        ...
        request_id: i64,
        cell_id: &str,
    ) -> EfficiencyCode_code_mode_protocol::StartedCell {
        let (response_tx, response_rx) = oneshot::channel();
        self.command_tx
            ...
            .send(DriverEvent::HostMessage(HostToClient::DelegateRequest {
                ...
                request: DelegateRequest::InvokeTool {
                    invocation: WireNestedToolCall {
                        ...
                        tool_kind: EfficiencyCode_code_mode_protocol::CodeModeToolKind::Function
                            .into(),
                        input: None,
                    },
                },
...
async fn deferred_delegates_follow_cell_readiness_and_cancellation() {
    ...
    assert_eq!(
        ...
        ClientToHost::DelegateResponse {
            ...
            result: WireResult::Ok {
                value:
                    EfficiencyCode_code_mode_protocol::host::DelegateResponse::NotificationDelivered,
            },
        }
    );
        ...
        .send(DriverEvent::HostMessage(HostToClient::DelegateRequest {
            ...
            request: DelegateRequest::InvokeTool {
                invocation: WireNestedToolCall {
                    ...
                    runtime_tool_call_id: "tool-1".to_string(),
                    tool_name: ToolName::plain("slow").into(),
                    tool_kind: EfficiencyCode_code_mode_protocol::CodeModeToolKind::Function.into(),
                    input: None,
                },
            },
        }))
...
async fn terminate_closes_cell_without_waiting_for_delegate_cleanup() {
    ...
    assert_eq!(
        ...
        Ok(EfficiencyCode_code_mode_protocol::WaitOutcome::LiveCell(
            EfficiencyCode_code_mode_protocol::RuntimeResponse::Terminated {
                cell_id: CellId::new("1".to_string()),
                content_items: Vec::new(),
            }
        ))
...
async fn remote_wait_accepts_durations_longer_than_five_minutes() {
    ...
    assert_eq!(
        ...
        Ok(EfficiencyCode_code_mode_protocol::WaitOutcome::LiveCell(
            EfficiencyCode_code_mode_protocol::RuntimeResponse::Yielded {
                cell_id: CellId::new("1".to_string()),
                content_items: Vec::new(),
            }
        ))
