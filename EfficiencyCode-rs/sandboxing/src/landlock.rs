...
/// Basename used when the EfficiencyCode executable self-invokes as the Linux sandbox
/// helper.
pub const EfficiencyCode_LINUX_SANDBOX_ARG0: &str = "EfficiencyCode-linux-sandbox";
