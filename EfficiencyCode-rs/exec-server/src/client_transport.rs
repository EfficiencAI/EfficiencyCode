...
const ENVIRONMENT_CLIENT_NAME: &str = "EfficiencyCode-environment";
...
impl ExecServerClient {
    ...
    #[tracing::instrument(name = "EfficiencyCode.exec_server.remote.noise.connect", skip_all)]
    ...
    #[tracing::instrument(
        name = "EfficiencyCode.exec_server.remote.harness.connect",
        skip_all,
        fields(
            otel.kind = "client",
            otel.name = "EfficiencyCode.exec_server.remote.harness.connect",
        )
    )]
    ...
    #[tracing::instrument(
        name = "EfficiencyCode.exec_server.remote.noise.websocket_connect",
        skip_all,
        fields(
            otel.kind = "client",
            otel.name = "EfficiencyCode.exec_server.remote.noise.websocket_connect",
