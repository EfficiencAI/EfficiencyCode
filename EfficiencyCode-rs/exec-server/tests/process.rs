...
use EfficiencyCode_exec_server::EnvironmentInfo;
use EfficiencyCode_exec_server::EnvironmentStatus;
use EfficiencyCode_exec_server::EnvironmentStatusKind;
...
use EfficiencyCode_exec_server::TerminateResponse;
