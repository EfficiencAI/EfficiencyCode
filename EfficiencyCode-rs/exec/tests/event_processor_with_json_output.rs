use EfficiencyCode_app_server_protocol::CollabAgentState as ApiCollabAgentState;
use EfficiencyCode_app_server_protocol::CollabAgentStatus as ApiCollabAgentStatus;
use EfficiencyCode_app_server_protocol::CollabAgentTool;
use EfficiencyCode_app_server_protocol::CollabAgentToolCallStatus as ApiCollabAgentToolCallStatus;
use EfficiencyCode_app_server_protocol::CommandAction;
use EfficiencyCode_app_server_protocol::CommandExecutionSource;
use EfficiencyCode_app_server_protocol::CommandExecutionStatus as ApiCommandExecutionStatus;
use EfficiencyCode_app_server_protocol::ErrorNotification;
use EfficiencyCode_app_server_protocol::FileUpdateChange as ApiFileUpdateChange;
...
use EfficiencyCode_app_server_protocol::McpToolCallError;
use EfficiencyCode_app_server_protocol::McpToolCallResult;
use EfficiencyCode_app_server_protocol::McpToolCallStatus as ApiMcpToolCallStatus;
use EfficiencyCode_app_server_protocol::PatchApplyStatus as ApiPatchApplyStatus;
use EfficiencyCode_app_server_protocol::PatchChangeKind as ApiPatchChangeKind;
...
use EfficiencyCode_app_server_protocol::WebSearchAction as ApiWebSearchAction;
use EfficiencyCode_app_server_protocol::WebSearchItem as ApiWebSearchItem;
...
use EfficiencyCode_exec::AgentMessageItem;
use EfficiencyCode_exec::CollabAgentState;
use EfficiencyCode_exec::CollabAgentStatus;
use EfficiencyCode_exec::CollabTool;
use EfficiencyCode_exec::CollabToolCallItem;
use EfficiencyCode_exec::CollabToolCallStatus;
use EfficiencyCode_exec::CollectedThreadEvents;
use EfficiencyCode_exec::CommandExecutionItem;
use EfficiencyCode_exec::CommandExecutionStatus;
use EfficiencyCode_exec::EfficiencyCodeStatus;
use EfficiencyCode_exec::ErrorItem;
use EfficiencyCode_exec::EventProcessorWithJsonOutput;
use EfficiencyCode_exec::ExecThreadItem;
use EfficiencyCode_exec::FileChangeItem;
use EfficiencyCode_exec::FileUpdateChange as ExecFileUpdateChange;
use EfficiencyCode_exec::ItemCompletedEvent;
use EfficiencyCode_exec::ItemStartedEvent;
use EfficiencyCode_exec::ItemUpdatedEvent;
use EfficiencyCode_exec::McpToolCallItem;
use EfficiencyCode_exec::McpToolCallItemError;
use EfficiencyCode_exec::McpToolCallItemResult;
use EfficiencyCode_exec::McpToolCallStatus;
use EfficiencyCode_exec::PatchApplyStatus;
use EfficiencyCode_exec::PatchChangeKind;
use EfficiencyCode_exec::ReasoningItem;
use EfficiencyCode_exec::ThreadErrorEvent;
use EfficiencyCode_exec::ThreadEvent;
use EfficiencyCode_exec::ThreadItemDetails;
use EfficiencyCode_exec::ThreadStartedEvent;
use EfficiencyCode_exec::TodoItem;
use EfficiencyCode_exec::TodoListItem;
use EfficiencyCode_exec::TurnCompletedEvent;
use EfficiencyCode_exec::TurnFailedEvent;
use EfficiencyCode_exec::TurnStartedEvent;
use EfficiencyCode_exec::Usage;
use EfficiencyCode_exec::WebSearchItem;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_configured = SessionConfiguredEvent {
        ...
        thread_source: None,
        thread_name: None,
        model: "EfficiencyCode-mini-latest".to_string(),
        model_provider_id: "test-provider".to_string(),
        service_tier: None,
        approval_policy: AskForApproval::Never,
        approvals_reviewer: EfficiencyCode_protocol::config_types::ApprovalsReviewer::User,
...
fn turn_started_emits_turn_started_event() {
    ...
    assert_eq!(
        ...
        CollectedThreadEvents {
            ...
            status: EfficiencyCodeStatus::Running,
        }
    );
}
...
fn plan_update_emits_started_then_updated_then_completed() {
    ...
    assert_eq!(
        ...
        CollectedThreadEvents {
            ...
            status: EfficiencyCodeStatus::InitiateShutdown,
        }
    );
}
...
fn token_usage_update_is_emitted_on_turn_completion() {
    ...
    let usage_update =
        processor.collect_thread_events(ServerNotification::ThreadTokenUsageUpdated(
            EfficiencyCode_app_server_protocol::ThreadTokenUsageUpdatedNotification {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
...
fn failed_turn_clears_stale_final_message() {
    ...
    assert_eq!(collected.status, EfficiencyCodeStatus::Running);
    ...
    assert_eq!(collected.status, EfficiencyCodeStatus::InitiateShutdown);
...
fn model_reroute_surfaces_as_error_item() {
    ...
    let collected = processor.collect_thread_events(ServerNotification::ModelRerouted(
        EfficiencyCode_app_server_protocol::ModelReroutedNotification {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            from_model: "gpt-5".to_string(),
            to_model: "gpt-5-mini".to_string(),
            reason: EfficiencyCode_app_server_protocol::ModelRerouteReason::HighRiskCyberActivity,
        },
    ));
