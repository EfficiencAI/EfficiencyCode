...
fn failed_turn_does_not_overwrite_output_last_message_file() {
    ...
    let status = processor.process_server_notification(ServerNotification::TurnCompleted(
        EfficiencyCode_app_server_protocol::TurnCompletedNotification {
            ...
            turn: EfficiencyCode_app_server_protocol::Turn {
                ...
                error: Some(EfficiencyCode_app_server_protocol::TurnError {
    ...
    assert_eq!(status, EfficiencyCodeStatus::InitiateShutdown);
    ...
    let collected = processor.collect_thread_events(ServerNotification::ItemCompleted(
        EfficiencyCode_app_server_protocol::ItemCompletedNotification {
            item: ThreadItem::McpToolCall {
                ...
                arguments: json!({"search_query": [{"q": "OpenAI EfficiencyCode CLI documentation"}]}),
                app_context: None,
                mcp_app_resource_uri: None,
                plugin_id: None,
                read_only_hint: None,
                result: Some(Box::new(EfficiencyCode_app_server_protocol::McpToolCallResult {
