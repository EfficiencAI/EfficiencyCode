...
mod EfficiencyCode_tool_config;
mod EfficiencyCode_tool_runner;
...
pub use crate::EfficiencyCode_tool_config::EfficiencyCodeToolCallParam;
pub use crate::EfficiencyCode_tool_config::EfficiencyCodeToolCallReplyParam;
...
const OTEL_SERVICE_NAME: &str = "EfficiencyCode_mcp_server";
...
mod tests {
    ...
    async fn mcp_server_builds_otel_provider_with_logs_traces_and_metrics() -> anyhow::Result<()> {
        ...
        let provider = EfficiencyCode_core::otel_init::build_provider(
            &config,
            "0.0.0-test",
            Some(OTEL_SERVICE_NAME),
            DEFAULT_ANALYTICS_ENABLED,
