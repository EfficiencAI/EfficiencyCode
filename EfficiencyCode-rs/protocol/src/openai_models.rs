//! Shared model metadata types exchanged between EfficiencyCode services and clients.
//!
...
/// Metadata describing a EfficiencyCode-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the EfficiencyCode backend `/models` endpoint.
