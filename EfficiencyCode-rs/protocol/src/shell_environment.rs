...
pub const EfficiencyCode_SESSION_ID_ENV_VAR: &str = "EfficiencyCode_SESSION_ID";
pub const EfficiencyCode_THREAD_ID_ENV_VAR: &str = "EfficiencyCode_THREAD_ID";
...
///
/// This prevents accidental propagation of EfficiencyCode launch context; it is not a
...
mod windows_tests {
    ...
    fn core_inherit_preserves_windows_startup_vars_case_insensitively() {
        let vars = make_vars(&[
            ...
            ("AppData", "C:\\Users\\EfficiencyCode\\AppData\\Roaming"),
        ...
        let expected = HashMap::from([
            ...
            (
                "AppData".to_string(),
                "C:\\Users\\EfficiencyCode\\AppData\\Roaming".to_string(),
            ),
...
mod non_windows_tests {
    ...
    fn core_inherit_preserves_non_windows_core_vars_case_insensitively() {
        ...
        let expected = HashMap::from([
            ...
            ("home".to_string(), "/home/EfficiencyCode".to_string()),
