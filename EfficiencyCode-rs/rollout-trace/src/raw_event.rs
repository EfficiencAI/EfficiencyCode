...
pub struct RawTraceEvent {
    ...
    pub EfficiencyCode_turn_id: Option<EfficiencyCodeTurnId>,
...
pub enum RawTraceEventPayload {
    ...
    EfficiencyCodeTurnStarted {
        EfficiencyCode_turn_id: EfficiencyCodeTurnId,
        thread_id: AgentThreadId,
    },
    EfficiencyCodeTurnEnded {
        EfficiencyCode_turn_id: EfficiencyCodeTurnId,
    ...
    InferenceCancelled {
        ...
        /// before EfficiencyCode stopped consuming the stream.
        upstream_request_id: Option<String>,
        /// Why EfficiencyCode stopped consuming the provider stream before a terminal response event.
        reason: String,
    ...
    ToolCallRuntimeStarted {
        tool_call_id: ToolCallId,
        /// Runtime/protocol observation for how EfficiencyCode began executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallRuntimeEnded {
        tool_call_id: ToolCallId,
        status: ExecutionStatus,
        /// Runtime/protocol observation for how EfficiencyCode finished executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallEnded {
        tool_call_id: ToolCallId,
    ...
    AgentResultObserved {
        ...
        child_EfficiencyCode_turn_id: EfficiencyCodeTurnId,
...
impl RawTraceEventPayload {
    ...
    pub(crate) fn raw_payload_refs(&self) -> Vec<&RawPayloadRef> {
        match self {
            ...
            | RawTraceEventPayload::EfficiencyCodeTurnEnded { .. }
