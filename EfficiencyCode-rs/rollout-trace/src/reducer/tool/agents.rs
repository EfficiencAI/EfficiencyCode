use EfficiencyCode_protocol::protocol::CollabAgentInteractionBeginEvent;
use EfficiencyCode_protocol::protocol::CollabAgentInteractionEndEvent;
use EfficiencyCode_protocol::protocol::CollabAgentSpawnEndEvent;
use EfficiencyCode_protocol::protocol::CollabCloseBeginEvent;
use EfficiencyCode_protocol::protocol::CollabCloseEndEvent;
...
pub(in crate::reducer) struct ObservedAgentResultEdge {
    ...
    pub(in crate::reducer) child_EfficiencyCode_turn_id: String,
...
impl TraceReducer {
    ...
    pub(in crate::reducer) fn queue_agent_result_interaction_edge(
        ...
        let source = if let Some(source_item_id) = self.latest_assistant_message_item_for_turn(
            ...
            &observed.child_EfficiencyCode_turn_id,
        ) {
        ...
        self.rollout
            ...
            .filter(|item| {
                item.thread_id == thread_id
                    && item.EfficiencyCode_turn_id.as_deref() == Some(EfficiencyCode_turn_id)
