//! Trace bundle format, writer, and reducer for EfficiencyCode rollouts.
//!
//! This crate owns the trace schema. Hot-path EfficiencyCode code should depend on the
...
/// Shared recorder context for inference attempts within one EfficiencyCode turn.
...
pub use thread::EfficiencyCode_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical EfficiencyCode tool boundary.
...
/// Append-only writer used by hot-path EfficiencyCode instrumentation.
