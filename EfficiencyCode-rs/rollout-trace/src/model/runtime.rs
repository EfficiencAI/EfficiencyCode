...
use super::EdgeId;
use super::EfficiencyCodeTurnId;
use super::McpCallId;
...
/// Runtime operation requested by the model, a JS code cell, or EfficiencyCode itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_EfficiencyCode_turn_id: Option<EfficiencyCodeTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the EfficiencyCode tool boundary.
    ///
    ...
    /// they describe how EfficiencyCode executed the request, not what the caller sent.
