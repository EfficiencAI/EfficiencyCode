...
/// EfficiencyCode conversation/session UUID.
...
pub type EfficiencyCodeTurnId = String;
...
/// Process/session ID returned by EfficiencyCode's terminal runtime.
...
/// Canonical reduced graph for one EfficiencyCode rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the EfficiencyCode rollout/session being observed. `trace_id`
    ...
    pub EfficiencyCode_turns: BTreeMap<EfficiencyCodeTurnId, EfficiencyCodeTurn>,
...
impl RolloutTrace {
    ...
    pub(crate) fn new(
        ...
        Self {
            ...
            EfficiencyCode_turns: BTreeMap::new(),
