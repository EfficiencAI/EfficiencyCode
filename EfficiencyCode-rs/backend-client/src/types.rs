pub use EfficiencyCode_backend_openapi_models::models::ConfigBundleResponse;
pub use EfficiencyCode_backend_openapi_models::models::CreditStatusDetails;
pub use EfficiencyCode_backend_openapi_models::models::DeliveredConfigToml;
pub use EfficiencyCode_backend_openapi_models::models::DeliveredManagedLayers;
pub use EfficiencyCode_backend_openapi_models::models::DeliveredRequirementsToml;
pub use EfficiencyCode_backend_openapi_models::models::DeliveredTomlFragment;
pub use EfficiencyCode_backend_openapi_models::models::PaginatedListTaskListItem;
pub use EfficiencyCode_backend_openapi_models::models::PlanType;
pub use EfficiencyCode_backend_openapi_models::models::RateLimitReachedKind;
pub use EfficiencyCode_backend_openapi_models::models::RateLimitStatusDetails;
pub use EfficiencyCode_backend_openapi_models::models::RateLimitStatusPayload;
pub use EfficiencyCode_backend_openapi_models::models::RateLimitWindowSnapshot;
pub use EfficiencyCode_backend_openapi_models::models::SpendControlLimitDetails;
pub use EfficiencyCode_backend_openapi_models::models::TaskListItem;
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct EfficiencyCodeWorkspaceMessagesResponse {
    #[serde(default)]
    pub messages: Vec<EfficiencyCodeWorkspaceMessage>,
}

/// Authenticated EfficiencyCode user settings used by CLI runtime policy.
#[derive(Clone, Copy, Debug, Default, Deserialize, PartialEq, Eq)]
pub struct EfficiencyCodeUserSettingsResponse {
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct EfficiencyCodeWorkspaceMessage {
    pub message_id: String,
    pub message_type: EfficiencyCodeWorkspaceMessageType,
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum EfficiencyCodeWorkspaceMessageType {
    Headline,
    Announcement,
    #[serde(other)]
    Unknown,
...
Second line"
    ...
    fn workspace_messages_response_deserializes_messages() {
        let response: EfficiencyCodeWorkspaceMessagesResponse =
        ...
        assert_eq!(
            response,
            EfficiencyCodeWorkspaceMessagesResponse {
                messages: vec![
                    EfficiencyCodeWorkspaceMessage {
                        message_id: "headline-id".to_string(),
                        message_type: EfficiencyCodeWorkspaceMessageType::Headline,
                    ...
                    EfficiencyCodeWorkspaceMessage {
                        ...
                        message_type: EfficiencyCodeWorkspaceMessageType::Announcement,
                    ...
                    EfficiencyCodeWorkspaceMessage {
                        ...
                        message_type: EfficiencyCodeWorkspaceMessageType::Unknown,
