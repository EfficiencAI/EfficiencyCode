...
const KNOWN_ORIGINATOR_TAG_VALUES: &[&str] = &[
    "EfficiencyCode_desktop",
    "EfficiencyCode-app-server",
    "EfficiencyCode_mcp_server",
    "EfficiencyCode_cli_rs",
    "EfficiencyCode-tui",
    "EfficiencyCode_vscode",
    "none",
    "EfficiencyCode_exec",
    "EfficiencyCode-cli",
    "EfficiencyCode_sdk_ts",
    "EfficiencyCode-app-server-sdk",
];
...
mod tests {
    ...
    fn session_metric_tags_include_expected_tags_in_order() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                (ORIGINATOR_TAG, "EfficiencyCode_cli"),
    ...
    fn session_metric_tags_skip_missing_optional_tags() {
        let tags = SessionMetricTagValues {
            auth_mode: None,
            session_source: "exec",
            originator: "EfficiencyCode_exec",
            service_name: None,
            model: "gpt-5.1",
            app_version: "1.2.3",
        }
        ...
        assert_eq!(
            ...
            vec![
                ...
                (ORIGINATOR_TAG, "EfficiencyCode_exec"),
                (MODEL_TAG, "gpt-5.1"),
                (APP_VERSION_TAG, "1.2.3"),
            ]
        );
