pub(crate) const OTEL_TARGET_PREFIX: &str = "EfficiencyCode_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "EfficiencyCode_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "EfficiencyCode_otel.trace_safe";
