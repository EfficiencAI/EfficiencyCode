...
pub struct AuthEnvTelemetryMetadata {
    ...
    pub EfficiencyCode_api_key_env_present: bool,
    pub EfficiencyCode_api_key_env_enabled: bool,
...
impl SessionTelemetry {
    ...
    pub fn record_startup_phase(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "EfficiencyCode.startup_phase",
                startup.phase = phase,
    ...
    pub fn record_turn_ttft(&self, duration: Duration) {
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "EfficiencyCode.turn_ttft",
                duration_ms = %duration.as_millis(),
            },
            log: {},
            trace: {},
    ...
    pub fn record_plugin_install_elicitation_sent(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "EfficiencyCode.plugin_install_elicitation_sent",
    ...
    pub fn record_plugin_install_suggestion(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "EfficiencyCode.plugin_install_suggestion",
                plugin_install.tool_type = tool_type,
                plugin_install.tool_id = tool_id,
                plugin_install.tool_name = tool_name,
    ...
    pub fn record_responses(&self, handle_responses_span: &Span, event: &ResponseEvent) {
        ...
        match event {
            ...
            ResponseEvent::Completed {
                ...
                handle_responses_span.record(
                    "EfficiencyCode.usage.reasoning_output_tokens",
                    token_usage.reasoning_output_tokens,
                );
                handle_responses_span.record(
                    "EfficiencyCode.usage.total_tokens",
    ...
    pub fn conversation_starts(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "EfficiencyCode.conversation_starts",
                provider_name = %provider_name,
                auth.env_openai_api_key_present = self.metadata.auth_env.openai_api_key_env_present,
                auth.env_EfficiencyCode_api_key_present = self.metadata.auth_env.EfficiencyCode_api_key_env_present,
                auth.env_EfficiencyCode_api_key_enabled = self.metadata.auth_env.EfficiencyCode_api_key_env_enabled,
    ...
    pub fn record_websocket_connect(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "EfficiencyCode.websocket_connect",
                duration_ms = %duration.as_millis(),
                http.response.status_code = status,
                success = success_str,
                error.message = error,
    ...
    pub fn record_websocket_request(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "EfficiencyCode.websocket_request",
                duration_ms = %duration.as_millis(),
                success = success_str,
                error.message = error,
                auth.env_openai_api_key_present = self.metadata.auth_env.openai_api_key_env_present,
    ...
    pub fn record_auth_recovery(
        ...
        log_and_trace_event!(
            self,
            common: {
                event.name = "EfficiencyCode.auth_recovery",
                auth.mode = mode,
                auth.step = step,
    ...
    fn sse_event(&self, kind: &str, duration: Duration) {
        ...
        log_event!(
            self,
            event.name = "EfficiencyCode.sse_event",
            event.kind = %kind,
            duration_ms = %duration.as_millis(),
        );
    }
    ...
    pub fn user_prompt(&self, items: &[UserInput]) {
        ...
        log_event!(
            self,
            event.name = "EfficiencyCode.user_prompt",
    ...
    pub fn tool_decision(
        ...
        log_event!(
            self,
            event.name = "EfficiencyCode.tool_decision",
            tool_name = %tool_name,
            call_id = %call_id,
    ...
    pub fn sandbox_outcome(
        ...
        log_event!(
            self,
            event.name = "EfficiencyCode.sandbox_outcome",
            tool_name = %tool_name,
            call_id = %call_id,
            outcome = %outcome,
    ...
    pub fn log_tool_failed(&self, tool_name: &str, error: &str) {
        log_event!(
            self,
            event.name = "EfficiencyCode.tool_result",
            tool_name = %tool_name,
