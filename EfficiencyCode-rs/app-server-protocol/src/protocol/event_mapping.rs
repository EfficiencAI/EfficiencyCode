    ...
    match msg {
        ...
        EventMsg::CollabAgentSpawnEnd(end_event) => {
            ...
            let status = match &end_event.status {
                EfficiencyCode_protocol::protocol::AgentStatus::Errored(_)
                | EfficiencyCode_protocol::protocol::AgentStatus::NotFound => {
        ...
        EventMsg::AgentMessageContentDelta(event) => {
            let EfficiencyCode_protocol::protocol::AgentMessageContentDeltaEvent {
                item_id,
                delta,
                ..
            } = event;
...
mod tests {
    ...
    use EfficiencyCode_protocol::protocol::CollabResumeBeginEvent;
    use EfficiencyCode_protocol::protocol::CollabResumeEndEvent;
    ...
    fn collab_resume_end_maps_to_item_completed_resume_agent() {
        let event = CollabResumeEndEvent {
            ...
            receiver_agent_nickname: None,
            receiver_agent_role: None,
            status: EfficiencyCode_protocol::protocol::AgentStatus::NotFound,
        };
