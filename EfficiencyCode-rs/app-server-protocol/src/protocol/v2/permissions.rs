...
use crate::TS;
use EfficiencyCode_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use EfficiencyCode_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use EfficiencyCode_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use EfficiencyCode_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use EfficiencyCode_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use EfficiencyCode_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use EfficiencyCode_protocol::models::LegacyReadWriteRoots;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> EfficiencyCode_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<EfficiencyCode_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: EfficiencyCode_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            EfficiencyCode_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            EfficiencyCode_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            EfficiencyCode_protocol::protocol::SandboxPolicy::ExternalSandbox {
                network_access,
