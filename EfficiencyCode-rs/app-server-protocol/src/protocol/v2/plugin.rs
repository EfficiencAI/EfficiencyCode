...
use crate::TS;
use EfficiencyCode_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use EfficiencyCode_protocol::protocol::SkillInterface as CoreSkillInterface;
use EfficiencyCode_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use EfficiencyCode_protocol::protocol::SkillScope as CoreSkillScope;
use EfficiencyCode_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
...
pub enum PluginAvailability {
    ...
    /// EfficiencyCode app-server exposes `"AVAILABLE"` in its API; the alias keeps
