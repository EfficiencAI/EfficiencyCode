...
use EfficiencyCode_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use EfficiencyCode_protocol::protocol::TokenUsage as CoreTokenUsage;
use EfficiencyCode_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "EfficiencyCode_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
    ...
    /// This is for internal use only (e.g. EfficiencyCode Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR EfficiencyCode CLOUD - DO NOT USE.
...
impl From<EfficiencyCode_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: EfficiencyCode_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> EfficiencyCode_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => EfficiencyCode_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => EfficiencyCode_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `EfficiencyCode_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
