...
use EfficiencyCode_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use EfficiencyCode_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use EfficiencyCode_protocol::user_input::ByteRange as CoreByteRange;
use EfficiencyCode_protocol::user_input::TextElement as CoreTextElement;
...
pub struct TurnStartParams {
    ...
    /// Optional metadata to enrich EfficiencyCode's ResponsesAPI turn metadata.
    ///
    /// Entries are flattened into the JSON string sent as
    /// `client_metadata["x-EfficiencyCode-turn-metadata"]` on ResponsesAPI HTTP and websocket requests.
    ///
