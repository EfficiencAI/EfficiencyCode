use super::EfficiencyCodeErrorInfo;
...
use EfficiencyCode_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use EfficiencyCode_protocol::protocol::ThreadHistoryMode as CoreThreadHistoryMode;
...
#[ts(export_to = "v2/")]
pub struct Thread {
    /// Identifier for this thread. EfficiencyCode-generated thread IDs are UUIDv7.
    pub id: String,
    ...
    /// Origin of the thread (CLI, VSCode, EfficiencyCode exec, EfficiencyCode app-server, etc.).
...
#[ts(export_to = "v2/")]
pub struct Turn {
    /// Identifier for this turn. EfficiencyCode-generated turn IDs are UUIDv7.
    pub id: String,
