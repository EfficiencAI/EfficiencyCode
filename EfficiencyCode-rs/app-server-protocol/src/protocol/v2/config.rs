...
pub enum ConfigLayerSource {
    /// Default configuration supplied with the installed EfficiencyCode package.
    ...
    /// User config layer from $EfficiencyCode_HOME/config.toml. This layer is special
    ...
    /// Path to a .EfficiencyCode/ folder within a project. There could be multiple of
