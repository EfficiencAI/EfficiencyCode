...
use crate::TS;
use EfficiencyCode_protocol::protocol::HookEventName as CoreHookEventName;
use EfficiencyCode_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use EfficiencyCode_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use EfficiencyCode_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use EfficiencyCode_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use EfficiencyCode_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use EfficiencyCode_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use EfficiencyCode_protocol::protocol::HookScope as CoreHookScope;
use EfficiencyCode_protocol::protocol::HookSource as CoreHookSource;
use EfficiencyCode_protocol::protocol::HookTrustStatus as CoreHookTrustStatus;
