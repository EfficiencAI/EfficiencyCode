...
use EfficiencyCode_protocol::items::McpToolCallError as CoreMcpToolCallError;
use EfficiencyCode_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use EfficiencyCode_protocol::mcp::McpServerInfo;
use EfficiencyCode_protocol::mcp::Resource as McpResource;
pub use EfficiencyCode_protocol::mcp::ResourceContent as McpResourceContent;
use EfficiencyCode_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use EfficiencyCode_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from EfficiencyCode_protocol::protocol::McpAuthStatus {
        Unknown,
        Unsupported,
        NotLoggedIn,
        BearerToken,
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from EfficiencyCode_protocol::protocol::McpStartupFailureReason {
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> EfficiencyCode_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => EfficiencyCode_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => EfficiencyCode_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => EfficiencyCode_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active EfficiencyCode turn when this elicitation was observed, if app-server could correlate one.
    ///
