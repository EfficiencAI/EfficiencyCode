...
use EfficiencyCode_experimental_api_macros::ExperimentalApi;
use EfficiencyCode_extension_items::ExtensionItem;
pub use EfficiencyCode_extension_items::image_generation::ImageGenerationFailure;
pub use EfficiencyCode_extension_items::image_generation::ImageGenerationItem;
pub use EfficiencyCode_extension_items::sleep::SleepItem;
pub use EfficiencyCode_extension_items::web_search::WebSearchAction;
pub use EfficiencyCode_extension_items::web_search::WebSearchItem;
use EfficiencyCode_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use EfficiencyCode_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use EfficiencyCode_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
...
use EfficiencyCode_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
use EfficiencyCode_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use EfficiencyCode_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use EfficiencyCode_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use EfficiencyCode_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
pub(crate) fn web_search_action_from_core(
    value: EfficiencyCode_protocol::models::WebSearchAction,
) -> WebSearchAction {
    match value {
        EfficiencyCode_protocol::models::WebSearchAction::Search { query, queries } => {
            WebSearchAction::Search { query, queries }
        }
        EfficiencyCode_protocol::models::WebSearchAction::OpenPage { url } => {
            WebSearchAction::OpenPage { url }
        }
        EfficiencyCode_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
            WebSearchAction::FindInPage { url, pattern }
        }
        EfficiencyCode_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
    }
}
...
impl From<EfficiencyCode_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: EfficiencyCode_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<EfficiencyCode_protocol::dynamic_tools::DynamicToolCallOutputContentItem>
    for DynamicToolCallOutputContentItem
{
    fn from(
        item: EfficiencyCode_protocol::dynamic_tools::DynamicToolCallOutputContentItem,
    ) -> Self {
        match item {
...
impl From<DynamicToolCallOutputContentItem>
    for EfficiencyCode_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
