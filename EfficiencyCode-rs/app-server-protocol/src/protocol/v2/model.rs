...
use EfficiencyCode_protocol::openai_models::ModelAvailabilityNux as CoreModelAvailabilityNux;
...
use EfficiencyCode_protocol::protocol::ModelRerouteReason as CoreModelRerouteReason;
use EfficiencyCode_protocol::protocol::ModelVerification as CoreModelVerification;
use EfficiencyCode_protocol::protocol::MultiAgentVersion as CoreMultiAgentVersion;
