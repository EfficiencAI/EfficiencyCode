...
use EfficiencyCode_protocol::config_types::ApprovalsReviewer as CoreApprovalsReviewer;
use EfficiencyCode_protocol::config_types::SandboxMode as CoreSandboxMode;
...
use EfficiencyCode_protocol::protocol::NonSteerableTurnKind as CoreNonSteerableTurnKind;
#[cfg(test)]
...
/// This translation layer make sure that we expose EfficiencyCode error code in camel case.
///
/// When an upstream HTTP status is available (for example, from the Responses API or a provider),
/// it is forwarded in `httpStatusCode` on the relevant `EfficiencyCodeErrorInfo` variant.
...
impl From<CoreEfficiencyCodeErrorInfo> for EfficiencyCodeErrorInfo {
    fn from(value: CoreEfficiencyCodeErrorInfo) -> Self {
        match value {
            CoreEfficiencyCodeErrorInfo::ContextWindowExceeded => {
                EfficiencyCodeErrorInfo::ContextWindowExceeded
            }
            CoreEfficiencyCodeErrorInfo::SessionBudgetExceeded => {
                EfficiencyCodeErrorInfo::SessionBudgetExceeded
            }
            CoreEfficiencyCodeErrorInfo::UsageLimitExceeded => {
                EfficiencyCodeErrorInfo::UsageLimitExceeded
            }
            CoreEfficiencyCodeErrorInfo::ServerOverloaded => {
                EfficiencyCodeErrorInfo::ServerOverloaded
            }
            CoreEfficiencyCodeErrorInfo::CyberPolicy => EfficiencyCodeErrorInfo::CyberPolicy,
            CoreEfficiencyCodeErrorInfo::HttpConnectionFailed { http_status_code } => {
                EfficiencyCodeErrorInfo::HttpConnectionFailed { http_status_code }
            }
            CoreEfficiencyCodeErrorInfo::ResponseStreamConnectionFailed { http_status_code } => {
                EfficiencyCodeErrorInfo::ResponseStreamConnectionFailed { http_status_code }
            }
            CoreEfficiencyCodeErrorInfo::InternalServerError => {
                EfficiencyCodeErrorInfo::InternalServerError
            }
            CoreEfficiencyCodeErrorInfo::Unauthorized => EfficiencyCodeErrorInfo::Unauthorized,
            CoreEfficiencyCodeErrorInfo::BadRequest => EfficiencyCodeErrorInfo::BadRequest,
            CoreEfficiencyCodeErrorInfo::ThreadRollbackFailed => {
                EfficiencyCodeErrorInfo::ThreadRollbackFailed
            }
            CoreEfficiencyCodeErrorInfo::SandboxError => EfficiencyCodeErrorInfo::SandboxError,
            CoreEfficiencyCodeErrorInfo::ResponseStreamDisconnected { http_status_code } => {
                EfficiencyCodeErrorInfo::ResponseStreamDisconnected { http_status_code }
            }
            CoreEfficiencyCodeErrorInfo::ResponseTooManyFailedAttempts { http_status_code } => {
                EfficiencyCodeErrorInfo::ResponseTooManyFailedAttempts { http_status_code }
            }
            CoreEfficiencyCodeErrorInfo::ActiveTurnNotSteerable { turn_kind } => {
                EfficiencyCodeErrorInfo::ActiveTurnNotSteerable {
                    turn_kind: turn_kind.into(),
                }
            }
            CoreEfficiencyCodeErrorInfo::Other => EfficiencyCodeErrorInfo::Other,
        }
    }
}
