...
pub enum AuthMode {
    /// OpenAI API key provided by the caller and stored by EfficiencyCode.
    ApiKey,
    /// ChatGPT OAuth managed by EfficiencyCode (tokens persisted and refreshed by EfficiencyCode).
    Chatgpt,
    ...
    Headers,
    /// Programmatic EfficiencyCode auth backed by a registered Agent Identity.
    #[serde(rename = "agentIdentity")]
    #[ts(rename = "agentIdentity")]
    #[strum(serialize = "agentIdentity")]
    AgentIdentity,
    /// Programmatic EfficiencyCode auth backed by a personal access token.
    #[serde(rename = "personalAccessToken")]
    #[ts(rename = "personalAccessToken")]
    #[strum(serialize = "personalAccessToken")]
    PersonalAccessToken,
    /// Amazon Bedrock bearer token managed by EfficiencyCode.
...
impl AuthMode {
    ...
    /// Returns whether this mode is backed by EfficiencyCode services rather than a direct model API.
...
client_request_definitions! {
    ...
    /// Spawn a standalone process (argv vector) without a EfficiencyCode sandbox.
...
/// Superset of [`EfficiencyCode_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by EfficiencyCode Cloud.
...
mod tests {
    ...
    fn jsonrpc_request_conversion_preserves_serde_enum_decoding() {
        let requests = [
            JSONRPCRequest {
                ...
                trace: Some(EfficiencyCode_protocol::protocol::W3cTraceContext {
    ...
    fn serialize_initialize_capabilities() -> Result<()> {
        let request = ClientRequest::Initialize {
            ...
            params: v1::InitializeParams {
                client_info: v1::ClientInfo {
                    name: "EfficiencyCode_vscode".to_string(),
    ...
    fn serialize_mcp_server_elicitation_request() -> Result<()> {
        ...
        let params = v2::McpServerElicitationRequestParams {
            ...
            server_name: "EfficiencyCode_apps".to_string(),
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    "threadId": "thr_123",
                    "turnId": "turn_123",
                    "serverName": "EfficiencyCode_apps",
                    "mode": "form",
                    "_meta": null,
        ...
        let response = ClientResponse::ThreadStart {
            ...
            response: v2::ThreadStartResponse {
                ...
                instruction_sources: vec![
                    EfficiencyCode_utils_path_uri::LegacyAppPathString::from_abs_path(
    ...
    fn serialize_account_login_chatgpt_streamlined() -> Result<()> {
        let request = ClientRequest::LoginAccount {
            ...
            params: v2::LoginAccountParams::Chatgpt {
                app_brand: None,
                EfficiencyCode_streamlined_login: true,
                use_hosted_login_success_page: false,
            },
        };
        assert_eq!(
    ...
    fn account_serializes_fields_in_camel_case() -> Result<()> {
        ...
        let EfficiencyCode_managed_bedrock = v2::Account::AmazonBedrock {
            uses_EfficiencyCode_managed_credentials: true,
        };
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesEfficiencyCodeManagedCredentials": true,
            }),
            serde_json::to_value(&EfficiencyCode_managed_bedrock)?,
        );
        ...
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesEfficiencyCodeManagedCredentials": false,
            }),
    ...
    fn serialize_thread_realtime_start() -> Result<()> {
        let request = ClientRequest::ThreadRealtimeStart {
            ...
            params: v2::ThreadRealtimeStartParams {
                ...
                EfficiencyCode_response_handoff_mode: Some(
                    EfficiencyCodeResponseHandoffMode::BemTags,
                ),
                EfficiencyCode_response_handoff_channel_prefixes: Some(
    ...
    fn serialize_thread_realtime_start_prompt_default_and_null() -> Result<()> {
        ...
        let default_prompt_value = json!({
            ...
            "params": {
                ...
                "EfficiencyCodeResponseHandoffPrefix": "",
                "outputModality": "audio",
                "realtimeSessionId": null,
                "transport": null,
                "voice": null
        ...
        let notification =
            ServerNotification::ThreadSettingsUpdated(v2::ThreadSettingsUpdatedNotification {
                ...
                thread_settings: v2::ThreadSettings {
                    ...
                    effort: None,
                    summary: None,
                    collaboration_mode: EfficiencyCode_protocol::config_types::CollaborationMode {
