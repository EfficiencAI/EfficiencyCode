...
const RESOURCE_URI: &str = "memo://EfficiencyCode/example-note";
...
fn init_params() -> InitializeRequestParams {
    ...
    InitializeRequestParams::new(
        ...
        Implementation::new("EfficiencyCode-test", "0.0.0-test")
            .with_title("EfficiencyCode rmcp resource test"),
    )
...
async fn rmcp_client_can_list_and_read_resources() -> anyhow::Result<()> {
    ...
    let mut expected_templates = ListResourceTemplatesResult::with_all_items(vec![
        rmcp::model::ResourceTemplate::new("memo://EfficiencyCode/{slug}", "EfficiencyCode-memo")
