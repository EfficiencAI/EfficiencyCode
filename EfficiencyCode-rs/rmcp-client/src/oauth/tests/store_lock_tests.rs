...
use crate::oauth::test_support::TempEfficiencyCodeHome;
...
const LOCK_HOLDER_READY_PATH_ENV: &str = "EfficiencyCode_OAUTH_STORE_LOCK_CHILD_READY_PATH";
...
fn store_lock_is_released_when_holder_process_exits() -> Result<()> {
    ...
    let mut child = Command::new(std::env::current_exe()?)
        ...
        .arg("--ignored")
        .env("EfficiencyCode_HOME", env.path())
