...
use super::TempEfficiencyCodeHome;
...
const REFRESH_LOCK_CONTENTION_EVENT_TARGET: &str =
    "EfficiencyCode_rmcp_client::oauth::refresh_lock::contention";
...
async fn test_context() -> Result<(TempEfficiencyCodeHome, MockServer, StoredOAuthTokens)> {
