...
impl RmcpClient {
    ...
    pub async fn new_stdio_client_with_protocol_mode(
        ...
        let requested_stdio_version = match protocol_mode {
            ...
            McpProtocolMode::V20260728 => env
                .as_mut()
                .and_then(|env| env.remove(OsStr::new("EfficiencyCode_MCP_PROTOCOL_VERSION"))),
        };
    ...
    async fn connect_pending_transport(
        ...
        // Preserve EfficiencyCode's existing snapshot and request-freshness behavior. rmcp 3
