...
3. When the current documentation supports it, the local EfficiencyCode CLI setup is:

   ```sh
   EfficiencyCode mcp add openaiDeveloperDocs --url https://developers.openai.com/mcp
   ```
