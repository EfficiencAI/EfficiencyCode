#!/usr/bin/env python3
"""Rewrite a local plugin version to a single EfficiencyCode cachebuster suffix."""
...
CACHEBUSTER_PREFIX = "EfficiencyCode"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "a single +EfficiencyCode.<cachebuster> suffix."
        )
    )
