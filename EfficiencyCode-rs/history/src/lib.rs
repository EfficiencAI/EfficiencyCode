...
pub struct ResponseItemEnvelope {
    ...
    pub metadata: Option<EfficiencyCodeHarnessMetadata>,
}

/// Metadata owned by the EfficiencyCode harness and persisted with a response item.
///
...
pub struct EfficiencyCodeHarnessMetadata {}
