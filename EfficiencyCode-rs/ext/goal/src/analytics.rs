...
use EfficiencyCode_analytics::EfficiencyCodeGoalEvent;
use EfficiencyCode_analytics::GoalEventKind;
...
impl GoalAnalytics {
    ...
    pub(crate) fn cleared(&self, goal: &EfficiencyCode_state::ThreadGoal) {
    ...
    fn track(
        ...
        self.client.track_goal_event(EfficiencyCodeGoalEvent {
