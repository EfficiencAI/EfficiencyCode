use EfficiencyCode_connectors_extension::ExecutorPluginConnectorProvider;
use EfficiencyCode_core::config::Config;
use EfficiencyCode_core_plugins::ExecutorPluginProvider;
...
struct SelectedPluginMetadata {
    ...
    servers: Vec<(String, EfficiencyCode_config::McpServerConfig)>,
