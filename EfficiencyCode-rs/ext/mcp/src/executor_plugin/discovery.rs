...
use EfficiencyCode_core_plugins::manifest::parse_plugin_manifest_uri;
use EfficiencyCode_exec_server::CapabilityRootDiscovery;
use EfficiencyCode_mcp::parse_executor_plugin_mcp_config;
...
fn parse_mcp_servers(
    selected_root: &SelectedCapabilityRoot,
    plugin_root: &EfficiencyCode_utils_path_uri::PathUri,
    contents: &str,
    environment_id: &str,
) -> Vec<(String, EfficiencyCode_config::McpServerConfig)> {
