...
use EfficiencyCode_extension_api::ApprovalReviewContributor;
use EfficiencyCode_extension_api::ConfigContributor;
use EfficiencyCode_extension_api::ContextContributor;
use EfficiencyCode_extension_api::ContextualUserFragment;
...
use EfficiencyCode_extension_api::SkillInvocationContributor;
...
use EfficiencyCode_extension_api::TurnInputContributor;
use EfficiencyCode_extension_api::TurnItemContributor;
use EfficiencyCode_extension_api::TurnLifecycleContributor;
use EfficiencyCode_extension_api::empty_extension_registry;
use EfficiencyCode_protocol::items::HookPromptItem;
        ...
        fragments.extend(
            contributor
                .contribute_turn_context(TurnContextContributionInput {
                    thread_id: EfficiencyCode_protocol::ThreadId::default(),
