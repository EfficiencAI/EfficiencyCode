use EfficiencyCode_api::SearchInput;
...
use EfficiencyCode_tools::retain_tail_from_last_n_user_messages;
use EfficiencyCode_tools::truncate_assistant_output_text_to_token_budget;
