...
/// Contributes EfficiencyCode memory read-path prompt context and memory read tools.
...
pub(crate) struct MemoriesExtensionConfig {
    ...
    pub(crate) EfficiencyCode_home: AbsolutePathBuf,
}
...
impl ContextContributor for MemoriesExtension {
    fn contribute_thread_context<'a>(
        ...
        Box::pin(async move {
            ...
            build_memory_tool_developer_instructions(&config.EfficiencyCode_home)
                .await
...
impl ToolContributor for MemoriesExtension {
    ...
    > {
        ...
        tools::memory_tools(
            LocalMemoriesBackend::from_EfficiencyCode_home(&config.EfficiencyCode_home),
