...
use EfficiencyCode_config::bundled_skills_enabled_from_stack;
...
use EfficiencyCode_skills::install_system_skills;
...
impl HostSkillsService {
    pub fn new(EfficiencyCode_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
    ...
    pub fn new_with_restriction_product(
        ...
        // The cache is shared by every process using this EfficiencyCode_HOME. Disabled services filter
    ...
    fn ensure_system_skills_installed(&self) {
        if let Err(err) = install_system_skills(&self.EfficiencyCode_home) {
