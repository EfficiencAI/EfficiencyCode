use EfficiencyCode_collaboration_mode_templates::DEFAULT as COLLABORATION_MODE_DEFAULT;
use EfficiencyCode_collaboration_mode_templates::PLAN as COLLABORATION_MODE_PLAN;
use EfficiencyCode_protocol::config_types::CollaborationModeMask;
use EfficiencyCode_protocol::config_types::ModeKind;
use EfficiencyCode_protocol::config_types::TUI_VISIBLE_COLLABORATION_MODES;
