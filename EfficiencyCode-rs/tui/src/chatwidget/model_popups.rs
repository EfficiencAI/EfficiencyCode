...
impl ChatWidget {
    ...
    fn auto_model_order(model: &str) -> usize {
        match model {
            "EfficiencyCode-auto-fast" => 0,
            "EfficiencyCode-auto-balanced" => 1,
            "EfficiencyCode-auto-thorough" => 2,
            _ => 3,
        }
    }
    ...
    pub(crate) fn open_all_models_popup(&mut self, presets: Vec<ModelPreset>) {
        ...
        let header = self.model_menu_header(
            ...
            "Access legacy models by running EfficiencyCode -m <model_name> or in your config.toml",
        );
        self.bottom_pane.show_selection_view(SelectionViewParams {
    ...
    pub(crate) fn open_reasoning_popup(&mut self, preset: ModelPreset) {
        ...
        let warn_for_model = preset.model.starts_with("gpt-5.1-EfficiencyCode")
            || preset.model.starts_with("gpt-5.1-EfficiencyCode-max")
