...
async fn custom_prompt_submit_sends_review_op() {
    ...
    // Expect AppEvent::EfficiencyCodeOp(Op::Review { .. }) with trimmed prompt
    let evt = rx.try_recv().expect("expected one app event");
    match evt {
        AppEvent::EfficiencyCodeOp(Op::Review { target }) => {
            assert_eq!(
                target,
                ReviewTarget::Custom {
...
async fn custom_prompt_enter_empty_does_not_send() {
    ...
    // No AppEvent::EfficiencyCodeOp should be sent
...
async fn interrupted_turn_after_goal_budget_limited_uses_budget_message_snapshot() {
    ...
    chat.handle_server_notification(
        EfficiencyCode_app_server_protocol::ServerNotification::TurnStarted(
            EfficiencyCode_app_server_protocol::TurnStartedNotification {
                thread_id: "thread-1".to_string(),
                turn: EfficiencyCode_app_server_protocol::Turn {
                    id: "turn-1".to_string(),
                    items_view: EfficiencyCode_app_server_protocol::TurnItemsView::Full,
                    items: Vec::new(),
                    status: EfficiencyCode_app_server_protocol::TurnStatus::InProgress,
                    error: None,
                    started_at: None,
                    completed_at: None,
                    duration_ms: None,
    ...
    chat.handle_server_notification(
        EfficiencyCode_app_server_protocol::ServerNotification::ThreadGoalUpdated(
            EfficiencyCode_app_server_protocol::ThreadGoalUpdatedNotification {
                ...
                goal: EfficiencyCode_app_server_protocol::ThreadGoal {
                    ...
                    status: EfficiencyCode_app_server_protocol::ThreadGoalStatus::BudgetLimited,
        ...
        EfficiencyCode_app_server_protocol::ServerNotification::TurnCompleted(
            EfficiencyCode_app_server_protocol::TurnCompletedNotification {
                ...
                turn: EfficiencyCode_app_server_protocol::Turn {
                    ...
                    items_view: EfficiencyCode_app_server_protocol::TurnItemsView::Full,
                    items: Vec::new(),
                    status: EfficiencyCode_app_server_protocol::TurnStatus::Interrupted,
                    error: None,
                    started_at: None,
                    completed_at: None,
                    duration_ms: None,
