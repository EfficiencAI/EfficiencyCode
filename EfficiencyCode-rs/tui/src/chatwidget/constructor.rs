...
impl ChatWidget {
    pub(crate) fn new_with_app_event(common: ChatWidgetInit) -> Self {
        Self::new_with_op_target(common, EfficiencyCodeOpTarget::AppEvent)
    }
    ...
    pub(super) fn new_with_op_target(
        ...
        let pet_http_client = EfficiencyCode_http_client::RouteAwareClientPool::new(
            config.http_client_factory(),
            EfficiencyCode_http_client::ClientRouteClass::Other,
        );
        ...
        let mut widget = Self {
            ...
            EfficiencyCode_rate_limit_reached_type: None,
            EfficiencyCode_spend_control_reached: None,
        ...
        widget
            .bottom_pane
            .set_token_activity_command_enabled(widget.has_EfficiencyCode_backend_auth);
