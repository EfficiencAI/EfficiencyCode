...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: EfficiencyCode_app_server_protocol::GuardianApprovalReview,
        completion: Option<(
            i64,
            EfficiencyCode_app_server_protocol::AutoReviewDecisionSource,
        )>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                EfficiencyCode_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                EfficiencyCode_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                EfficiencyCode_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                EfficiencyCode_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                EfficiencyCode_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                EfficiencyCode_app_server_protocol::GuardianRiskLevel::Low => {
                    EfficiencyCode_protocol::approvals::GuardianRiskLevel::Low
                }
                EfficiencyCode_app_server_protocol::GuardianRiskLevel::Medium => {
                    EfficiencyCode_protocol::approvals::GuardianRiskLevel::Medium
                }
                EfficiencyCode_app_server_protocol::GuardianRiskLevel::High => {
                    EfficiencyCode_protocol::approvals::GuardianRiskLevel::High
                }
                EfficiencyCode_app_server_protocol::GuardianRiskLevel::Critical => {
                    EfficiencyCode_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    EfficiencyCode_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        EfficiencyCode_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    EfficiencyCode_app_server_protocol::GuardianUserAuthorization::Low => {
                        EfficiencyCode_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    EfficiencyCode_app_server_protocol::GuardianUserAuthorization::Medium => {
                        EfficiencyCode_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    EfficiencyCode_app_server_protocol::GuardianUserAuthorization::High => {
                        EfficiencyCode_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                EfficiencyCode_app_server_protocol::AutoReviewDecisionSource::Agent => {
