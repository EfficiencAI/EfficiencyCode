...
use EfficiencyCode_app_server_protocol::AuthMode as ApiAuthMode;
...
fn onboarding_request_id() -> EfficiencyCode_app_server_protocol::RequestId {
    EfficiencyCode_app_server_protocol::RequestId::String(Uuid::new_v4().to_string())
}
...
pub(super) async fn cancel_login_attempt(
    ...
    let _ = request_handle
        .request_typed::<EfficiencyCode_app_server_protocol::CancelLoginAccountResponse>(
...
impl AuthModeWidget {
    ...
    fn render_pick_mode(&self, area: Rect, buf: &mut Buffer) {
        let mut lines: Vec<Line> = vec![
            Line::from(vec![
                "  ".into(),
                "Sign in with ChatGPT to use EfficiencyCode as part of your paid plan".into(),
            ]),
            Line::from(vec![
                "  ".into(),
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        ...
        docs_line.push_span(
            "EfficiencyCode docs".underlined(),
            Some("https://developers.openai.com/EfficiencyCode/security"),
        );
        ...
        let lines = vec![
            ...
            "".into(),
            "  Decide how much autonomy you want to grant EfficiencyCode".into(),
            docs_line,
            "".into(),
            "  EfficiencyCode can make mistakes".into(),
            HyperlinkLine::new(
    ...
    fn render_api_key_configured(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  EfficiencyCode will use usage-based billing with your API key.".into(),
        ];
...
mod tests {
    ...
    const PRODUCTION_LENGTH_AUTH_URL: &str = concat!(
        ...
        "EfficiencyCode_cli_simplified_flow=true&",
        "state=8cHjQ4nVx2Yp7Lm9Rk3Wf6Ta1Bs5Du0Ei4Go7Nz2PqM&",
        "originator=EfficiencyCode_cli_rs"
    );
    ...
    async fn widget_forced_chatgpt() -> (AuthModeWidget, TempDir) {
        ...
        let config = ConfigBuilder::default()
            .EfficiencyCode_home(EfficiencyCode_home_path.clone())
            .build()
            .await
            .unwrap();
        ...
        let client = InProcessAppServerClient::start(InProcessClientStartArgs {
            ...
            environment_manager: Arc::new(
                EfficiencyCode_app_server_client::EnvironmentManager::default_for_tests(),
            ),
    ...
    fn chatgpt_success_message_renders_osc8_hyperlinks() {
        ...
        assert_eq!(
            collect_osc8_chars(
                &buf,
                area,
                "https://developers.openai.com/EfficiencyCode/security"
            ),
            "EfficiencyCode docs"
        );
        assert_eq!(
        ...
        ✓ Signed in with your ChatGPT account
          ...
          Decide how much autonomy you want to grant EfficiencyCode
          For more details see the EfficiencyCode docs

          EfficiencyCode can make mistakes
          Review the code it writes and commands it runs
