...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: EfficiencyCode_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<EfficiencyCode_protocol::openai_models::ReasoningEffort>,
