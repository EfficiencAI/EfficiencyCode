...
//! the fallback bucket.
//!
//! These caps are deliberately conservative: EfficiencyCode is rebuilding normal terminal scrollback, not an
...
use EfficiencyCode_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;
