...
mod tests {
    ...
    use EfficiencyCode_app_server_protocol::McpElicitationObjectType;
    use EfficiencyCode_app_server_protocol::McpElicitationSchema;
    ...
    use EfficiencyCode_app_server_protocol::PermissionGrantScope;
    use EfficiencyCode_app_server_protocol::PermissionsRequestApprovalParams;
    use EfficiencyCode_app_server_protocol::PermissionsRequestApprovalResponse;
    use EfficiencyCode_app_server_protocol::RequestId as AppServerRequestId;
    use EfficiencyCode_app_server_protocol::ServerRequest;
    use EfficiencyCode_app_server_protocol::ToolRequestUserInputAnswer;
    ...
    fn rejects_permissions_with_paths_that_cannot_be_localized() {
        ...
        let permissions = EfficiencyCode_app_server_protocol::RequestPermissionProfile {
            network: None,
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: EfficiencyCode_protocol::request_permissions::RequestPermissionsResponse {
                    ...
                    scope: EfficiencyCode_protocol::request_permissions::PermissionGrantScope::Session,
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: EfficiencyCode_app_server_protocol::GrantedPermissionProfile {
                    ...
                    file_system: Some(AdditionalFileSystemPermissions {
                        ...
                        glob_scan_max_depth: None,
                        entries: Some(vec![
                            EfficiencyCode_app_server_protocol::FileSystemSandboxEntry {
                                path: EfficiencyCode_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(read_path).into(),
                                },
                                access:
                                    EfficiencyCode_app_server_protocol::FileSystemAccessMode::Read,
                            },
                            EfficiencyCode_app_server_protocol::FileSystemSandboxEntry {
                                path: EfficiencyCode_app_server_protocol::FileSystemPath::Path {
                                ...
                                access:
                                    EfficiencyCode_app_server_protocol::FileSystemAccessMode::Write,
                            },
                        ]),
                    }),
                },
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: EfficiencyCode_app_server_protocol::ChatgptAuthTokensRefreshParams {
                    reason: EfficiencyCode_app_server_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
