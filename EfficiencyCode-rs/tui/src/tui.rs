...
/// Restore the terminal after EfficiencyCode is exiting.
///
...
impl Tui {
    pub(crate) fn new(
        ...
        let is_zellij = EfficiencyCode_terminal_detection::terminal_info().is_zellij();
    ...
    /// terminal modes and stderr while keeping raw mode enabled, then re-applies EfficiencyCode TUI modes
