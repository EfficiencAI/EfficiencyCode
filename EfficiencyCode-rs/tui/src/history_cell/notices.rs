...
impl HistoryCell for UpdateAvailableHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            line![
                "See ",
                "https://github.com/openai/EfficiencyCode"
                    .cyan()
                    .underlined(),
        ...
        let content = text![
            line![
                ...
                " ",
                format!("{EfficiencyCode_CLI_VERSION} -> {}", self.latest_version).bold(),
            ],
            update_instruction,
            "",
            "See full release notes:",
            "https://github.com/openai/EfficiencyCode/releases/latest"
                .cyan()
                .underlined(),
        ];
    ...
    fn raw_lines(&self) -> Vec<Line<'static>> {
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            "See https://github.com/openai/EfficiencyCode for installation options.".to_string()
        };
        vec![
            ...
            Line::from("https://github.com/openai/EfficiencyCode/releases/latest"),
        ]
    }
