...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for EfficiencyCode",
            ...
            SlashCommand::Quit | SlashCommand::Exit => "exit EfficiencyCode",
            ...
            SlashCommand::Skills => {
                "use skills to improve how EfficiencyCode performs specific tasks"
            }
            ...
            SlashCommand::Personality => "choose a communication style for EfficiencyCode",
            ...
            SlashCommand::Permissions => "choose what EfficiencyCode is allowed to do",
            ...
            SlashCommand::Logout => "log out of EfficiencyCode",
