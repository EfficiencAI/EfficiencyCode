...
pub fn paste_image_to_temp_png() -> Result<(PathBuf, PastedImageInfo), PasteImageError> {
    ...
    match paste_image_as_png() {
        Ok((png, info)) => {
            ...
            let tmp = Builder::new()
                .prefix("EfficiencyCode-clipboard-")
                .suffix(".png")
                .tempfile()
...
pub fn normalize_pasted_path(pasted: &str) -> Option<PathBuf> {
    ...
    // Possibly use typed-path: https://github.com/openai/EfficiencyCode/pull/2567/commits/3cc92b78e0a1f94e857cf4674d3a9db918ed352e
    //
