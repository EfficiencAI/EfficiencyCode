...
pub(crate) const PACKAGE_URL: &str = "https://registry.npmjs.org/@openai%2fEfficiencyCode";
    ...
    fn version_json(version: &str) -> serde_json::Value {
        serde_json::json!({
            "dist": {
                ...
                "tarball": format!("https://registry.npmjs.org/@openai/EfficiencyCode/-/EfficiencyCode-{version}.tgz"),
            }
        })
    }
