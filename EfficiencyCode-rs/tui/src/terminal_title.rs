...
//! "leave the old title alone" or "clear the title EfficiencyCode last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title EfficiencyCode manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before EfficiencyCode started managing the title.
