...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            StatusSurfacePreviewItem::AppName => "EfficiencyCode",
            ...
            StatusSurfacePreviewItem::EfficiencyCodeVersion => "0.0.0",
            ...
            StatusSurfacePreviewItem::Model => "gpt-5.2-EfficiencyCode",
            StatusSurfacePreviewItem::ModelWithReasoning => "gpt-5.2-EfficiencyCode medium",
