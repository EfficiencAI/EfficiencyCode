...
pub(crate) enum TerminalTitleItem {
    ...
    WeeklyLimit,
    /// EfficiencyCode application version.
    EfficiencyCodeVersion,
...
impl TerminalTitleItem {
    pub(crate) fn description(self) -> &'static str {
        match self {
            TerminalTitleItem::AppName => "EfficiencyCode app name",
            ...
            TerminalTitleItem::EfficiencyCodeVersion => "EfficiencyCode application version",
    ...
    pub(crate) fn preview_item(self) -> Option<StatusSurfacePreviewItem> {
        match self {
            ...
            TerminalTitleItem::EfficiencyCodeVersion => {
                Some(StatusSurfacePreviewItem::EfficiencyCodeVersion)
            }
