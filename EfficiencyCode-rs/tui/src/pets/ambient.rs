//! Ambient terminal rendering for the EfficiencyCode companion.
//!
...
impl AmbientPet {
    ...
    /// EfficiencyCode_HOME cache, and records the terminal protocol support snapshot used
    ...
    pub(crate) fn load(
        ...
        let cache_dir = EfficiencyCode_home
            .join("cache")
            .join("tui-pets")
            .join("frame-cache")
            .join(&pet.id)
...
mod tests {
    ...
    #[test]
    fn notification_labels_match_EfficiencyCode_app_vocabulary() {
