//! Built-in pet catalog ported from the EfficiencyCode App avatar catalog.
...
pub(super) const BUILTIN_PETS: &[BuiltinPet] = &[
    BuiltinPet {
        id: "EfficiencyCode",
        display_name: "EfficiencyCode",
        description: "The original EfficiencyCode companion",
        spritesheet_file: "EfficiencyCode-spritesheet-v4.webp",
    },
    BuiltinPet {
        id: "dewey",
        display_name: "Dewey",
