...
mod tests {
    ...
    use EfficiencyCode_protocol::protocol::TurnContextItem;
    use EfficiencyCode_protocol::protocol::USER_MESSAGE_BEGIN;
    use EfficiencyCode_protocol::protocol::UserMessageEvent;
        ...
        apply_rollout_item(
            ...
            &RolloutItem::SessionMeta(SessionMetaLine {
                meta: SessionMeta {
                    ...
                    originator: "EfficiencyCode_cli_rs".to_string(),
    ...
    fn thread_settings_applied_updates_resume_metadata() {
        ...
        assert_eq!(metadata.model.as_deref(), Some("gpt-5.2-EfficiencyCode"));
