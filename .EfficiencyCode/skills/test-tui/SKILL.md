---
name: test-tui
description: Guide for testing EfficiencyCode TUI interactively
---

You can start and use EfficiencyCode TUI to verify changes. 
...
Use `just EfficiencyCode` target to run - `just EfficiencyCode -c ...`
