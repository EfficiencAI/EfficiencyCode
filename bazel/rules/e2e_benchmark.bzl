...
_WORKSPACE_ROOT_MARKER = "//EfficiencyCode-rs/utils/cargo-bin:repo_root.marker"

def EfficiencyCode_e2e_benchmark(name, binaries = [], data = [], deps = []):
    ...
    workspace_root_test(
        ...
        visibility = ["//EfficiencyCode-rs:__pkg__"],
