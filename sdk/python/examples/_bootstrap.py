...
def ensure_local_sdk_src() -> Path:
    ...
    package_dir = src_dir / "openai_EfficiencyCode"
...
def runtime_config():
    """Return an example-friendly EfficiencyCodeConfig for repo-source SDK usage."""
...
def temporary_sample_image_path() -> Iterator[Path]:
    with tempfile.TemporaryDirectory(prefix="EfficiencyCode-python-example-image-") as temp_root:
