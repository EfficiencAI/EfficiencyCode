...
RUN_REAL_EfficiencyCode_TESTS = os.environ.get("RUN_REAL_EfficiencyCode_TESTS") == "1"
pytestmark = pytest.mark.skipif(
    not RUN_REAL_EfficiencyCode_TESTS,
    reason="set RUN_REAL_EfficiencyCode_TESTS=1 to run real EfficiencyCode integration coverage",
)
...
def runtime_env(tmp_path_factory: pytest.TempPathFactory) -> PreparedRuntimeEnv:
    ...
    env["EfficiencyCode_PYTHON_SDK_DIR"] = str(ROOT)
