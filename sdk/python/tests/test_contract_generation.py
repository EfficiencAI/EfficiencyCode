...
GENERATED_TARGETS = [
    Path("src/openai_EfficiencyCode/generated/notification_registry.py"),
    Path("src/openai_EfficiencyCode/generated/v2_all.py"),
    Path("src/openai_EfficiencyCode/api.py"),
]
...
def test_generated_files_are_up_to_date():
    ...
    assert importlib.metadata.version("openai-EfficiencyCode-cli-bin") == "0.144.4"
    env = os.environ.copy()
    env.pop("EfficiencyCode_EXEC_PATH", None)
