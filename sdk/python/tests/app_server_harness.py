...
from openai_EfficiencyCode import EfficiencyCodeConfig
...
class AppServerHarness:
    ...
    def __init__(self, tmp_path: Path, *, requires_openai_auth: bool = False) -> None:
        ...
        self.EfficiencyCode_home = tmp_path / "EfficiencyCode-home"
    ...
    def __enter__(self) -> AppServerHarness:
        self.EfficiencyCode_home.mkdir()
    ...
    def __exit__(self, _exc_type: object, _exc: object, _tb: object) -> None:
        ...
        shutil.rmtree(self.EfficiencyCode_home, ignore_errors=True)
        shutil.rmtree(self.workspace, ignore_errors=True)

    def app_server_config(self) -> EfficiencyCodeConfig:
        """Build SDK config for an isolated pinned-runtime app-server process."""
        return EfficiencyCodeConfig(
            cwd=str(self.workspace),
            env={
                "EfficiencyCode_HOME": str(self.EfficiencyCode_home),
                "EfficiencyCode_APP_SERVER_DISABLE_MANAGED_CONFIG": "1",
                "RUST_LOG": "warn",
            },
        )
    ...
    def _write_config(self) -> None:
        ...
        config_toml = self.EfficiencyCode_home / "config.toml"
