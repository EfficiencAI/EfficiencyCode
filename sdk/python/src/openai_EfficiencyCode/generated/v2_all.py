...
#   filename:  EfficiencyCode_app_server_protocol.v2.schemas.json
...
class EfficiencyCodeAppServerProtocolV2(BaseModel):
    pass
...
class AmazonBedrockCredentialSource(Enum):
    EfficiencyCode_managed = "EfficiencyCodeManaged"
...
class EfficiencyCodeErrorInfoValue(Enum):
...
class HttpConnectionFailedEfficiencyCodeErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamConnectionFailedEfficiencyCodeErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamDisconnectedEfficiencyCodeErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseTooManyFailedAttemptsEfficiencyCodeErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ProjectConfigLayerSource(BaseModel):
    ...
    dot_EfficiencyCode_folder: Annotated[AbsolutePathBuf, Field(alias="dotEfficiencyCodeFolder")]
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    chatgpt_plan_type: Annotated[
        ...
        Field(
            ...
            description="Optional plan type supplied by the client.\n\nWhen `null`, EfficiencyCode attempts to derive the plan type from access-token claims. If unavailable, the plan defaults to `unknown`.",
        ),
    ] = None
    type: Annotated[
...
class RateLimitResetType(Enum):
    EfficiencyCode_rate_limits = "EfficiencyCodeRateLimits"
    unknown = "unknown"
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `EfficiencyCode_protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ActiveTurnNotSteerableEfficiencyCodeErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class EfficiencyCodeErrorInfo(
    RootModel[
        EfficiencyCodeErrorInfoValue
        | HttpConnectionFailedEfficiencyCodeErrorInfo
        | ResponseStreamConnectionFailedEfficiencyCodeErrorInfo
        | ResponseStreamDisconnectedEfficiencyCodeErrorInfo
        | ResponseTooManyFailedAttemptsEfficiencyCodeErrorInfo
        | ActiveTurnNotSteerableEfficiencyCodeErrorInfo
    ]
):
    model_config = ConfigDict(
        populate_by_name=True,
...
class ChatgptLoginAccountParams(BaseModel):
    ...
    EfficiencyCode_streamlined_login: Annotated[bool | None, Field(alias="EfficiencyCodeStreamlinedLogin")] = None
...
class TurnError(BaseModel):
    ...
    EfficiencyCode_error_info: Annotated[EfficiencyCodeErrorInfo | None, Field(alias="EfficiencyCodeErrorInfo")] = None
    message: str
...
class GetAccountRateLimitsResponse(BaseModel):
    ...
    rate_limits_by_limit_id: Annotated[
        ...
        Field(
            ...
            description="Multi-bucket view keyed by metered `limit_id` (for example, `EfficiencyCode`).",
        ),
    ] = None
...
class Turn(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this turn. EfficiencyCode-generated turn IDs are UUIDv7.")
    ]
    items: Annotated[
...
class Thread(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this thread. EfficiencyCode-generated thread IDs are UUIDv7.")
    ]
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, EfficiencyCode exec, EfficiencyCode app-server, etc.)."
        ),
    ]
