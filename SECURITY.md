...
Thank you for helping us keep EfficiencyCode secure!
...
## How to operate EfficiencyCode safely

For details on EfficiencyCode security boundaries, including sandboxing, approvals, and network controls, see [Agent approvals & security](https://developers.openai.com/EfficiencyCode/agent-approvals-security).
