"""Archive writers for canonical EfficiencyCode package directories."""
...
def write_tar_zst_archive(package_dir: Path, archive_path: Path) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="EfficiencyCode-package-archive-") as temp_dir_str:
