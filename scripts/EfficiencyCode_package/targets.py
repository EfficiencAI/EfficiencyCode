...
PACKAGE_VARIANTS: dict[str, PackageVariant] = {
    "EfficiencyCode": PackageVariant(
        name="EfficiencyCode",
        cargo_bin="EfficiencyCode",
        executable_stem="EfficiencyCode",
    ),
    "EfficiencyCode-app-server": PackageVariant(
        name="EfficiencyCode-app-server",
        cargo_bin="EfficiencyCode-app-server",
        executable_stem="EfficiencyCode-app-server",
    ),
}
